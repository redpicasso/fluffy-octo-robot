...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", NikonType2MakernoteDirectory.TAG_FLASH_USED);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_128_GCM_SHA256 = init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", NikonType2MakernoteDirectory.TAG_DELETED_IMAGE_COUNT);
    ...
    public static final CipherSuite TLS_DH_anon_WITH_AES_256_GCM_SHA384 = init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", NikonType2MakernoteDirectory.TAG_EXPOSURE_SEQUENCE_NUMBER);
    ...
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", NikonType2MakernoteDirectory.TAG_LENS_STOPS);
    ...
    public static final CipherSuite TLS_RSA_WITH_AES_128_GCM_SHA256 = init("TLS_RSA_WITH_AES_128_GCM_SHA256", NikonType2MakernoteDirectory.TAG_SCENE_ASSIST);
    ...
    public static final CipherSuite TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", NikonType2MakernoteDirectory.TAG_LENS);
