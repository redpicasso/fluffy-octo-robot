...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build = newBuilder.header(str, "websocket").header(HttpHeaders.CONNECTION, str).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    void checkResponse(Response response) throws ProtocolException {
        ...
        if (response.code() == 101) {
            ...
            String str2 = HttpHeaders.UPGRADE;
     ...
     */
    /* JADX WARNING: Missing block: B:40:0x009a, code:
