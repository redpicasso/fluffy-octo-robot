...
public final class CacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        try {
            ...
            if (response2 != null) {
                if (proceed.code() == OlympusRawInfoMakernoteDirectory.TagWbRbLevelsDaylightFluor) {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(com.google.common.net.HttpHeaders.CONTENT_TYPE), response.body().contentLength(), Okio.buffer(anonymousClass1))).build();
    }
