...
class AndroidPlatform extends Platform {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0027 A:{PHI: r5 , ExcHandler: java.lang.ClassNotFoundException (unused java.lang.ClassNotFoundException), Splitter: B:0:0x0000} */
    ...
    public boolean isCleartextTrafficPermitted(java.lang.String r5) {
        ...
        r0 = java.lang.Class.forName(r0);	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        r1 = "getInstance";
        r2 = 0;
        r3 = new java.lang.Class[r2];	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        r1 = r0.getMethod(r1, r3);	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        r3 = 0;
        r2 = new java.lang.Object[r2];	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        r1 = r1.invoke(r3, r2);	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        r5 = r4.api24IsCleartextTrafficPermitted(r5, r0, r1);	 Catch:{ ClassNotFoundException -> 0x0027, ClassNotFoundException -> 0x0027, IllegalAccessException -> 0x001f, IllegalArgumentException -> 0x001d, InvocationTargetException -> 0x001b }
        return r5;
    L_0x001b:
        r5 = move-exception;
        goto L_0x0020;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0011 A:{SYNTHETIC, Splitter: B:9:0x0011} */
    /* JADX WARNING: Failed to process nested try/catch */
