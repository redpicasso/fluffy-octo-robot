...
public class MediaSessionCompat {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            str2 = MediaSessionCompat.KEY_EXTRA_BINDER;
                            if (extraBinder != null) {
                                asBinder = extraBinder.asBinder();
                            }
                            BundleCompat.putBinder(bundle, str2, asBinder);
                            bundle.putBundle(MediaSessionCompat.KEY_SESSION_TOKEN2_BUNDLE, sessionToken.getSessionToken2Bundle());
                    ...
                    str2 = MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION;
                    if (equals) {
                        Callback.this.onAddQueueItem((MediaDescriptionCompat) bundle.getParcelable(str2));
                        return;
                    }
                    equals = str.equals(MediaControllerCompat.COMMAND_ADD_QUEUE_ITEM_AT);
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            String str2 = MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(13, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_ARTIST;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(2, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_AUTHOR;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(3, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_COMPILATION;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(15, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_COMPOSER;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(4, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_DATE;
            if (bundle.containsKey(str2)) {
                editMetadata.putString(5, bundle.getString(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_DISC_NUMBER;
            if (bundle.containsKey(str2)) {
                editMetadata.putLong(14, bundle.getLong(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_DURATION;
            if (bundle.containsKey(str2)) {
                editMetadata.putLong(9, bundle.getLong(str2));
            }
            str2 = MediaMetadataCompat.METADATA_KEY_GENRE;
            if (bundle.containsKey(str2)) {
