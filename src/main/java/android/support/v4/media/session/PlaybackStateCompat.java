...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && VERSION.SDK_INT >= 21) {
            ...
            List list3 = list;
            if (VERSION.SDK_INT >= 22) {
                this.mStateObj = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, list3, this.mActiveItemId, this.mExtras);
            } else {
                this.mStateObj = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, list3, this.mActiveItemId);
            }
        }
