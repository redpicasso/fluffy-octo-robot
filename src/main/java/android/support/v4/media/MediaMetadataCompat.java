...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static {
        ...
        arrayMap.put(METADATA_KEY_DURATION, valueOf2);
        ...
        arrayMap.put(METADATA_KEY_USER_RATING, valueOf4);
        ...
        arrayMap.put(str5, valueOf3);
        arrayMap = METADATA_KEYS_TYPE;
        String str6 = METADATA_KEY_DISPLAY_ICON_URI;
        arrayMap.put(str6, valueOf);
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            while (i < charSequenceArr.length) {
                strArr = PREFERRED_DESCRIPTION_ORDER;
                if (i2 >= strArr.length) {
                    break;
                }
                int i3 = i2 + 1;
        ...
        str = METADATA_KEY_DOWNLOAD_STATUS;
        if (bundle2.containsKey(str)) {
            bundle.putLong(MediaDescriptionCompat.EXTRA_DOWNLOAD_STATUS, getLong(str));
        }
        if (!bundle.isEmpty()) {
