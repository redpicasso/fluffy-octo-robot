...
public class Task<TResult> {
                    ...
                    if (atomicInteger2.decrementAndGet() == 0) {
                        if (arrayList2.size() != 0) {
                            if (arrayList2.size() == 1) {
                                ...
                                taskCompletionSource2.setError(new AggregateException(String.format("There were %d exceptions.", new Object[]{Integer.valueOf(arrayList2.size())}), arrayList2));
                            }
    ...
    L_0x000a:
        ...
        r4 = r3.lock;	 Catch:{ all -> 0x002c }
        r4.notifyAll();	 Catch:{ all -> 0x002c }
        r3.runContinuations();	 Catch:{ all -> 0x002c }
        r4 = r3.errorHasBeenObserved;	 Catch:{ all -> 0x002c }
        if (r4 != 0) goto L_0x002a;
    L_0x001d:
        r4 = getUnobservedExceptionHandler();	 Catch:{ all -> 0x002c }
        if (r4 == 0) goto L_0x002a;
    L_0x0023:
        r4 = new bolts.UnobservedErrorNotifier;	 Catch:{ all -> 0x002c }
