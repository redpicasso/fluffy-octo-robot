...
public class ImageDimensions {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = imageDimensions.getWidth() == getWidth() && imageDimensions.getHeight() == getHeight() && imageDimensions.getFacing() == getFacing() && imageDimensions.getRotation() == getRotation();
        return z;
    }
}
