...
final class RealBufferedSource implements BufferedSource {
    ...
    public String readUtf8LineStrict(long j) throws IOException {
        ...
        if (j >= 0) {
            ...
            if (j2 < Long.MAX_VALUE && request(j2) && this.buffer.getByte(j2 - 1) == Ascii.CR && request(1 + j2) && this.buffer.getByte(j2) == (byte) 10) {
    ...
    public int readUtf8CodePoint() throws IOException {
        ...
        if ((b & CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY) == JfifUtil.MARKER_SOFn) {
            require(2);
