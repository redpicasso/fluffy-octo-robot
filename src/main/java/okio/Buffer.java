...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00ac A:{SYNTHETIC, EDGE_INSN: B:40:0x00ac->B:35:0x00ac ?: BREAK  } */
    ...
    public int readUtf8CodePoint() throws EOFException {
        if (this.size != 0) {
            ...
            if ((b & 128) == 0) {
                ...
                i2 = 1;
                i4 = 0;
            } else if ((b & CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY) == JfifUtil.MARKER_SOFn) {
                i = b & 31;
                i2 = 2;
                i4 = 128;
            } else if ((b & 240) == CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY) {
                i = b & 15;
                i2 = 3;
                i4 = 2048;
            } else if ((b & 248) == 240) {
