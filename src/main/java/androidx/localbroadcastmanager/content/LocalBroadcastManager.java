...
public final class LocalBroadcastManager {
    ...
    /* JADX WARNING: Missing block: B:59:0x0171, code:
            return true;
     */
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r22) {
        ...
        r2 = r1.mReceivers;
        monitor-enter(r2);
        r10 = r22.getAction();	 Catch:{ all -> 0x0175 }
        r3 = r1.mAppContext;	 Catch:{ all -> 0x0175 }
        r3 = r3.getContentResolver();	 Catch:{ all -> 0x0175 }
        r11 = r0.resolveTypeIfNeeded(r3);	 Catch:{ all -> 0x0175 }
        r12 = r22.getData();	 Catch:{ all -> 0x0175 }
        r13 = r22.getScheme();	 Catch:{ all -> 0x0175 }
        r14 = r22.getCategories();	 Catch:{ all -> 0x0175 }
        r3 = r22.getFlags();	 Catch:{ all -> 0x0175 }
        r3 = r3 & 8;
    ...
    L_0x0030:
        ...
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0175 }
        ...
        r4 = r4.toString();	 Catch:{ all -> 0x0175 }
        android.util.Log.v(r3, r4);	 Catch:{ all -> 0x0175 }
    L_0x0056:
        r3 = r1.mActions;	 Catch:{ all -> 0x0175 }
        r4 = r22.getAction();	 Catch:{ all -> 0x0175 }
        r3 = r3.get(r4);	 Catch:{ all -> 0x0175 }
        r8 = r3;
        r8 = (java.util.ArrayList) r8;	 Catch:{ all -> 0x0175 }
    ...
    L_0x007d:
        ...
        r7 = 0;
    L_0x0080:
        r3 = r8.size();	 Catch:{ all -> 0x0175 }
        if (r7 >= r3) goto L_0x0142;
    L_0x0086:
        r3 = r8.get(r7);	 Catch:{ all -> 0x0175 }
        r5 = r3;
        r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5;	 Catch:{ all -> 0x0175 }
    ...
    L_0x008f:
        ...
        r9 = r5.filter;	 Catch:{ all -> 0x0175 }
        r4.append(r9);	 Catch:{ all -> 0x0175 }
        r4 = r4.toString();	 Catch:{ all -> 0x0175 }
        android.util.Log.v(r3, r4);	 Catch:{ all -> 0x0175 }
    L_0x00a7:
        r3 = r5.broadcasting;	 Catch:{ all -> 0x0175 }
    ...
    L_0x00c0:
        ...
        r20 = r11;
        r11 = 1;
        r3 = r3.match(r4, r5, r6, r7, r8, r9);	 Catch:{ all -> 0x0175 }
        if (r3 < 0) goto L_0x0105;
    L_0x00da:
        if (r16 == 0) goto L_0x00f6;
    L_0x00dc:
        r4 = "LocalBroadcastManager";
        r5 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0175 }
        r5.<init>();	 Catch:{ all -> 0x0175 }
        r6 = "  Filter matched!  match=0x";
        r5.append(r6);	 Catch:{ all -> 0x0175 }
        r3 = java.lang.Integer.toHexString(r3);	 Catch:{ all -> 0x0175 }
        r5.append(r3);	 Catch:{ all -> 0x0175 }
        r3 = r5.toString();	 Catch:{ all -> 0x0175 }
        android.util.Log.v(r4, r3);	 Catch:{ all -> 0x0175 }
    L_0x00f6:
        if (r10 != 0) goto L_0x00fe;
    L_0x00f8:
        r6 = new java.util.ArrayList;	 Catch:{ all -> 0x0175 }
    ...
    L_0x0146:
        r3 = 0;
    L_0x0147:
        r4 = r10.size();	 Catch:{ all -> 0x0175 }
        if (r3 >= r4) goto L_0x0159;
    L_0x014d:
        r4 = r10.get(r3);	 Catch:{ all -> 0x0175 }
        r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4;	 Catch:{ all -> 0x0175 }
        r5 = 0;
        r4.broadcasting = r5;	 Catch:{ all -> 0x0175 }
        r3 = r3 + 1;
        goto L_0x0147;
    L_0x0159:
        r3 = r1.mPendingBroadcasts;	 Catch:{ all -> 0x0175 }
        r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord;	 Catch:{ all -> 0x0175 }
        r4.<init>(r0, r10);	 Catch:{ all -> 0x0175 }
        r3.add(r4);	 Catch:{ all -> 0x0175 }
        r0 = r1.mHandler;	 Catch:{ all -> 0x0175 }
        r0 = r0.hasMessages(r11);	 Catch:{ all -> 0x0175 }
