...
public final class ResourceManagerInternal {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        return ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i, drawable)) && !tintDrawableUsingColorFilter(context, i, drawable) && z) ? null : drawable;
    }
    ...
    L_0x0075:
        ...
        r3 = (androidx.appcompat.widget.ResourceManagerInternal.InflateDelegate) r3;	 Catch:{ Exception -> 0x00a4 }
