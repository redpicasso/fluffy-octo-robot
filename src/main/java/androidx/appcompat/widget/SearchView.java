...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < 960 || i2 < 720 || configuration.orientation != 2) {
                return (i >= LogSeverity.CRITICAL_VALUE || (i >= OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE && i2 >= 480)) ? JfifUtil.MARKER_SOFn : 160;
            } else {
                return 256;
            }
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(i, Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(i2, Ints.MAX_POWER_OF_TWO));
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        Parcelable activity = PendingIntent.getActivity(getContext(), 0, intent2, Ints.MAX_POWER_OF_TWO);
