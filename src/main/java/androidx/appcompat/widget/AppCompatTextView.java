...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:5:0x0010 A:{RETURN, ExcHandler: java.lang.InterruptedException (unused java.lang.InterruptedException), Splitter: B:3:0x0005} */
    ...
    L_0x0004:
        ...
        r0 = (androidx.core.text.PrecomputedTextCompat) r0;	 Catch:{ InterruptedException -> 0x0010, InterruptedException -> 0x0010 }
        androidx.core.widget.TextViewCompat.setPrecomputedText(r2, r0);	 Catch:{ InterruptedException -> 0x0010, InterruptedException -> 0x0010 }
    L_0x0010:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.AppCompatTextView.consumeTextFutureAndSetBlocking():void");
    }
