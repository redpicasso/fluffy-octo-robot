...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    public void onMeasure(int i, int i2) {
        ...
        Object obj = 1;
        boolean z = i2 == Ints.MAX_POWER_OF_TWO;
        setFillViewport(z);
        int childCount = this.mTabLayout.getChildCount();
        if (childCount <= 1 || !(i2 == Ints.MAX_POWER_OF_TWO || i2 == Integer.MIN_VALUE)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
        ...
        i2 = MeasureSpec.makeMeasureSpec(this.mContentHeight, Ints.MAX_POWER_OF_TWO);
