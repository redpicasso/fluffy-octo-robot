...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public MenuItem setActionProvider(android.view.ActionProvider actionProvider) {
        ActionProvider actionProviderWrapperJB;
        if (VERSION.SDK_INT >= 16) {
            actionProviderWrapperJB = new ActionProviderWrapperJB(this.mContext, actionProvider);
        } else {
            actionProviderWrapperJB = new ActionProviderWrapper(this.mContext, actionProvider);
        }
