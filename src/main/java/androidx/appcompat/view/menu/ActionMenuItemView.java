...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return i >= 480 || ((i >= OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE && configuration.screenHeightDp >= 480) || configuration.orientation == 2);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 != Ints.MAX_POWER_OF_TWO && this.mMinWidth > 0 && measuredWidth < i) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(i, Ints.MAX_POWER_OF_TWO), i2);
        }
