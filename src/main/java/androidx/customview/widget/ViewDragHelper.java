...
public class ViewDragHelper {
    ...
    private void ensureMotionHistorySizeForId(int i) {
        ...
        if (fArr == null || fArr.length <= i) {
            ...
            Object obj8 = this.mInitialMotionX;
            if (obj8 != null) {
                System.arraycopy(obj8, 0, obj, 0, obj8.length);
                obj8 = this.mInitialMotionY;
                System.arraycopy(obj8, 0, obj2, 0, obj8.length);
                obj8 = this.mLastMotionX;
                System.arraycopy(obj8, 0, obj3, 0, obj8.length);
                obj8 = this.mLastMotionY;
                System.arraycopy(obj8, 0, obj4, 0, obj8.length);
                obj8 = this.mInitialEdgesTouched;
                System.arraycopy(obj8, 0, obj5, 0, obj8.length);
                obj8 = this.mEdgeDragsInProgress;
                System.arraycopy(obj8, 0, obj6, 0, obj8.length);
                obj8 = this.mEdgeDragsLocked;
                System.arraycopy(obj8, 0, obj7, 0, obj8.length);
            }
