...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private static class SetIndicatorInfo {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
            jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:androidx.legacy.app.ActionBarDrawerToggle.SetIndicatorInfo.<init>(android.app.Activity):void, dom blocks: []
        ...
        L_0x0058:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.legacy.app.ActionBarDrawerToggle.SetIndicatorInfo.<init>(android.app.Activity):void");
        }
    }
