...
public final class FingerprintManagerCompat {
    ...
    private static FingerprintManager getFingerprintManagerOrNull(@NonNull Context context) {
        ...
        return (VERSION.SDK_INT <= 23 || !context.getPackageManager().hasSystemFeature("android.hardware.fingerprint")) ? null : (FingerprintManager) context.getSystemService(FingerprintManager.class);
    }
