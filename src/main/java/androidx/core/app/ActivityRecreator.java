...
final class ActivityRecreator {
    ...
    protected static boolean queueOnStopIfNecessary(Object obj, Activity activity) {
        try {
            ...
            obj = mainThreadField.get(activity);
            mainHandler.postAtFrontOfQueue(new Runnable() {
                public void run() {
                    try {
                        if (ActivityRecreator.performStopActivity3ParamsMethod != null) {
                            ActivityRecreator.performStopActivity3ParamsMethod.invoke(obj, new Object[]{obj2, Boolean.valueOf(false), "AppCompat recreation"});
                            return;
                        }
                        ActivityRecreator.performStopActivity2ParamsMethod.invoke(obj, new Object[]{obj2, Boolean.valueOf(false)});
