...
public final class InputConnectionCompat {
    ...
    L_0x0003:
        return r0;
    L_0x0004:
        r1 = "androidx.core.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT";
        r1 = android.text.TextUtils.equals(r1, r8);
        r2 = 1;
    ...
    L_0x000d:
        ...
        goto L_0x0018;
    L_0x000f:
        r1 = "android.support.v13.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT";
        r8 = android.text.TextUtils.equals(r1, r8);
    ...
    L_0x001b:
        r3 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER";
        goto L_0x0020;
    L_0x001e:
        r3 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER";
    L_0x0020:
        r3 = r9.getParcelable(r3);	 Catch:{ all -> 0x007f }
        r3 = (android.os.ResultReceiver) r3;	 Catch:{ all -> 0x007f }
        if (r8 == 0) goto L_0x002b;
    L_0x0028:
        r4 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI";
        goto L_0x002d;
    L_0x002b:
        r4 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_URI";
    L_0x002d:
        r4 = r9.getParcelable(r4);	 Catch:{ all -> 0x007d }
        r4 = (android.net.Uri) r4;	 Catch:{ all -> 0x007d }
        if (r8 == 0) goto L_0x0038;
    L_0x0035:
        r5 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION";
        goto L_0x003a;
    L_0x0038:
        r5 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION";
    L_0x003a:
        r5 = r9.getParcelable(r5);	 Catch:{ all -> 0x007d }
        r5 = (android.content.ClipDescription) r5;	 Catch:{ all -> 0x007d }
        if (r8 == 0) goto L_0x0045;
    L_0x0042:
        r6 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI";
        goto L_0x0047;
    L_0x0045:
        r6 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI";
    L_0x0047:
        r6 = r9.getParcelable(r6);	 Catch:{ all -> 0x007d }
        r6 = (android.net.Uri) r6;	 Catch:{ all -> 0x007d }
        if (r8 == 0) goto L_0x0052;
    L_0x004f:
        r7 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS";
        goto L_0x0054;
    L_0x0052:
        r7 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS";
    L_0x0054:
        r7 = r9.getInt(r7);	 Catch:{ all -> 0x007d }
        if (r8 == 0) goto L_0x005d;
    L_0x005a:
        r8 = "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS";
        goto L_0x005f;
    L_0x005d:
        r8 = "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_OPTS";
    L_0x005f:
        r8 = r9.getParcelable(r8);	 Catch:{ all -> 0x007d }
        r8 = (android.os.Bundle) r8;	 Catch:{ all -> 0x007d }
        if (r4 == 0) goto L_0x0073;
    L_0x0067:
        if (r5 == 0) goto L_0x0073;
    L_0x0069:
        r9 = new androidx.core.view.inputmethod.InputContentInfoCompat;	 Catch:{ all -> 0x007d }
        r9.<init>(r4, r5, r6);	 Catch:{ all -> 0x007d }
        r8 = r10.onCommitContent(r9, r7, r8);	 Catch:{ all -> 0x007d }
        goto L_0x0074;
    L_0x0073:
        r8 = 0;
    L_0x0074:
