...
public final class LinkifyCompat {
    ...
    /* JADX WARNING: Missing block: B:2:?, code:
            r1 = findAddress(r6);
     */
    ...
    /* JADX WARNING: Missing block: B:6:0x0012, code:
            r3 = new androidx.core.text.util.LinkifyCompat.LinkSpec();
            r4 = r1.length() + r2;
            r3.start = r2 + r0;
            r0 = r0 + r4;
            r3.end = r0;
    ...
    /* JADX WARNING: Missing block: B:8:?, code:
            r1 = java.net.URLEncoder.encode(r1, com.bumptech.glide.load.Key.STRING_CHARSET_NAME);
     */
    /* JADX WARNING: Missing block: B:10:?, code:
            ...
            r5.add(r3);
     */
    /* JADX WARNING: Missing block: B:17:0x0005, code:
            continue;
     */
