...
public abstract class AbstractServerStream extends AbstractStream implements ServerStream, io.grpc.internal.MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends io.grpc.internal.AbstractStream.TransportState {
        ...
        public final void setListener(ServerStreamListener serverStreamListener) {
            ...
            this.listener = (ServerStreamListener) Preconditions.checkNotNull(serverStreamListener, CastExtraArgs.LISTENER);
        }
        ...
        private void closeListener(Status status) {
            boolean z = (status.isOk() && this.closedStatus == null) ? false : true;
