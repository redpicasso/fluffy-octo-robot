...
public abstract class APEZProvider extends ContentProvider {
    public static final String[] ALL_FIELDS = new String[]{FILEID, FILENAME, ZIPFILE, MODIFICATION, CRC32, COMPRESSEDLEN, UNCOMPRESSEDLEN, COMPRESSIONTYPE};
    public static final int[] ALL_FIELDS_INT = new int[]{0, 1, 2, 3, 4, 5, 6, 7};
        ...
        if (!this.mInit) {
            ...
            try {
                ...
                if (resolveContentProvider.metaData != null) {
                    ...
                    i2 = resolveContentProvider.metaData.getInt("patchVersion", i2);
                    String str = "N";
                    if (str != resolveContentProvider.metaData.getString("mainFilename", str)) {
                        if (str != resolveContentProvider.metaData.getString("patchFilename", str)) {
                            strArr = new String[]{r7, resolveContentProvider.metaData.getString("patchFilename", str)};
                        } else {
                            strArr = new String[]{r7};
                        }
                    }
                    i = i2;
                    i2 = i3;
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        return openAssetFile != null ? openAssetFile.getParcelFileDescriptor() : null;
    }
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        Cursor matrixCursor = new MatrixCursor(strArr, zipEntryROArr.length);
