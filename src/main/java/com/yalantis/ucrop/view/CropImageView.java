...
public class CropImageView extends TransformImageView {
    ...
    public void setImageToWrapCropBounds(boolean z) {
        if (this.mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (z) {
                Runnable wrapCropBoundsRunnable = new WrapCropBoundsRunnable(this, this.mImageToWrapCropBoundsAnimDuration, f4, f5, f2, f, currentScale, f3, isImageWrapCropBounds);
