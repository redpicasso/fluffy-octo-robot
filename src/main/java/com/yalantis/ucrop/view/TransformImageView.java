...
public class TransformImageView extends ImageView {
    ...
    protected void onImageLaidOut() {
        ...
        if (drawable != null) {
            Log.d(TAG, String.format("Image size: [%d:%d]", new Object[]{Integer.valueOf((int) ((float) drawable.getIntrinsicWidth())), Integer.valueOf((int) ((float) drawable.getIntrinsicHeight()))}));
            RectF rectF = new RectF(0.0f, 0.0f, r1, r0);
