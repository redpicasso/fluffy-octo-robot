...
public class RNGestureHandlerButtonViewManager extends ViewGroupManager<ButtonViewGroup> {
    ...
    static class ButtonViewGroup extends ViewGroup {
        ...
        private Drawable applyRippleEffectWhenNeeded(Drawable drawable) {
            if (this.mRippleColor != null && drawable != null && VERSION.SDK_INT >= 21 && (drawable instanceof RippleDrawable)) {
                int[][] iArr = new int[1][];
                iArr[0] = new int[]{16842910};
                ((RippleDrawable) drawable).setColor(new ColorStateList(iArr, new int[]{this.mRippleColor.intValue()}));
            }
            return drawable;
        }
