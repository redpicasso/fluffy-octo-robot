...
public class RotationGestureHandler extends GestureHandler<RotationGestureHandler> {
    ...
    private OnRotationGestureListener mGestureListener = new OnRotationGestureListener() {
        ...
        public boolean onRotation(RotationGestureDetector rotationGestureDetector) {
            ...
            rotationGestureHandler.mLastRotation = rotationGestureHandler.mLastRotation + rotationGestureDetector.getRotation();
            ...
            if (timeDelta > 0) {
                ...
                rotationGestureHandler2.mLastVelocity = (rotationGestureHandler2.mLastRotation - access$000) / ((double) timeDelta);
            }
