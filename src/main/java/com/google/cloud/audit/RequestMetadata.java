...
public final class RequestMetadata extends GeneratedMessageLite<RequestMetadata, Builder> implements RequestMetadataOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<RequestMetadata, Builder> implements RequestMetadataOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.callerIp_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getCallerIp());
        }
        if (!this.callerSuppliedUserAgent_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getCallerSuppliedUserAgent());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.callerIp_ = visitor.visitString(this.callerIp_.isEmpty() ^ true, this.callerIp_, requestMetadata.callerIp_.isEmpty() ^ true, requestMetadata.callerIp_);
                this.callerSuppliedUserAgent_ = visitor.visitString(this.callerSuppliedUserAgent_.isEmpty() ^ true, this.callerSuppliedUserAgent_, true ^ requestMetadata.callerSuppliedUserAgent_.isEmpty(), requestMetadata.callerSuppliedUserAgent_);
