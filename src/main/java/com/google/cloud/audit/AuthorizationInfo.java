...
public final class AuthorizationInfo extends GeneratedMessageLite<AuthorizationInfo, Builder> implements AuthorizationInfoOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<AuthorizationInfo, Builder> implements AuthorizationInfoOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.resource_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getResource());
        }
        if (!this.permission_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getPermission());
        }
        boolean z = this.granted_;
        if (z) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.resource_ = visitor.visitString(this.resource_.isEmpty() ^ true, this.resource_, authorizationInfo.resource_.isEmpty() ^ true, authorizationInfo.resource_);
                this.permission_ = visitor.visitString(this.permission_.isEmpty() ^ true, this.permission_, true ^ authorizationInfo.permission_.isEmpty(), authorizationInfo.permission_);
                boolean z = this.granted_;
