...
public final class HttpRequest extends GeneratedMessageLite<HttpRequest, Builder> implements HttpRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<HttpRequest, Builder> implements HttpRequestOrBuilder {
        private Builder() {
    ...
    private void setLatency(com.google.protobuf.Duration.Builder builder) {
    ...
    private void mergeLatency(Duration duration) {
        ...
        if (duration2 == null || duration2 == Duration.getDefaultInstance()) {
            ...
            this.latency_ = (Duration) ((com.google.protobuf.Duration.Builder) Duration.newBuilder(this.latency_).mergeFrom(duration)).buildPartial();
        }
    }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        z = this.cacheValidatedWithOriginServer_;
        if (z) {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.requestMethod_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getRequestMethod());
        }
        if (!this.requestUrl_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getRequestUrl());
        }
        long j = this.requestSize_;
        if (j != 0) {
        ...
        int i2 = this.status_;
        if (i2 != 0) {
            i += CodedOutputStream.computeInt32Size(4, i2);
        }
        j = this.responseSize_;
        if (j != 0) {
            i += CodedOutputStream.computeInt64Size(5, j);
        }
        if (!this.userAgent_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(6, getUserAgent());
        }
        if (!this.remoteIp_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(7, getRemoteIp());
        }
        if (!this.referer_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(8, getReferer());
        }
        boolean z = this.cacheHit_;
        if (z) {
        ...
        z = this.cacheValidatedWithOriginServer_;
        if (z) {
            i += CodedOutputStream.computeBoolSize(10, z);
        }
        z = this.cacheLookup_;
        if (z) {
            i += CodedOutputStream.computeBoolSize(11, z);
        }
        j = this.cacheFillBytes_;
        if (j != 0) {
        ...
        if (!this.serverIp_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(13, getServerIp());
        }
        if (this.latency_ != null) {
            i += CodedOutputStream.computeMessageSize(14, getLatency());
        }
        if (!this.protocol_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(15, getProtocol());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.requestMethod_ = visitor.visitString(this.requestMethod_.isEmpty() ^ true, this.requestMethod_, httpRequest.requestMethod_.isEmpty() ^ true, httpRequest.requestMethod_);
                this.requestUrl_ = visitor.visitString(this.requestUrl_.isEmpty() ^ true, this.requestUrl_, httpRequest.requestUrl_.isEmpty() ^ true, httpRequest.requestUrl_);
                ...
                this.userAgent_ = visitor.visitString(this.userAgent_.isEmpty() ^ true, this.userAgent_, httpRequest.userAgent_.isEmpty() ^ true, httpRequest.userAgent_);
                this.remoteIp_ = visitor.visitString(this.remoteIp_.isEmpty() ^ true, this.remoteIp_, httpRequest.remoteIp_.isEmpty() ^ true, httpRequest.remoteIp_);
                this.serverIp_ = visitor.visitString(this.serverIp_.isEmpty() ^ true, this.serverIp_, httpRequest.serverIp_.isEmpty() ^ true, httpRequest.serverIp_);
                this.referer_ = visitor.visitString(this.referer_.isEmpty() ^ true, this.referer_, httpRequest.referer_.isEmpty() ^ true, httpRequest.referer_);
                this.latency_ = (Duration) visitor.visitMessage(this.latency_, httpRequest.latency_);
                boolean z = this.cacheLookup_;
                boolean z2 = httpRequest.cacheLookup_;
                this.cacheLookup_ = visitor.visitBoolean(z, z, z2, z2);
                z = this.cacheHit_;
                z2 = httpRequest.cacheHit_;
                this.cacheHit_ = visitor.visitBoolean(z, z, z2, z2);
                z = this.cacheValidatedWithOriginServer_;
                z2 = httpRequest.cacheValidatedWithOriginServer_;
                this.cacheValidatedWithOriginServer_ = visitor.visitBoolean(z, z, z2, z2);
                ...
                this.protocol_ = visitor.visitString(this.protocol_.isEmpty() ^ true, this.protocol_, httpRequest.protocol_.isEmpty() ^ true, httpRequest.protocol_);
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 106:
                                ...
                                break;
                            case 114:
                                com.google.protobuf.Duration.Builder builder = this.latency_ != null ? (com.google.protobuf.Duration.Builder) this.latency_.toBuilder() : null;
