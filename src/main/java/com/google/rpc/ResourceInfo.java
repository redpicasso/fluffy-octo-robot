...
public final class ResourceInfo extends GeneratedMessageLite<ResourceInfo, Builder> implements ResourceInfoOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ResourceInfo, Builder> implements ResourceInfoOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.resourceName_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getResourceName());
        }
        if (!this.owner_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getOwner());
        }
        if (!this.description_.isEmpty()) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.resourceType_ = visitor.visitString(this.resourceType_.isEmpty() ^ true, this.resourceType_, resourceInfo.resourceType_.isEmpty() ^ true, resourceInfo.resourceType_);
                this.resourceName_ = visitor.visitString(this.resourceName_.isEmpty() ^ true, this.resourceName_, resourceInfo.resourceName_.isEmpty() ^ true, resourceInfo.resourceName_);
                this.owner_ = visitor.visitString(this.owner_.isEmpty() ^ true, this.owner_, resourceInfo.owner_.isEmpty() ^ true, resourceInfo.owner_);
                this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, true ^ resourceInfo.description_.isEmpty(), resourceInfo.description_);
