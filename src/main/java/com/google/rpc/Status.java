...
public final class Status extends GeneratedMessageLite<Status, Builder> implements StatusOrBuilder {
    ...
    private int code_;
    private ProtobufList<Any> details_ = GeneratedMessageLite.emptyProtobufList();
    private String message_ = "";

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Status, Builder> implements StatusOrBuilder {
        private Builder() {
    ...
    private void setDetails(int i, com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();
    ...
    private void addDetails(com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();
        this.details_.add((Any) builder.build());
    }

    private void addDetails(int i, com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        while (i2 < this.details_.size()) {
            i += CodedOutputStream.computeMessageSize(3, (MessageLite) this.details_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.message_ = visitor.visitString(this.message_.isEmpty() ^ true, this.message_, status.message_.isEmpty() ^ true, status.message_);
