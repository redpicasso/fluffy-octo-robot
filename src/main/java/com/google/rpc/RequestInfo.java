...
public final class RequestInfo extends GeneratedMessageLite<RequestInfo, Builder> implements RequestInfoOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<RequestInfo, Builder> implements RequestInfoOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.servingData_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getServingData());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.requestId_ = visitor.visitString(this.requestId_.isEmpty() ^ true, this.requestId_, requestInfo.requestId_.isEmpty() ^ true, requestInfo.requestId_);
                this.servingData_ = visitor.visitString(this.servingData_.isEmpty() ^ true, this.servingData_, true ^ requestInfo.servingData_.isEmpty(), requestInfo.servingData_);
