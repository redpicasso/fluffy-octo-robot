...
public final class DebugInfo extends GeneratedMessageLite<DebugInfo, Builder> implements DebugInfoOrBuilder {
    ...
    private ProtobufList<String> stackEntries_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<DebugInfo, Builder> implements DebugInfoOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = (0 + i2) + (getStackEntriesList().size() * 1);
        if (!this.detail_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getDetail());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.detail_ = visitor.visitString(this.detail_.isEmpty() ^ true, this.detail_, true ^ debugInfo.detail_.isEmpty(), debugInfo.detail_);
