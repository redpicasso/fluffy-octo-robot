...
public final class Help extends GeneratedMessageLite<Help, Builder> implements HelpOrBuilder {
    ...
    private ProtobufList<Link> links_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Help, Builder> implements HelpOrBuilder {
        private Builder() {
        ...
        protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    Link link = (Link) obj2;
                    this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, link.description_.isEmpty() ^ true, link.description_);
                    this.url_ = visitor.visitString(this.url_.isEmpty() ^ true, this.url_, true ^ link.url_.isEmpty(), link.url_);
    ...
    private void setLinks(int i, Builder builder) {
        ensureLinksIsMutable();
    ...
    private void addLinks(Builder builder) {
        ensureLinksIsMutable();
        this.links_.add((Link) builder.build());
    }

    private void addLinks(int i, Builder builder) {
        ensureLinksIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.links_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.links_.get(i));
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.links_ = ((Visitor) obj).visitList(this.links_, ((Help) obj2).links_);
                MergeFromVisitor mergeFromVisitor = MergeFromVisitor.INSTANCE;
                return this;
            case MERGE_FROM_STREAM:
                CodedInputStream codedInputStream = (CodedInputStream) obj;
