...
public final class LocalizedMessage extends GeneratedMessageLite<LocalizedMessage, Builder> implements LocalizedMessageOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<LocalizedMessage, Builder> implements LocalizedMessageOrBuilder {
        private Builder() {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.locale_ = visitor.visitString(this.locale_.isEmpty() ^ true, this.locale_, localizedMessage.locale_.isEmpty() ^ true, localizedMessage.locale_);
                this.message_ = visitor.visitString(this.message_.isEmpty() ^ true, this.message_, true ^ localizedMessage.message_.isEmpty(), localizedMessage.message_);
