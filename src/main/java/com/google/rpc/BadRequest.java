...
public final class BadRequest extends GeneratedMessageLite<BadRequest, Builder> implements BadRequestOrBuilder {
    ...
    private ProtobufList<FieldViolation> fieldViolations_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<BadRequest, Builder> implements BadRequestOrBuilder {
        private Builder() {
    ...
    public static final class FieldViolation extends GeneratedMessageLite<FieldViolation, Builder> implements FieldViolationOrBuilder {
        ...
        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<FieldViolation, Builder> implements FieldViolationOrBuilder {
            private Builder() {
        ...
        protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    this.field_ = visitor.visitString(this.field_.isEmpty() ^ true, this.field_, fieldViolation.field_.isEmpty() ^ true, fieldViolation.field_);
                    this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, true ^ fieldViolation.description_.isEmpty(), fieldViolation.description_);
    ...
    private void setFieldViolations(int i, Builder builder) {
        ensureFieldViolationsIsMutable();
    ...
    private void addFieldViolations(Builder builder) {
        ensureFieldViolationsIsMutable();
        this.fieldViolations_.add((FieldViolation) builder.build());
    }

    private void addFieldViolations(int i, Builder builder) {
        ensureFieldViolationsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        for (i = 0; i < this.fieldViolations_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.fieldViolations_.get(i));
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.fieldViolations_ = ((Visitor) obj).visitList(this.fieldViolations_, ((BadRequest) obj2).fieldViolations_);
                MergeFromVisitor mergeFromVisitor = MergeFromVisitor.INSTANCE;
                return this;
            case MERGE_FROM_STREAM:
                CodedInputStream codedInputStream = (CodedInputStream) obj;
