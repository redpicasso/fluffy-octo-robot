...
public final class Detector {
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        if (isValid(resultPointArr[0]) && isValid(resultPointArr[1]) && isValid(resultPointArr[2]) && isValid(resultPointArr[3])) {
            int i2;
            int[] iArr = new int[]{sampleLine(resultPointArr[0], resultPointArr[1], r4), sampleLine(resultPointArr[1], resultPointArr[2], r4), sampleLine(resultPointArr[2], resultPointArr[3], r4), sampleLine(resultPointArr[3], resultPointArr[0], this.nbCenterLayers * 2)};
    ...
    private boolean isWhiteOrBlackRectangle(Point point, Point point2, Point point3, Point point4) {
        ...
        if (color != 0 && getColor(point5, point) == color && getColor(point, point2) == color && getColor(point2, point3) == color) {
            return true;
        }
        return false;
    }
    ...
    private static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, int i, int i2) {
        ...
        float x2 = (resultPointArr[0].getX() - resultPointArr[2].getX()) * f;
        float y2 = (resultPointArr[0].getY() - resultPointArr[2].getY()) * f;
        ...
        y2 = (resultPointArr[1].getX() - resultPointArr[3].getX()) * f;
        f *= resultPointArr[1].getY() - resultPointArr[3].getY();
        ResultPoint resultPoint3 = new ResultPoint(x3 + y2, y3 + f);
        ResultPoint resultPoint4 = new ResultPoint(x3 - y2, y3 - f);
