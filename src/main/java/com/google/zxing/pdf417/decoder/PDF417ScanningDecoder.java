        ...
        while (i6 <= i3) {
            ...
            if (detectionResult.getDetectionResultColumn(i7) == null) {
                ...
                while (i4 <= boundingBox.getMaxY()) {
                    ...
                    int i12;
                    int i13;
                    int startColumn = getStartColumn(detectionResult, i7, i4, z);
                    ...
                    i12 = i10;
                    int i14 = i9;
                    Codeword detectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i11, i4, i5, i14);
                    if (detectCodeword != null) {
                        detectionResultColumn.setCodeword(i4, detectCodeword);
                        i5 = Math.min(i5, detectCodeword.getWidth());
                        i9 = Math.max(i14, detectCodeword.getWidth());
                        i10 = i11;
                        i4++;
                        i8 = -1;
                    } else {
    ...
    private static DecoderResult createDecoderResultFromAmbiguousValues(int i, int[] iArr, int[] iArr2, int[] iArr3, int[][] iArr4) throws FormatException, ChecksumException {
        ...
        while (true) {
            ...
            if (i2 > 0) {
                ...
                try {
                    i = decodeCodewords(iArr, i, iArr2);
                    return i;
            ...
            try {
                ...
                for (BarcodeValue value : barcodeValueArr[i]) {
                    if (value.getValue().length == 0) {
                        ...
                        formatter.format("%4d(%2d)", new Object[]{Integer.valueOf(barcodeValueArr[i][r4].getValue()[0]), barcodeValueArr[i][r4].getConfidence(barcodeValueArr[i][r4].getValue()[0])});
                    }
                }
