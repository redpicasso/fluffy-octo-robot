...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    public byte[] getRow(int i, byte[] bArr) {
        ...
        System.arraycopy(this.yuvData, ((i + this.top) * this.dataWidth) + this.left, bArr2, 0, width);
        return bArr2;
    }
    ...
    public byte[] getMatrix() {
        ...
        int i4 = 0;
        if (width == i3) {
            System.arraycopy(this.yuvData, i2, obj, 0, i);
            return obj;
        }
        while (i4 < height) {
            System.arraycopy(this.yuvData, i2, obj, i4 * width, width);
            i2 += this.dataWidth;
            i4++;
        }
        return obj;
