...
public final class HighLevelEncoder {
    ...
    private static char randomize253State(char c, int i) {
        ...
        if (i2 > ExifDirectoryBase.TAG_NEW_SUBFILE_TYPE) {
            i2 -= 254;
        }
        return (char) i2;
    }
    ...
    static int lookAheadTest(CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 == charSequence.length()) {
                ...
                if (minimumCount == 1 && bArr[5] > (byte) 0) {
                    return 5;
                }
                ...
                if (minimumCount != 1 || bArr[2] <= (byte) 0) {
                    return (minimumCount != 1 || bArr[3] <= (byte) 0) ? 1 : 3;
                } else {
                    return 2;
                }
            }
            ...
            if (i4 >= 4) {
                ...
                if (iArr2[5] >= iArr2[0] && ((bArr2[1] + bArr2[2]) + bArr2[3]) + bArr2[4] != 0) {
                    if (minimumCount2 == 1 && bArr2[4] > (byte) 0) {
                        return 4;
                    }
                    if (minimumCount2 == 1 && bArr2[2] > (byte) 0) {
                        return 2;
                    }
                    if (minimumCount2 == 1 && bArr2[3] > (byte) 0) {
                        return 3;
                    }
