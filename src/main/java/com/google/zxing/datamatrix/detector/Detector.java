...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            transitions2 = transitionsBetween(resultPoint8, resultPoint4).getTransitions();
            int transitions3 = transitionsBetween(resultPoint6, resultPoint4).getTransitions();
            if ((transitions2 & 1) == 1) {
                transitions2++;
            }
            int i3 = transitions2;
            ...
            sampleGrid = sampleGrid(this.image, resultPoint8, resultPoint9, resultPoint6, resultPoint4, i3, transitions3);
        } else {
            resultPoint4 = correctTopRight(resultPoint9, resultPoint6, resultPoint10, resultPoint11, Math.min(i2, i));
            if (resultPoint4 == null) {
                resultPoint4 = resultPoint11;
            }
            transitions2 = Math.max(transitionsBetween(resultPoint10, resultPoint4).getTransitions(), transitionsBetween(resultPoint6, resultPoint4).getTransitions()) + 1;
            if ((transitions2 & 1) == 1) {
                transitions2++;
            }
            int i4 = transitions2;
            sampleGrid = sampleGrid(this.image, resultPoint10, resultPoint9, resultPoint6, resultPoint4, i4, i4);
            resultPoint8 = resultPoint10;
        }
        return new DetectorResult(sampleGrid, new ResultPoint[]{resultPoint8, resultPoint9, resultPoint6, resultPoint4});
    }
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint resultPoint, ResultPoint resultPoint2) {
        ...
        while (x != x2) {
            boolean z2 = this.image.get(obj != null ? y : x, obj != null ? x : y);
            if (z2 != z) {
                i++;
                z = z2;
            }
