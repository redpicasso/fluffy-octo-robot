...
public final class Encoder {
     ...
     */
        static {
            ...
            r0 = $SwitchMap$com$google$zxing$qrcode$decoder$Mode;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = com.google.zxing.qrcode.decoder.Mode.NUMERIC;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = 1;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r0 = $SwitchMap$com$google$zxing$qrcode$decoder$Mode;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = com.google.zxing.qrcode.decoder.Mode.ALPHANUMERIC;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x001f }
            r2 = 2;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x001f }
        L_0x001f:
            r0 = $SwitchMap$com$google$zxing$qrcode$decoder$Mode;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = com.google.zxing.qrcode.decoder.Mode.BYTE;	 Catch:{ NoSuchFieldError -> 0x002a }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x002a }
            r2 = 3;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x002a }
        L_0x002a:
            r0 = $SwitchMap$com$google$zxing$qrcode$decoder$Mode;	 Catch:{ NoSuchFieldError -> 0x0035 }
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        String obj3 = obj2 != null ? map.get(EncodeHintType.CHARACTER_SET).toString() : DEFAULT_BYTE_MODE_ENCODING;
        Mode chooseMode = chooseMode(str, obj3);
        BitArray bitArray = new BitArray();
        if (chooseMode == Mode.BYTE && obj2 != null) {
        ...
        appendBytes(str, chooseMode, bitArray2, obj3);
    ...
    private static Mode chooseMode(String str, String str2) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if ((charAt < '0' || charAt > '9') && getAlphanumericCode(charAt) == -1) {
                return Mode.BYTE;
            }
            obj = 1;
        }
    ...
    private static boolean isOnlyDoubleByteKanji(String str) {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                int i2 = bytes[i] & 255;
                if ((i2 < 129 || i2 > 159) && (i2 < CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY || i2 > 235)) {
                    return false;
                }
            }
            return true;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x0044 A:{SYNTHETIC} */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x0035 A:{LOOP_END, LOOP:0: B:3:0x0008->B:16:0x0035} */
    static void appendKanjiBytes(java.lang.String r6, com.google.zxing.common.BitArray r7) throws com.google.zxing.WriterException {
        /*
        r0 = "Shift_JIS";
        r6 = r6.getBytes(r0);	 Catch:{ UnsupportedEncodingException -> 0x004d }
        r0 = r6.length;
        r1 = 0;
    L_0x0008:
