...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(28, new ECB(4, 116), new ECB(4, 117));
        ...
        r6 = new ECBlocks[4];
        r6[0] = new ECBlocks(30, new ECB(4, 121), new ECB(5, 122));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(6, 117), new ECB(4, 118));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, 115));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(8, 122), new ECB(4, 123));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(3, 117), new ECB(10, 118));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(7, 116), new ECB(7, 117));
        ...
        iArr2 = new int[]{6, 26, 52, 78, 104, NikonType2MakernoteDirectory.TAG_ADAPTER};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(5, 115), new ECB(10, 116));
        ...
        iArr2 = new int[]{6, 30, 56, 82, 108, NikonType2MakernoteDirectory.TAG_DIGITAL_ZOOM};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(13, 115), new ECB(3, 116));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, 115));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, 115), new ECB(1, 116));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(13, 115), new ECB(6, 116));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(12, 121), new ECB(7, 122));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(6, 121), new ECB(14, 122));
        ...
        iArr2 = new int[]{6, 28, 54, 80, 106, NikonType2MakernoteDirectory.TAG_LENS, 158};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, 122), new ECB(4, 123));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(4, 122), new ECB(18, 123));
        ...
        iArr2 = new int[]{6, 26, 54, 82, 110, 138, NikonType2MakernoteDirectory.TAG_DELETED_IMAGE_COUNT};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(20, 117), new ECB(4, 118));
        ...
        r4 = new ECBlocks[4];
        r4[0] = new ECBlocks(30, new ECB(19, 118), new ECB(6, 119));
