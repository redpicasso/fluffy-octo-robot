...
public final class MonochromeRectangleDetector {
    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        ...
        while (i13 < i14 && i13 >= i7 && i12 < i4 && i12 >= i3) {
            int[] blackWhiteRange;
            if (i2 == 0) {
                blackWhiteRange = blackWhiteRange(i13, i9, i3, i4, true);
            } else {
                blackWhiteRange = blackWhiteRange(i12, i9, i7, i8, false);
            }
            if (blackWhiteRange != null) {
                ...
                if (i2 == 0) {
                    ...
                    return new ResultPoint((float) iArr[i14], (float) i13);
                }
                i12 -= i2;
                if (iArr[0] >= i11) {
                ...
                return new ResultPoint(f, (float) iArr[i14]);
            } else {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:66:0x006f A:{SYNTHETIC, EDGE_INSN: B:66:0x006f->B:36:0x006f ?: BREAK  , EDGE_INSN: B:66:0x006f->B:36:0x006f ?: BREAK  } */
