...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, NikonType2MakernoteDirectory.TAG_LENS_STOPS}, "US/CA");
            ...
            add(new int[]{529}, "CY");
            add(new int[]{531}, "MK");
            add(new int[]{SanyoMakernoteDirectory.TAG_RECORD_SHUTTER_RELEASE}, "MT");
            add(new int[]{539}, "IE");
            ...
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            add(new int[]{IptcDirectory.TAG_COUNTRY_OR_PRIMARY_LOCATION_NAME}, "DZ");
            add(new int[]{616}, "KE");
            add(new int[]{618}, "CI");
            add(new int[]{619}, "TN");
            add(new int[]{621}, "SY");
            add(new int[]{IptcDirectory.TAG_CREDIT}, "EG");
            add(new int[]{624}, "LY");
            add(new int[]{625}, "JO");
            add(new int[]{626}, "IR");
            add(new int[]{IptcDirectory.TAG_SOURCE}, "KW");
            add(new int[]{IptcDirectory.TAG_COPYRIGHT_NOTICE}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 649}, "FI");
            ...
            add(new int[]{770}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{OlympusCameraSettingsMakernoteDirectory.TagAfFineTuneAdj}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
            add(new int[]{784}, "PY");
            add(new int[]{785}, "PE");
            add(new int[]{LeicaMakernoteDirectory.TAG_MEASURED_LV}, "EC");
