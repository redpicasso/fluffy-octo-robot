    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        while (i2 < uPCEANReaderArr.length) {
            try {
                ...
                Object obj = (decodeRow.getBarcodeFormat() == BarcodeFormat.EAN_13 && decodeRow.getText().charAt(0) == '0') ? 1 : null;
                if (map == null) {
                    collection = null;
                } else {
                    collection = (Collection) map.get(DecodeHintType.POSSIBLE_FORMATS);
                }
                Object obj2 = (collection == null || collection.contains(BarcodeFormat.UPC_A)) ? 1 : null;
