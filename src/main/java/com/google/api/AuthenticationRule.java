...
public final class AuthenticationRule extends GeneratedMessageLite<AuthenticationRule, Builder> implements AuthenticationRuleOrBuilder {
    ...
    private ProtobufList<AuthRequirement> requirements_ = GeneratedMessageLite.emptyProtobufList();
    private String selector_ = "";

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<AuthenticationRule, Builder> implements AuthenticationRuleOrBuilder {
        private Builder() {
    ...
    private void setOauth(com.google.api.OAuthRequirements.Builder builder) {
    ...
    private void mergeOauth(OAuthRequirements oAuthRequirements) {
        ...
        if (oAuthRequirements2 == null || oAuthRequirements2 == OAuthRequirements.getDefaultInstance()) {
            ...
            this.oauth_ = (OAuthRequirements) ((com.google.api.OAuthRequirements.Builder) OAuthRequirements.newBuilder(this.oauth_).mergeFrom(oAuthRequirements)).buildPartial();
        }
    }
    ...
    private void setRequirements(int i, com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();
    ...
    private void addRequirements(com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();
        this.requirements_.add((AuthRequirement) builder.build());
    }

    private void addRequirements(int i, com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        if (this.oauth_ != null) {
            i += CodedOutputStream.computeMessageSize(2, getOauth());
        }
        boolean z = this.allowWithoutCredential_;
        if (z) {
            i += CodedOutputStream.computeBoolSize(5, z);
        }
        while (i2 < this.requirements_.size()) {
            i += CodedOutputStream.computeMessageSize(7, (MessageLite) this.requirements_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, true ^ authenticationRule.selector_.isEmpty(), authenticationRule.selector_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.api.OAuthRequirements.Builder builder = this.oauth_ != null ? (com.google.api.OAuthRequirements.Builder) this.oauth_.toBuilder() : null;
