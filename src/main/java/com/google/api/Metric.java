...
public final class Metric extends GeneratedMessageLite<Metric, Builder> implements MetricOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Metric, Builder> implements MetricOrBuilder {
        private Builder() {
        ...
        public String getLabelsOrDefault(String str, String str2) {
            if (str != null) {
                Map labelsMap = ((Metric) this.instance).getLabelsMap();
    ...
    public int getSerializedSize() {
        ...
        if (!this.type_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getType());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.type_ = visitor.visitString(this.type_.isEmpty() ^ true, this.type_, true ^ metric.type_.isEmpty(), metric.type_);
