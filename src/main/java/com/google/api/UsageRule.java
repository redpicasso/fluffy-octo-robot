...
public final class UsageRule extends GeneratedMessageLite<UsageRule, Builder> implements UsageRuleOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<UsageRule, Builder> implements UsageRuleOrBuilder {
        private Builder() {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, true ^ usageRule.selector_.isEmpty(), usageRule.selector_);
                boolean z = this.allowUnregisteredCalls_;
                boolean z2 = usageRule.allowUnregisteredCalls_;
                this.allowUnregisteredCalls_ = visitor.visitBoolean(z, z, z2, z2);
                z = this.skipServiceControl_;
                boolean z3 = usageRule.skipServiceControl_;
                this.skipServiceControl_ = visitor.visitBoolean(z, z, z3, z3);
