...
public final class Authentication extends GeneratedMessageLite<Authentication, Builder> implements AuthenticationOrBuilder {
    ...
    private ProtobufList<AuthProvider> providers_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<AuthenticationRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Authentication, Builder> implements AuthenticationOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((AuthenticationRule) builder.build());
    }

    private void addRules(int i, com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void setProviders(int i, com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();
    ...
    private void addProviders(com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();
        this.providers_.add((AuthProvider) builder.build());
    }

    private void addProviders(int i, com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.providers_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(4, (MessageLite) this.providers_.get(i));
        }
