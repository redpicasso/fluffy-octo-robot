...
public final class SystemParameterRule extends GeneratedMessageLite<SystemParameterRule, Builder> implements SystemParameterRuleOrBuilder {
    ...
    private ProtobufList<SystemParameter> parameters_ = GeneratedMessageLite.emptyProtobufList();
    private String selector_ = "";

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<SystemParameterRule, Builder> implements SystemParameterRuleOrBuilder {
        private Builder() {
    ...
    private void setParameters(int i, com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();
    ...
    private void addParameters(com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();
        this.parameters_.add((SystemParameter) builder.build());
    }

    private void addParameters(int i, com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();
    ...
    public int getSerializedSize() {
        ...
        while (i2 < this.parameters_.size()) {
            i += CodedOutputStream.computeMessageSize(2, (MessageLite) this.parameters_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, true ^ systemParameterRule.selector_.isEmpty(), systemParameterRule.selector_);
