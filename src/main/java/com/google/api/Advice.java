...
public final class Advice extends GeneratedMessageLite<Advice, Builder> implements AdviceOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Advice, Builder> implements AdviceOrBuilder {
        private Builder() {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.description_ = ((Visitor) obj).visitString(this.description_.isEmpty() ^ true, this.description_, true ^ advice.description_.isEmpty(), advice.description_);
