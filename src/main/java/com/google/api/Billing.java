...
public final class Billing extends GeneratedMessageLite<Billing, Builder> implements BillingOrBuilder {
    ...
    private ProtobufList<BillingDestination> consumerDestinations_ = GeneratedMessageLite.emptyProtobufList();
    ...
    public static final class BillingDestination extends GeneratedMessageLite<BillingDestination, Builder> implements BillingDestinationOrBuilder {
        ...
        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<BillingDestination, Builder> implements BillingDestinationOrBuilder {
            private Builder() {
        ...
        public int getSerializedSize() {
            ...
            int i2 = 0;
            i = !this.monitoredResource_.isEmpty() ? CodedOutputStream.computeStringSize(1, getMonitoredResource()) + 0 : 0;
            int i3 = 0;
            while (i2 < this.metrics_.size()) {
                i3 += CodedOutputStream.computeStringSizeNoTag((String) this.metrics_.get(i2));
                i2++;
            }
            i = (i + i3) + (getMetricsList().size() * 1);
        ...
        protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    this.monitoredResource_ = visitor.visitString(this.monitoredResource_.isEmpty() ^ true, this.monitoredResource_, true ^ billingDestination.monitoredResource_.isEmpty(), billingDestination.monitoredResource_);
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Billing, Builder> implements BillingOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.consumerDestinations_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(8, (MessageLite) this.consumerDestinations_.get(i));
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.consumerDestinations_ = ((Visitor) obj).visitList(this.consumerDestinations_, ((Billing) obj2).consumerDestinations_);
