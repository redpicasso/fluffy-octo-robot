...
public final class Backend extends GeneratedMessageLite<Backend, Builder> implements BackendOrBuilder {
    ...
    private ProtobufList<BackendRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Backend, Builder> implements BackendOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((BackendRule) builder.build());
    }

    private void addRules(int i, com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.rules_ = ((Visitor) obj).visitList(this.rules_, ((Backend) obj2).rules_);
