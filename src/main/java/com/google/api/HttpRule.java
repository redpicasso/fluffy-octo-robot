...
public final class HttpRule extends GeneratedMessageLite<HttpRule, Builder> implements HttpRuleOrBuilder {
    ...
    private ProtobufList<HttpRule> additionalBindings_;
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<HttpRule, Builder> implements HttpRuleOrBuilder {
        private Builder() {
    ...
    private void setCustom(com.google.api.CustomHttpPattern.Builder builder) {
    ...
    private void mergeCustom(CustomHttpPattern customHttpPattern) {
        if (this.patternCase_ != 8 || this.pattern_ == CustomHttpPattern.getDefaultInstance()) {
            ...
            this.pattern_ = ((com.google.api.CustomHttpPattern.Builder) CustomHttpPattern.newBuilder((CustomHttpPattern) this.pattern_).mergeFrom(customHttpPattern)).buildPartial();
        }
        this.patternCase_ = 8;
    }
    ...
    private void setAdditionalBindings(int i, Builder builder) {
        ensureAdditionalBindingsIsMutable();
    ...
    private void addAdditionalBindings(int i, Builder builder) {
        ensureAdditionalBindingsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = !this.selector_.isEmpty() ? CodedOutputStream.computeStringSize(1, getSelector()) + 0 : 0;
        if (this.patternCase_ == 2) {
            i += CodedOutputStream.computeStringSize(2, getGet());
        }
        if (this.patternCase_ == 3) {
            i += CodedOutputStream.computeStringSize(3, getPut());
        }
        if (this.patternCase_ == 4) {
            i += CodedOutputStream.computeStringSize(4, getPost());
        }
        if (this.patternCase_ == 5) {
            i += CodedOutputStream.computeStringSize(5, getDelete());
        }
        if (this.patternCase_ == 6) {
            i += CodedOutputStream.computeStringSize(6, getPatch());
        }
        if (!this.body_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(7, getBody());
        }
        if (this.patternCase_ == 8) {
            i += CodedOutputStream.computeMessageSize(8, (CustomHttpPattern) this.pattern_);
        }
        while (i2 < this.additionalBindings_.size()) {
            i += CodedOutputStream.computeMessageSize(11, (MessageLite) this.additionalBindings_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, httpRule.selector_.isEmpty() ^ true, httpRule.selector_);
                this.body_ = visitor.visitString(this.body_.isEmpty() ^ true, this.body_, httpRule.body_.isEmpty() ^ true, httpRule.body_);
                    ...
                    try {
                        ...
                        if (i != 0) {
                            ...
                            if (i == 10) {
                                ...
                                com.google.api.CustomHttpPattern.Builder builder = this.patternCase_ == 8 ? (com.google.api.CustomHttpPattern.Builder) ((CustomHttpPattern) this.pattern_).toBuilder() : null;
