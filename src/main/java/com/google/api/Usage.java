...
public final class Usage extends GeneratedMessageLite<Usage, Builder> implements UsageOrBuilder {
    ...
    private ProtobufList<String> requirements_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<UsageRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Usage, Builder> implements UsageOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((UsageRule) builder.build());
    }

    private void addRules(int i, com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        i2 = (i2 + 0) + (getRequirementsList().size() * 1);
        while (i < this.rules_.size()) {
            i2 += CodedOutputStream.computeMessageSize(6, (MessageLite) this.rules_.get(i));
            i++;
        }
        if (!this.producerNotificationChannel_.isEmpty()) {
            i2 += CodedOutputStream.computeStringSize(7, getProducerNotificationChannel());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.producerNotificationChannel_ = visitor.visitString(this.producerNotificationChannel_.isEmpty() ^ true, this.producerNotificationChannel_, true ^ usage.producerNotificationChannel_.isEmpty(), usage.producerNotificationChannel_);
