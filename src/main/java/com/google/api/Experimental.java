...
public final class Experimental extends GeneratedMessageLite<Experimental, Builder> implements ExperimentalOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Experimental, Builder> implements ExperimentalOrBuilder {
        private Builder() {
    ...
    private void setAuthorization(com.google.api.AuthorizationConfig.Builder builder) {
    ...
    private void mergeAuthorization(AuthorizationConfig authorizationConfig) {
        ...
        if (authorizationConfig2 == null || authorizationConfig2 == AuthorizationConfig.getDefaultInstance()) {
            ...
            this.authorization_ = (AuthorizationConfig) ((com.google.api.AuthorizationConfig.Builder) AuthorizationConfig.newBuilder(this.authorization_).mergeFrom(authorizationConfig)).buildPartial();
        }
    }
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (this.authorization_ != null) {
            i = 0 + CodedOutputStream.computeMessageSize(8, getAuthorization());
        }
    ...
    public static Experimental parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (Experimental) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }
    ...
    public static Experimental parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (Experimental) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.authorization_ = (AuthorizationConfig) ((Visitor) obj).visitMessage(this.authorization_, ((Experimental) obj2).authorization_);
            ...
            case MERGE_FROM_STREAM:
                ...
                while (obj3 == null) {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 66) {
                                com.google.api.AuthorizationConfig.Builder builder = this.authorization_ != null ? (com.google.api.AuthorizationConfig.Builder) this.authorization_.toBuilder() : null;
