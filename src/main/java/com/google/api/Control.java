...
public final class Control extends GeneratedMessageLite<Control, Builder> implements ControlOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Control, Builder> implements ControlOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.environment_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getEnvironment());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.environment_ = ((Visitor) obj).visitString(this.environment_.isEmpty() ^ true, this.environment_, true ^ control.environment_.isEmpty(), control.environment_);
