...
public final class ProjectProperties extends GeneratedMessageLite<ProjectProperties, Builder> implements ProjectPropertiesOrBuilder {
    ...
    private ProtobufList<Property> properties_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ProjectProperties, Builder> implements ProjectPropertiesOrBuilder {
        private Builder() {
    ...
    private void setProperties(int i, com.google.api.Property.Builder builder) {
        ensurePropertiesIsMutable();
    ...
    private void addProperties(com.google.api.Property.Builder builder) {
        ensurePropertiesIsMutable();
        this.properties_.add((Property) builder.build());
    }

    private void addProperties(int i, com.google.api.Property.Builder builder) {
        ensurePropertiesIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.properties_ = ((Visitor) obj).visitList(this.properties_, ((ProjectProperties) obj2).properties_);
