...
public final class Page extends GeneratedMessageLite<Page, Builder> implements PageOrBuilder {
    ...
    private ProtobufList<Page> subpages_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Page, Builder> implements PageOrBuilder {
        private Builder() {
    ...
    private void setSubpages(int i, Builder builder) {
        ensureSubpagesIsMutable();
    ...
    private void addSubpages(int i, Builder builder) {
        ensureSubpagesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        while (i2 < this.subpages_.size()) {
            i += CodedOutputStream.computeMessageSize(3, (MessageLite) this.subpages_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                Page page = (Page) obj2;
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, page.name_.isEmpty() ^ true, page.name_);
                this.content_ = visitor.visitString(this.content_.isEmpty() ^ true, this.content_, true ^ page.content_.isEmpty(), page.content_);
