...
public final class Logging extends GeneratedMessageLite<Logging, Builder> implements LoggingOrBuilder {
    ...
    private ProtobufList<LoggingDestination> consumerDestinations_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<LoggingDestination> producerDestinations_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Logging, Builder> implements LoggingOrBuilder {
        private Builder() {
    ...
    public static final class LoggingDestination extends GeneratedMessageLite<LoggingDestination, Builder> implements LoggingDestinationOrBuilder {
        ...
        private ProtobufList<String> logs_ = GeneratedMessageLite.emptyProtobufList();
        private String monitoredResource_ = "";

        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<LoggingDestination, Builder> implements LoggingDestinationOrBuilder {
            private Builder() {
        ...
        public int getSerializedSize() {
            ...
            i = (0 + i2) + (getLogsList().size() * 1);
            if (!this.monitoredResource_.isEmpty()) {
                i += CodedOutputStream.computeStringSize(3, getMonitoredResource());
            }
        ...
        protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (methodToInvoke) {
                ...
                case VISIT:
                    ...
                    this.monitoredResource_ = visitor.visitString(this.monitoredResource_.isEmpty() ^ true, this.monitoredResource_, true ^ loggingDestination.monitoredResource_.isEmpty(), loggingDestination.monitoredResource_);
    ...
    private void setProducerDestinations(int i, Builder builder) {
        ensureProducerDestinationsIsMutable();
    ...
    private void addProducerDestinations(Builder builder) {
        ensureProducerDestinationsIsMutable();
        this.producerDestinations_.add((LoggingDestination) builder.build());
    }

    private void addProducerDestinations(int i, Builder builder) {
        ensureProducerDestinationsIsMutable();
    ...
    private void setConsumerDestinations(int i, Builder builder) {
        ensureConsumerDestinationsIsMutable();
    ...
    private void addConsumerDestinations(Builder builder) {
        ensureConsumerDestinationsIsMutable();
        this.consumerDestinations_.add((LoggingDestination) builder.build());
    }

    private void addConsumerDestinations(int i, Builder builder) {
        ensureConsumerDestinationsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.consumerDestinations_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(2, (MessageLite) this.consumerDestinations_.get(i));
        }
