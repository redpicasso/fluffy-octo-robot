...
public final class ConfigChange extends GeneratedMessageLite<ConfigChange, Builder> implements ConfigChangeOrBuilder {
    ...
    private ProtobufList<Advice> advices_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ConfigChange, Builder> implements ConfigChangeOrBuilder {
        private Builder() {
    ...
    private void setAdvices(int i, com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();
    ...
    private void addAdvices(com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();
        this.advices_.add((Advice) builder.build());
    }

    private void addAdvices(int i, com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = !this.element_.isEmpty() ? CodedOutputStream.computeStringSize(1, getElement()) + 0 : 0;
        if (!this.oldValue_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getOldValue());
        }
        if (!this.newValue_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getNewValue());
        }
        if (this.changeType_ != ChangeType.CHANGE_TYPE_UNSPECIFIED.getNumber()) {
            i += CodedOutputStream.computeEnumSize(4, this.changeType_);
        }
        while (i2 < this.advices_.size()) {
            i += CodedOutputStream.computeMessageSize(5, (MessageLite) this.advices_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.element_ = visitor.visitString(this.element_.isEmpty() ^ true, this.element_, configChange.element_.isEmpty() ^ true, configChange.element_);
                this.oldValue_ = visitor.visitString(this.oldValue_.isEmpty() ^ true, this.oldValue_, configChange.oldValue_.isEmpty() ^ true, configChange.oldValue_);
                this.newValue_ = visitor.visitString(this.newValue_.isEmpty() ^ true, this.newValue_, configChange.newValue_.isEmpty() ^ true, configChange.newValue_);
