...
public final class SystemParameters extends GeneratedMessageLite<SystemParameters, Builder> implements SystemParametersOrBuilder {
    ...
    private ProtobufList<SystemParameterRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<SystemParameters, Builder> implements SystemParametersOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((SystemParameterRule) builder.build());
    }

    private void addRules(int i, com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.rules_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.rules_.get(i));
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.rules_ = ((Visitor) obj).visitList(this.rules_, ((SystemParameters) obj2).rules_);
