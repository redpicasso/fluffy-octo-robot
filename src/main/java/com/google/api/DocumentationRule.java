...
public final class DocumentationRule extends GeneratedMessageLite<DocumentationRule, Builder> implements DocumentationRuleOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<DocumentationRule, Builder> implements DocumentationRuleOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.deprecationDescription_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getDeprecationDescription());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, documentationRule.selector_.isEmpty() ^ true, documentationRule.selector_);
                this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, documentationRule.description_.isEmpty() ^ true, documentationRule.description_);
                this.deprecationDescription_ = visitor.visitString(this.deprecationDescription_.isEmpty() ^ true, this.deprecationDescription_, true ^ documentationRule.deprecationDescription_.isEmpty(), documentationRule.deprecationDescription_);
