...
public final class ContextRule extends GeneratedMessageLite<ContextRule, Builder> implements ContextRuleOrBuilder {
    ...
    private ProtobufList<String> provided_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<String> requested_ = GeneratedMessageLite.emptyProtobufList();
    private String selector_ = "";

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ContextRule, Builder> implements ContextRuleOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        int i4 = 0;
        for (i2 = 0; i2 < this.requested_.size(); i2++) {
            i4 += CodedOutputStream.computeStringSizeNoTag((String) this.requested_.get(i2));
        }
        i = (i + i4) + (getRequestedList().size() * 1);
        i2 = 0;
        while (i3 < this.provided_.size()) {
            i2 += CodedOutputStream.computeStringSizeNoTag((String) this.provided_.get(i3));
            i3++;
        }
        i = (i + i2) + (getProvidedList().size() * 1);
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, true ^ contextRule.selector_.isEmpty(), contextRule.selector_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            ...
                            if (readTag == 10) {
                                ...
                                this.provided_.add(readStringRequireUtf8);
