...
public final class SourceInfo extends GeneratedMessageLite<SourceInfo, Builder> implements SourceInfoOrBuilder {
    ...
    private ProtobufList<Any> sourceFiles_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<SourceInfo, Builder> implements SourceInfoOrBuilder {
        private Builder() {
    ...
    private void setSourceFiles(int i, com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();
    ...
    private void addSourceFiles(com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();
        this.sourceFiles_.add((Any) builder.build());
    }

    private void addSourceFiles(int i, com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        for (i = 0; i < this.sourceFiles_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.sourceFiles_.get(i));
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.sourceFiles_ = ((Visitor) obj).visitList(this.sourceFiles_, ((SourceInfo) obj2).sourceFiles_);
