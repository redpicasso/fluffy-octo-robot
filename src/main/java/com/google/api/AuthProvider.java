...
public final class AuthProvider extends GeneratedMessageLite<AuthProvider, Builder> implements AuthProviderOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<AuthProvider, Builder> implements AuthProviderOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.issuer_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getIssuer());
        }
        if (!this.jwksUri_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getJwksUri());
        }
        if (!this.audiences_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(4, getAudiences());
        }
        if (!this.authorizationUrl_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(5, getAuthorizationUrl());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.id_ = visitor.visitString(this.id_.isEmpty() ^ true, this.id_, authProvider.id_.isEmpty() ^ true, authProvider.id_);
                this.issuer_ = visitor.visitString(this.issuer_.isEmpty() ^ true, this.issuer_, authProvider.issuer_.isEmpty() ^ true, authProvider.issuer_);
                this.jwksUri_ = visitor.visitString(this.jwksUri_.isEmpty() ^ true, this.jwksUri_, authProvider.jwksUri_.isEmpty() ^ true, authProvider.jwksUri_);
                this.audiences_ = visitor.visitString(this.audiences_.isEmpty() ^ true, this.audiences_, authProvider.audiences_.isEmpty() ^ true, authProvider.audiences_);
                this.authorizationUrl_ = visitor.visitString(this.authorizationUrl_.isEmpty() ^ true, this.authorizationUrl_, true ^ authProvider.authorizationUrl_.isEmpty(), authProvider.authorizationUrl_);
