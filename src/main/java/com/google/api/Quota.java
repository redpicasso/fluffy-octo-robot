...
public final class Quota extends GeneratedMessageLite<Quota, Builder> implements QuotaOrBuilder {
    ...
    private ProtobufList<QuotaLimit> limits_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<MetricRule> metricRules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Quota, Builder> implements QuotaOrBuilder {
        private Builder() {
    ...
    private void setLimits(int i, com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
    ...
    private void addLimits(com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
        this.limits_.add((QuotaLimit) builder.build());
    }

    private void addLimits(int i, com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
    ...
    private void setMetricRules(int i, com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();
    ...
    private void addMetricRules(com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();
        this.metricRules_.add((MetricRule) builder.build());
    }

    private void addMetricRules(int i, com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.metricRules_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(4, (MessageLite) this.metricRules_.get(i));
        }
