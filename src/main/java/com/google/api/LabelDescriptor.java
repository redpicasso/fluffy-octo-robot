...
public final class LabelDescriptor extends GeneratedMessageLite<LabelDescriptor, Builder> implements LabelDescriptorOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<LabelDescriptor, Builder> implements LabelDescriptorOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (this.valueType_ != ValueType.STRING.getNumber()) {
            i += CodedOutputStream.computeEnumSize(2, this.valueType_);
        }
        if (!this.description_.isEmpty()) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.key_ = visitor.visitString(this.key_.isEmpty() ^ true, this.key_, labelDescriptor.key_.isEmpty() ^ true, labelDescriptor.key_);
                ...
                this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, labelDescriptor.description_.isEmpty() ^ true, labelDescriptor.description_);
