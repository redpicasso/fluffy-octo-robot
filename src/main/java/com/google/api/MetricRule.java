...
public final class MetricRule extends GeneratedMessageLite<MetricRule, Builder> implements MetricRuleOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<MetricRule, Builder> implements MetricRuleOrBuilder {
        private Builder() {
        ...
        public long getMetricCostsOrDefault(String str, long j) {
            if (str != null) {
                Map metricCostsMap = ((MetricRule) this.instance).getMetricCostsMap();
                return metricCostsMap.containsKey(str) ? ((Long) metricCostsMap.get(str)).longValue() : j;
            } else {
                throw new NullPointerException();
            }
        }
        ...
        public long getMetricCostsOrThrow(String str) {
            if (str != null) {
                ...
                if (metricCostsMap.containsKey(str)) {
                    return ((Long) metricCostsMap.get(str)).longValue();
                }
    ...
    public long getMetricCostsOrDefault(String str, long j) {
        if (str != null) {
            Map internalGetMetricCosts = internalGetMetricCosts();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (Entry entry : internalGetMetricCosts().entrySet()) {
    ...
    public int getSerializedSize() {
        ...
        for (Entry entry : internalGetMetricCosts().entrySet()) {
            i += MetricCostsDefaultEntryHolder.defaultEntry.computeMessageSize(2, (String) entry.getKey(), (Long) entry.getValue());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.selector_ = visitor.visitString(this.selector_.isEmpty() ^ true, this.selector_, true ^ metricRule.selector_.isEmpty(), metricRule.selector_);
