...
public final class Http extends GeneratedMessageLite<Http, Builder> implements HttpOrBuilder {
    ...
    private ProtobufList<HttpRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Http, Builder> implements HttpOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((HttpRule) builder.build());
    }

    private void addRules(int i, com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();
