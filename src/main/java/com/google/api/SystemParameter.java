...
public final class SystemParameter extends GeneratedMessageLite<SystemParameter, Builder> implements SystemParameterOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<SystemParameter, Builder> implements SystemParameterOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.httpHeader_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getHttpHeader());
        }
        if (!this.urlQueryParameter_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getUrlQueryParameter());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, systemParameter.name_.isEmpty() ^ true, systemParameter.name_);
                this.httpHeader_ = visitor.visitString(this.httpHeader_.isEmpty() ^ true, this.httpHeader_, systemParameter.httpHeader_.isEmpty() ^ true, systemParameter.httpHeader_);
                this.urlQueryParameter_ = visitor.visitString(this.urlQueryParameter_.isEmpty() ^ true, this.urlQueryParameter_, true ^ systemParameter.urlQueryParameter_.isEmpty(), systemParameter.urlQueryParameter_);
