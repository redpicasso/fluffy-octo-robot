...
public final class Documentation extends GeneratedMessageLite<Documentation, Builder> implements DocumentationOrBuilder {
    ...
    private ProtobufList<Page> pages_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<DocumentationRule> rules_ = GeneratedMessageLite.emptyProtobufList();
    private String summary_;

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Documentation, Builder> implements DocumentationOrBuilder {
        private Builder() {
    ...
    private void setPages(int i, com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
    ...
    private void addPages(com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
        this.pages_.add((Page) builder.build());
    }

    private void addPages(int i, com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
    ...
    private void setRules(int i, com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((DocumentationRule) builder.build());
    }

    private void addRules(int i, com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int i2 = 0; i2 < this.rules_.size(); i2++) {
            codedOutputStream.writeMessage(3, (MessageLite) this.rules_.get(i2));
        }
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = !this.summary_.isEmpty() ? CodedOutputStream.computeStringSize(1, getSummary()) + 0 : 0;
        if (!this.overview_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getOverview());
        }
        int i3 = i;
        for (i = 0; i < this.rules_.size(); i++) {
            i3 += CodedOutputStream.computeMessageSize(3, (MessageLite) this.rules_.get(i));
        }
        if (!this.documentationRootUrl_.isEmpty()) {
            i3 += CodedOutputStream.computeStringSize(4, getDocumentationRootUrl());
        }
        while (i2 < this.pages_.size()) {
            i3 += CodedOutputStream.computeMessageSize(5, (MessageLite) this.pages_.get(i2));
            i2++;
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.summary_ = visitor.visitString(this.summary_.isEmpty() ^ true, this.summary_, documentation.summary_.isEmpty() ^ true, documentation.summary_);
                ...
                this.documentationRootUrl_ = visitor.visitString(this.documentationRootUrl_.isEmpty() ^ true, this.documentationRootUrl_, documentation.documentationRootUrl_.isEmpty() ^ true, documentation.documentationRootUrl_);
                this.overview_ = visitor.visitString(this.overview_.isEmpty() ^ true, this.overview_, true ^ documentation.overview_.isEmpty(), documentation.overview_);
