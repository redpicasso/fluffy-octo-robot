...
public final class Context extends GeneratedMessageLite<Context, Builder> implements ContextOrBuilder {
    ...
    private ProtobufList<ContextRule> rules_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Context, Builder> implements ContextOrBuilder {
        private Builder() {
    ...
    private void setRules(int i, com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    private void addRules(com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((ContextRule) builder.build());
    }

    private void addRules(int i, com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.rules_ = ((Visitor) obj).visitList(this.rules_, ((Context) obj2).rules_);
