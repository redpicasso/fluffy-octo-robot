...
public final class MonitoredResource extends GeneratedMessageLite<MonitoredResource, Builder> implements MonitoredResourceOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<MonitoredResource, Builder> implements MonitoredResourceOrBuilder {
        private Builder() {
        ...
        public String getLabelsOrDefault(String str, String str2) {
            if (str != null) {
                Map labelsMap = ((MonitoredResource) this.instance).getLabelsMap();
    ...
    public int getSerializedSize() {
        ...
        for (Entry entry : internalGetLabels().entrySet()) {
            i += LabelsDefaultEntryHolder.defaultEntry.computeMessageSize(2, (String) entry.getKey(), (String) entry.getValue());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.type_ = visitor.visitString(this.type_.isEmpty() ^ true, this.type_, true ^ monitoredResource.type_.isEmpty(), monitoredResource.type_);
