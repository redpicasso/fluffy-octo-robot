...
public final class MetricDescriptor extends GeneratedMessageLite<MetricDescriptor, Builder> implements MetricDescriptorOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public enum MetricKind implements EnumLite {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public enum ValueType implements EnumLite {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<MetricDescriptor, Builder> implements MetricDescriptorOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (this.metricKind_ != MetricKind.METRIC_KIND_UNSPECIFIED.getNumber()) {
            i += CodedOutputStream.computeEnumSize(3, this.metricKind_);
        }
        if (this.valueType_ != ValueType.VALUE_TYPE_UNSPECIFIED.getNumber()) {
            i += CodedOutputStream.computeEnumSize(4, this.valueType_);
        }
        if (!this.unit_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(5, getUnit());
        }
        if (!this.description_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(6, getDescription());
        }
        if (!this.displayName_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(7, getDisplayName());
        }
        if (!this.type_.isEmpty()) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, metricDescriptor.name_.isEmpty() ^ true, metricDescriptor.name_);
                this.type_ = visitor.visitString(this.type_.isEmpty() ^ true, this.type_, metricDescriptor.type_.isEmpty() ^ true, metricDescriptor.type_);
                ...
                this.unit_ = visitor.visitString(this.unit_.isEmpty() ^ true, this.unit_, metricDescriptor.unit_.isEmpty() ^ true, metricDescriptor.unit_);
                this.description_ = visitor.visitString(this.description_.isEmpty() ^ true, this.description_, metricDescriptor.description_.isEmpty() ^ true, metricDescriptor.description_);
                this.displayName_ = visitor.visitString(this.displayName_.isEmpty() ^ true, this.displayName_, metricDescriptor.displayName_.isEmpty() ^ true, metricDescriptor.displayName_);
