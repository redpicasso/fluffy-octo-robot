...
public final class Cursor extends GeneratedMessageLite<Cursor, Builder> implements CursorOrBuilder {
    ...
    private ProtobufList<Value> values_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Cursor, Builder> implements CursorOrBuilder {
        private Builder() {
        ...
        public Builder setValues(int i, com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
        ...
        public Builder addValues(com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
            ((Cursor) this.instance).addValues(builder);
            return this;
        }

        public Builder addValues(int i, com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
    ...
    private void setValues(int i, com.google.firestore.v1.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    private void addValues(com.google.firestore.v1.Value.Builder builder) {
        ensureValuesIsMutable();
        this.values_.add((Value) builder.build());
    }

    private void addValues(int i, com.google.firestore.v1.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    private void setBefore(boolean z) {
        this.before_ = z;
    }
    ...
    public static Cursor parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (Cursor) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
