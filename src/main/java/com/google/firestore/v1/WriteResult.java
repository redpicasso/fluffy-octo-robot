...
public final class WriteResult extends GeneratedMessageLite<WriteResult, Builder> implements WriteResultOrBuilder {
    ...
    private ProtobufList<Value> transformResults_ = GeneratedMessageLite.emptyProtobufList();
    private Timestamp updateTime_;

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteResult, Builder> implements WriteResultOrBuilder {
        private Builder() {
        ...
        public Builder setTransformResults(int i, com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
        ...
        public Builder addTransformResults(com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
            ((WriteResult) this.instance).addTransformResults(builder);
            return this;
        }

        public Builder addTransformResults(int i, com.google.firestore.v1.Value.Builder builder) {
            copyOnWrite();
    ...
    private void setTransformResults(int i, Value value) {
        if (value != null) {
    ...
    private void setTransformResults(int i, com.google.firestore.v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();
    ...
    private void addTransformResults(int i, Value value) {
        if (value != null) {
            ensureTransformResultsIsMutable();
    ...
    private void addTransformResults(com.google.firestore.v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();
        this.transformResults_.add((Value) builder.build());
    }

    private void addTransformResults(int i, com.google.firestore.v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = this.updateTime_ != null ? CodedOutputStream.computeMessageSize(1, getUpdateTime()) + 0 : 0;
        while (i2 < this.transformResults_.size()) {
            i += CodedOutputStream.computeMessageSize(2, (MessageLite) this.transformResults_.get(i2));
            i2++;
        }
    ...
    public static WriteResult parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (WriteResult) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
            ...
            case MERGE_FROM_STREAM:
                ...
                while (obj3 == null) {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                com.google.protobuf.Timestamp.Builder builder = this.updateTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.updateTime_.toBuilder() : null;
