...
public final class MapValue extends GeneratedMessageLite<MapValue, Builder> implements MapValueOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<MapValue, Builder> implements MapValueOrBuilder {
        private Builder() {
        ...
        public Value getFieldsOrDefault(String str, Value value) {
            if (str != null) {
                Map fieldsMap = ((MapValue) this.instance).getFieldsMap();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        for (Entry entry : internalGetFields().entrySet()) {
            FieldsDefaultEntryHolder.defaultEntry.serializeTo(codedOutputStream, 1, (String) entry.getKey(), (Value) entry.getValue());
        }
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.fields_ = ((Visitor) obj).visitMap(this.fields_, ((MapValue) obj2).internalGetFields());
