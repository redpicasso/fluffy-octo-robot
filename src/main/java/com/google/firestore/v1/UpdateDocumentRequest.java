...
public final class UpdateDocumentRequest extends GeneratedMessageLite<UpdateDocumentRequest, Builder> implements UpdateDocumentRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<UpdateDocumentRequest, Builder> implements UpdateDocumentRequestOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (this.document_ != null) {
            i = 0 + CodedOutputStream.computeMessageSize(1, getDocument());
        }
        if (this.updateMask_ != null) {
            i += CodedOutputStream.computeMessageSize(2, getUpdateMask());
        }
        if (this.mask_ != null) {
    ...
    public static UpdateDocumentRequest parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (UpdateDocumentRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
            ...
            case MERGE_FROM_STREAM:
                ...
                while (obj3 == null) {
                    try {
                        ...
                        if (readTag != 0) {
                            com.google.firestore.v1.DocumentMask.Builder builder;
                            if (readTag == 10) {
                                com.google.firestore.v1.Document.Builder builder2 = this.document_ != null ? (com.google.firestore.v1.Document.Builder) this.document_.toBuilder() : null;
                                this.document_ = (Document) codedInputStream.readMessage(Document.parser(), extensionRegistryLite);
                                if (builder2 != null) {
                                    builder2.mergeFrom(this.document_);
                                    this.document_ = (Document) builder2.buildPartial();
                                }
                            } else if (readTag == 18) {
                                builder = this.updateMask_ != null ? (com.google.firestore.v1.DocumentMask.Builder) this.updateMask_.toBuilder() : null;
                                ...
                                builder = this.mask_ != null ? (com.google.firestore.v1.DocumentMask.Builder) this.mask_.toBuilder() : null;
