...
public final class WriteResponse extends GeneratedMessageLite<WriteResponse, Builder> implements WriteResponseOrBuilder {
    ...
    private ProtobufList<WriteResult> writeResults_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteResponse, Builder> implements WriteResponseOrBuilder {
        private Builder() {
        ...
        public Builder setWriteResults(int i, com.google.firestore.v1.WriteResult.Builder builder) {
            copyOnWrite();
        ...
        public Builder addWriteResults(com.google.firestore.v1.WriteResult.Builder builder) {
            copyOnWrite();
            ((WriteResponse) this.instance).addWriteResults(builder);
            return this;
        }

        public Builder addWriteResults(int i, com.google.firestore.v1.WriteResult.Builder builder) {
            copyOnWrite();
        ...
        public Builder setCommitTime(com.google.protobuf.Timestamp.Builder builder) {
            copyOnWrite();
    ...
    private void setWriteResults(int i, WriteResult writeResult) {
        if (writeResult != null) {
    ...
    private void setWriteResults(int i, com.google.firestore.v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
    ...
    private void addWriteResults(int i, WriteResult writeResult) {
        if (writeResult != null) {
            ensureWriteResultsIsMutable();
    ...
    private void addWriteResults(com.google.firestore.v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
        this.writeResults_.add((WriteResult) builder.build());
    }

    private void addWriteResults(int i, com.google.firestore.v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
    ...
    private void removeWriteResults(int i) {
        ensureWriteResultsIsMutable();
    ...
    private void setCommitTime(com.google.protobuf.Timestamp.Builder builder) {
    ...
    private void mergeCommitTime(Timestamp timestamp) {
        ...
        if (timestamp2 == null || timestamp2 == Timestamp.getDefaultInstance()) {
            ...
            this.commitTime_ = (Timestamp) ((com.google.protobuf.Timestamp.Builder) Timestamp.newBuilder(this.commitTime_).mergeFrom(timestamp)).buildPartial();
        }
    }
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = !this.streamId_.isEmpty() ? CodedOutputStream.computeStringSize(1, getStreamId()) + 0 : 0;
        if (!this.streamToken_.isEmpty()) {
            i += CodedOutputStream.computeBytesSize(2, this.streamToken_);
        }
        while (i2 < this.writeResults_.size()) {
            i += CodedOutputStream.computeMessageSize(3, (MessageLite) this.writeResults_.get(i2));
            i2++;
        }
        if (this.commitTime_ != null) {
            i += CodedOutputStream.computeMessageSize(4, getCommitTime());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.streamId_ = visitor.visitString(this.streamId_.isEmpty() ^ true, this.streamId_, writeResponse.streamId_.isEmpty() ^ true, writeResponse.streamId_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.commitTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.commitTime_.toBuilder() : null;
