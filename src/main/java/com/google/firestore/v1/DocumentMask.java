...
public final class DocumentMask extends GeneratedMessageLite<DocumentMask, Builder> implements DocumentMaskOrBuilder {
    ...
    private ProtobufList<String> fieldPaths_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<DocumentMask, Builder> implements DocumentMaskOrBuilder {
        private Builder() {
    ...
    private void setFieldPaths(int i, String str) {
        if (str != null) {
    ...
    private void addFieldPaths(String str) {
        if (str != null) {
            ensureFieldPathsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        i = (0 + i2) + (getFieldPathsList().size() * 1);
    ...
    public static DocumentMask parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (DocumentMask) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.fieldPaths_ = ((Visitor) obj).visitList(this.fieldPaths_, ((DocumentMask) obj2).fieldPaths_);
