...
public final class DocumentDelete extends GeneratedMessageLite<DocumentDelete, Builder> implements DocumentDeleteOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<DocumentDelete, Builder> implements DocumentDeleteOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        int i3 = 0;
        while (i2 < this.removedTargetIds_.size()) {
            i3 += CodedOutputStream.computeInt32SizeNoTag(this.removedTargetIds_.getInt(i2));
            i2++;
        }
        i = (i + i3) + (getRemovedTargetIdsList().size() * 1);
    ...
    public static DocumentDelete parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (DocumentDelete) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.document_ = visitor.visitString(this.document_.isEmpty() ^ true, this.document_, true ^ documentDelete.document_.isEmpty(), documentDelete.document_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.readTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.readTime_.toBuilder() : null;
