...
public final class ListDocumentsResponse extends GeneratedMessageLite<ListDocumentsResponse, Builder> implements ListDocumentsResponseOrBuilder {
    ...
    private ProtobufList<Document> documents_ = GeneratedMessageLite.emptyProtobufList();
    private String nextPageToken_ = "";

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListDocumentsResponse, Builder> implements ListDocumentsResponseOrBuilder {
        private Builder() {
        ...
        public Builder setDocuments(int i, com.google.firestore.v1.Document.Builder builder) {
            copyOnWrite();
        ...
        public Builder addDocuments(com.google.firestore.v1.Document.Builder builder) {
            copyOnWrite();
            ((ListDocumentsResponse) this.instance).addDocuments(builder);
            return this;
        }

        public Builder addDocuments(int i, com.google.firestore.v1.Document.Builder builder) {
            copyOnWrite();
    ...
    private void setDocuments(int i, Document document) {
        if (document != null) {
    ...
    private void setDocuments(int i, com.google.firestore.v1.Document.Builder builder) {
        ensureDocumentsIsMutable();
    ...
    private void addDocuments(int i, Document document) {
        if (document != null) {
            ensureDocumentsIsMutable();
    ...
    private void addDocuments(com.google.firestore.v1.Document.Builder builder) {
        ensureDocumentsIsMutable();
        this.documents_.add((Document) builder.build());
    }

    private void addDocuments(int i, com.google.firestore.v1.Document.Builder builder) {
        ensureDocumentsIsMutable();
    ...
    private void removeDocuments(int i) {
        ensureDocumentsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        for (i = 0; i < this.documents_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.documents_.get(i));
        }
        if (!this.nextPageToken_.isEmpty()) {
    ...
    public static ListDocumentsResponse parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (ListDocumentsResponse) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.nextPageToken_ = visitor.visitString(this.nextPageToken_.isEmpty() ^ true, this.nextPageToken_, true ^ listDocumentsResponse.nextPageToken_.isEmpty(), listDocumentsResponse.nextPageToken_);
