...
public final class TargetChange extends GeneratedMessageLite<TargetChange, Builder> implements TargetChangeOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public enum TargetChangeType implements EnumLite {
        NO_CHANGE(0),
        ADD(1),
        REMOVE(2),
        CURRENT(3),
        ...
        private static final EnumLiteMap<TargetChangeType> internalValueMap = null;
        private final int value;

        static {
            internalValueMap = new EnumLiteMap<TargetChangeType>() {
        ...
        public static TargetChangeType forNumber(int i) {
            ...
            if (i != 3) {
                return i != 4 ? null : RESET;
            } else {
                return CURRENT;
            }
        }

        public static EnumLiteMap<TargetChangeType> internalGetValueMap() {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<TargetChange, Builder> implements TargetChangeOrBuilder {
        private Builder() {
        ...
        public Builder setCause(com.google.rpc.Status.Builder builder) {
            copyOnWrite();
    ...
    private void setTargetChangeTypeValue(int i) {
    ...
    private void setCause(com.google.rpc.Status.Builder builder) {
    ...
    private void mergeCause(Status status) {
        ...
        if (status2 == null || status2 == Status.getDefaultInstance()) {
            ...
            this.cause_ = (Status) ((com.google.rpc.Status.Builder) Status.newBuilder(this.cause_).mergeFrom(status)).buildPartial();
        }
    }
    ...
    public int getSerializedSize() {
        ...
        int i2 = 0;
        i = this.targetChangeType_ != TargetChangeType.NO_CHANGE.getNumber() ? CodedOutputStream.computeEnumSize(1, this.targetChangeType_) + 0 : 0;
        int i3 = 0;
        while (i2 < this.targetIds_.size()) {
            i3 += CodedOutputStream.computeInt32SizeNoTag(this.targetIds_.getInt(i2));
            i2++;
        }
        i = (i + i3) + (getTargetIdsList().size() * 1);
        if (this.cause_ != null) {
            i += CodedOutputStream.computeMessageSize(3, getCause());
        }
        if (!this.resumeToken_.isEmpty()) {
            i += CodedOutputStream.computeBytesSize(4, this.resumeToken_);
        }
        if (this.readTime_ != null) {
            i += CodedOutputStream.computeMessageSize(6, getReadTime());
        }
    ...
    public static TargetChange parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (TargetChange) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                com.google.rpc.Status.Builder builder = this.cause_ != null ? (com.google.rpc.Status.Builder) this.cause_.toBuilder() : null;
