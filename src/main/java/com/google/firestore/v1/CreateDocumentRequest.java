...
public final class CreateDocumentRequest extends GeneratedMessageLite<CreateDocumentRequest, Builder> implements CreateDocumentRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<CreateDocumentRequest, Builder> implements CreateDocumentRequestOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.documentId_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getDocumentId());
        }
        if (this.document_ != null) {
            i += CodedOutputStream.computeMessageSize(4, getDocument());
        }
        if (this.mask_ != null) {
            i += CodedOutputStream.computeMessageSize(5, getMask());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.parent_ = visitor.visitString(this.parent_.isEmpty() ^ true, this.parent_, createDocumentRequest.parent_.isEmpty() ^ true, createDocumentRequest.parent_);
                this.collectionId_ = visitor.visitString(this.collectionId_.isEmpty() ^ true, this.collectionId_, createDocumentRequest.collectionId_.isEmpty() ^ true, createDocumentRequest.collectionId_);
                this.documentId_ = visitor.visitString(this.documentId_.isEmpty() ^ true, this.documentId_, true ^ createDocumentRequest.documentId_.isEmpty(), createDocumentRequest.documentId_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.firestore.v1.DocumentMask.Builder builder2 = this.mask_ != null ? (com.google.firestore.v1.DocumentMask.Builder) this.mask_.toBuilder() : null;
