...
public final class WriteRequest extends GeneratedMessageLite<WriteRequest, Builder> implements WriteRequestOrBuilder {
    ...
    private ProtobufList<Write> writes_;
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteRequest, Builder> implements WriteRequestOrBuilder {
        private Builder() {
        ...
        public String getLabelsOrDefault(String str, String str2) {
            if (str != null) {
                Map labelsMap = ((WriteRequest) this.instance).getLabelsMap();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (Entry entry : internalGetLabels().entrySet()) {
            LabelsDefaultEntryHolder.defaultEntry.serializeTo(codedOutputStream, 5, (String) entry.getKey(), (String) entry.getValue());
        }
    }
    ...
    public int getSerializedSize() {
        ...
        if (!this.streamId_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getStreamId());
        }
        while (i2 < this.writes_.size()) {
            i += CodedOutputStream.computeMessageSize(3, (MessageLite) this.writes_.get(i2));
            i2++;
        }
        if (!this.streamToken_.isEmpty()) {
            i += CodedOutputStream.computeBytesSize(4, this.streamToken_);
        }
        for (Entry entry : internalGetLabels().entrySet()) {
            i += LabelsDefaultEntryHolder.defaultEntry.computeMessageSize(5, (String) entry.getKey(), (String) entry.getValue());
        }
    ...
    public static WriteRequest parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (WriteRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.database_ = visitor.visitString(this.database_.isEmpty() ^ true, this.database_, writeRequest.database_.isEmpty() ^ true, writeRequest.database_);
                this.streamId_ = visitor.visitString(this.streamId_.isEmpty() ^ true, this.streamId_, writeRequest.streamId_.isEmpty() ^ true, writeRequest.streamId_);
