...
public final class BeginTransactionRequest extends GeneratedMessageLite<BeginTransactionRequest, Builder> implements BeginTransactionRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<BeginTransactionRequest, Builder> implements BeginTransactionRequestOrBuilder {
        private Builder() {
        ...
        public Builder setOptions(com.google.firestore.v1.TransactionOptions.Builder builder) {
            copyOnWrite();
    ...
    private void setOptions(com.google.firestore.v1.TransactionOptions.Builder builder) {
    ...
    private void mergeOptions(TransactionOptions transactionOptions) {
        ...
        if (transactionOptions2 == null || transactionOptions2 == TransactionOptions.getDefaultInstance()) {
            ...
            this.options_ = (TransactionOptions) ((com.google.firestore.v1.TransactionOptions.Builder) TransactionOptions.newBuilder(this.options_).mergeFrom(transactionOptions)).buildPartial();
        }
    }
    ...
    public static BeginTransactionRequest parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (BeginTransactionRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.database_ = visitor.visitString(this.database_.isEmpty() ^ true, this.database_, true ^ beginTransactionRequest.database_.isEmpty(), beginTransactionRequest.database_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.firestore.v1.TransactionOptions.Builder builder = this.options_ != null ? (com.google.firestore.v1.TransactionOptions.Builder) this.options_.toBuilder() : null;
