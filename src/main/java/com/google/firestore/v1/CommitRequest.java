...
public final class CommitRequest extends GeneratedMessageLite<CommitRequest, Builder> implements CommitRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<CommitRequest, Builder> implements CommitRequestOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        while (i2 < this.writes_.size()) {
            i += CodedOutputStream.computeMessageSize(2, (MessageLite) this.writes_.get(i2));
            i2++;
        }
        if (!this.transaction_.isEmpty()) {
    ...
    public static CommitRequest parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (CommitRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.database_ = visitor.visitString(this.database_.isEmpty() ^ true, this.database_, commitRequest.database_.isEmpty() ^ true, commitRequest.database_);
