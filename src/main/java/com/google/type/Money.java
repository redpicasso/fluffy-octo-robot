...
public final class Money extends GeneratedMessageLite<Money, Builder> implements MoneyOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Money, Builder> implements MoneyOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.currencyCode_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getCurrencyCode());
        }
        long j = this.units_;
        if (j != 0) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.currencyCode_ = visitor.visitString(this.currencyCode_.isEmpty() ^ true, this.currencyCode_, money.currencyCode_.isEmpty() ^ true, money.currencyCode_);
