...
public final class PostalAddress extends GeneratedMessageLite<PostalAddress, Builder> implements PostalAddressOrBuilder {
    ...
    private ProtobufList<String> addressLines_ = GeneratedMessageLite.emptyProtobufList();
    ...
    private ProtobufList<String> recipients_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<PostalAddress, Builder> implements PostalAddressOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = this.revision_;
        int i3 = 0;
        i = i != 0 ? CodedOutputStream.computeInt32Size(1, i) + 0 : 0;
        if (!this.regionCode_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getRegionCode());
        }
        if (!this.languageCode_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(3, getLanguageCode());
        }
        if (!this.postalCode_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(4, getPostalCode());
        }
        if (!this.sortingCode_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(5, getSortingCode());
        }
        if (!this.administrativeArea_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(6, getAdministrativeArea());
        }
        if (!this.locality_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(7, getLocality());
        }
        if (!this.sublocality_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(8, getSublocality());
        }
        int i4 = 0;
        for (i2 = 0; i2 < this.addressLines_.size(); i2++) {
            i4 += CodedOutputStream.computeStringSizeNoTag((String) this.addressLines_.get(i2));
        }
        i = (i + i4) + (getAddressLinesList().size() * 1);
        i2 = 0;
        while (i3 < this.recipients_.size()) {
            i2 += CodedOutputStream.computeStringSizeNoTag((String) this.recipients_.get(i3));
            i3++;
        }
        i = (i + i2) + (getRecipientsList().size() * 1);
        if (!this.organization_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(11, getOrganization());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.regionCode_ = visitor.visitString(this.regionCode_.isEmpty() ^ true, this.regionCode_, postalAddress.regionCode_.isEmpty() ^ true, postalAddress.regionCode_);
                this.languageCode_ = visitor.visitString(this.languageCode_.isEmpty() ^ true, this.languageCode_, postalAddress.languageCode_.isEmpty() ^ true, postalAddress.languageCode_);
                this.postalCode_ = visitor.visitString(this.postalCode_.isEmpty() ^ true, this.postalCode_, postalAddress.postalCode_.isEmpty() ^ true, postalAddress.postalCode_);
                this.sortingCode_ = visitor.visitString(this.sortingCode_.isEmpty() ^ true, this.sortingCode_, postalAddress.sortingCode_.isEmpty() ^ true, postalAddress.sortingCode_);
                this.administrativeArea_ = visitor.visitString(this.administrativeArea_.isEmpty() ^ true, this.administrativeArea_, postalAddress.administrativeArea_.isEmpty() ^ true, postalAddress.administrativeArea_);
                this.locality_ = visitor.visitString(this.locality_.isEmpty() ^ true, this.locality_, postalAddress.locality_.isEmpty() ^ true, postalAddress.locality_);
                this.sublocality_ = visitor.visitString(this.sublocality_.isEmpty() ^ true, this.sublocality_, postalAddress.sublocality_.isEmpty() ^ true, postalAddress.sublocality_);
                ...
                this.organization_ = visitor.visitString(this.organization_.isEmpty() ^ true, this.organization_, postalAddress.organization_.isEmpty() ^ true, postalAddress.organization_);
                    ...
                    try {
                        ...
                        switch (readTag) {
                            ...
                            case 82:
                                ...
                                this.recipients_.add(readStringRequireUtf8);
                                break;
                            case 90:
