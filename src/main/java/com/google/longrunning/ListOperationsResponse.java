...
public final class ListOperationsResponse extends GeneratedMessageLite<ListOperationsResponse, Builder> implements ListOperationsResponseOrBuilder {
    ...
    private ProtobufList<Operation> operations_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListOperationsResponse, Builder> implements ListOperationsResponseOrBuilder {
        private Builder() {
    ...
    private void setOperations(int i, com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();
    ...
    private void addOperations(com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();
        this.operations_.add((Operation) builder.build());
    }

    private void addOperations(int i, com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.operations_.size(); i++) {
            i2 += CodedOutputStream.computeMessageSize(1, (MessageLite) this.operations_.get(i));
        }
        if (!this.nextPageToken_.isEmpty()) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.nextPageToken_ = visitor.visitString(this.nextPageToken_.isEmpty() ^ true, this.nextPageToken_, true ^ listOperationsResponse.nextPageToken_.isEmpty(), listOperationsResponse.nextPageToken_);
