...
public final class ListOperationsRequest extends GeneratedMessageLite<ListOperationsRequest, Builder> implements ListOperationsRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListOperationsRequest, Builder> implements ListOperationsRequestOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        i = 0;
        if (!this.filter_.isEmpty()) {
            i = 0 + CodedOutputStream.computeStringSize(1, getFilter());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, listOperationsRequest.name_.isEmpty() ^ true, listOperationsRequest.name_);
                this.filter_ = visitor.visitString(this.filter_.isEmpty() ^ true, this.filter_, listOperationsRequest.filter_.isEmpty() ^ true, listOperationsRequest.filter_);
                ...
                this.pageToken_ = visitor.visitString(this.pageToken_.isEmpty() ^ true, this.pageToken_, listOperationsRequest.pageToken_.isEmpty() ^ true, listOperationsRequest.pageToken_);
