...
class GeoJsonParser {
    ...
    private static GeoJsonFeature parseFeature(JSONObject jSONObject) {
        ...
        try {
            str2 = jSONObject.has(str2) ? jSONObject.getString(str2) : null;
            ...
            return new GeoJsonFeature(parseGeometry, str2, hashMap, parseBoundingBox);
        } catch (JSONException unused) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Feature could not be successfully parsed ");
    ...
    private static Geometry createGeometry(String str, JSONArray jSONArray) throws JSONException {
        ...
        return str.equals(GEOMETRY_COLLECTION) ? createGeometryCollection(jSONArray) : null;
    }
    ...
    private void parseGeoJson() {
        ...
        try {
            ...
            if (string.equals(FEATURE)) {
                parseFeature = parseFeature(this.mGeoJsonFile);
                ...
                parseFeature = parseGeometryToFeature(this.mGeoJsonFile);
                if (parseFeature != null) {
                    this.mGeoJsonFeatures.add(parseFeature);
                }
            } else {
