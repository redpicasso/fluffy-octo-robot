...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    private ProtobufList<EnumValue> enumvalue_ = GeneratedMessageLite.emptyProtobufList();
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        private Builder() {
    ...
    private void setEnumvalue(int i, com.google.protobuf.EnumValue.Builder builder) {
        ensureEnumvalueIsMutable();
    ...
    private void addEnumvalue(com.google.protobuf.EnumValue.Builder builder) {
        ensureEnumvalueIsMutable();
        this.enumvalue_.add((EnumValue) builder.build());
    }

    private void addEnumvalue(int i, com.google.protobuf.EnumValue.Builder builder) {
        ensureEnumvalueIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, enumR.name_.isEmpty() ^ true, enumR.name_);
