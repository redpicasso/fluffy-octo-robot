...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListValue, Builder> implements ListValueOrBuilder {
        private Builder() {
    ...
    private void setValues(int i, com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    private void addValues(com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();
        this.values_.add((Value) builder.build());
    }

    private void addValues(int i, com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.values_ = ((Visitor) obj).visitList(this.values_, ((ListValue) obj2).values_);
