...
public final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
    ...
    private void setStructValue(com.google.protobuf.Struct.Builder builder) {
    ...
    private void mergeStructValue(Struct struct) {
        if (this.kindCase_ != 5 || this.kind_ == Struct.getDefaultInstance()) {
            ...
            this.kind_ = ((com.google.protobuf.Struct.Builder) Struct.newBuilder((Struct) this.kind_).mergeFrom(struct)).buildPartial();
        }
        this.kindCase_ = 5;
    }
    ...
    private void setListValue(com.google.protobuf.ListValue.Builder builder) {
        this.kind_ = builder.build();
        this.kindCase_ = 6;
    }
    ...
    private void mergeListValue(ListValue listValue) {
        if (this.kindCase_ != 6 || this.kind_ == ListValue.getDefaultInstance()) {
            ...
            this.kind_ = ((com.google.protobuf.ListValue.Builder) ListValue.newBuilder((ListValue) this.kind_).mergeFrom(listValue)).buildPartial();
        }
        this.kindCase_ = 6;
    }
    ...
    public int getSerializedSize() {
        ...
        if (this.kindCase_ == 3) {
            i += CodedOutputStream.computeStringSize(3, getStringValue());
        }
        if (this.kindCase_ == 4) {
                    ...
                    try {
                        ...
                        if (i != 0) {
                            if (i == 8) {
                                ...
                                com.google.protobuf.Struct.Builder builder = this.kindCase_ == 5 ? (com.google.protobuf.Struct.Builder) ((Struct) this.kind_).toBuilder() : null;
                                ...
                                com.google.protobuf.ListValue.Builder builder2 = this.kindCase_ == 6 ? (com.google.protobuf.ListValue.Builder) ((ListValue) this.kind_).toBuilder() : null;
