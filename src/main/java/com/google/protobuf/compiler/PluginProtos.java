...
public final class PluginProtos {
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessageLite<CodeGeneratorRequest, Builder> implements CodeGeneratorRequestOrBuilder {
        ...
        private ProtobufList<String> fileToGenerate_ = GeneratedMessageLite.emptyProtobufList();
        private byte memoizedIsInitialized = (byte) -1;
        private String parameter_ = "";
        private ProtobufList<FileDescriptorProto> protoFile_ = GeneratedMessageLite.emptyProtobufList();

        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<CodeGeneratorRequest, Builder> implements CodeGeneratorRequestOrBuilder {
            private Builder() {
        ...
        private void setFileToGenerate(int i, String str) {
            if (str != null) {
        ...
        private void addFileToGenerate(String str) {
            if (str != null) {
                ensureFileToGenerateIsMutable();
        ...
        private void addAllFileToGenerate(Iterable<String> iterable) {
            ensureFileToGenerateIsMutable();
        ...
        private void addFileToGenerateBytes(ByteString byteString) {
            if (byteString != null) {
                ensureFileToGenerateIsMutable();
        ...
        private void setParameterBytes(ByteString byteString) {
            if (byteString != null) {
                this.bitField0_ |= 1;
        ...
        private void setProtoFile(int i, FileDescriptorProto fileDescriptorProto) {
        ...
        private void setProtoFile(int i, com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.set(i, (FileDescriptorProto) builder.build());
        }

        private void addProtoFile(FileDescriptorProto fileDescriptorProto) {
            if (fileDescriptorProto != null) {
                ensureProtoFileIsMutable();
        ...
        private void addProtoFile(int i, FileDescriptorProto fileDescriptorProto) {
            if (fileDescriptorProto != null) {
                ensureProtoFileIsMutable();
        ...
        private void addProtoFile(com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.add((FileDescriptorProto) builder.build());
        }

        private void addProtoFile(int i, com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.add(i, (FileDescriptorProto) builder.build());
        }

        private void addAllProtoFile(Iterable<? extends FileDescriptorProto> iterable) {
            ensureProtoFileIsMutable();
        ...
        private void removeProtoFile(int i) {
            ensureProtoFileIsMutable();
        ...
        private void setCompilerVersion(Builder builder) {
            this.compilerVersion_ = (Version) builder.build();
            this.bitField0_ |= 2;
        }

        private void mergeCompilerVersion(Version version) {
            Version version2 = this.compilerVersion_;
            if (version2 == null || version2 == Version.getDefaultInstance()) {
                this.compilerVersion_ = version;
            } else {
                this.compilerVersion_ = (Version) ((Builder) Version.newBuilder(this.compilerVersion_).mergeFrom(version)).buildPartial();
            }
            this.bitField0_ |= 2;
        }
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i2 = 0; i2 < this.fileToGenerate_.size(); i2++) {
                codedOutputStream.writeString(1, (String) this.fileToGenerate_.get(i2));
            }
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 1) == 1) {
                i2 += CodedOutputStream.computeStringSize(2, getParameter());
            }
            if ((this.bitField0_ & 2) == 2) {
        ...
        public static CodeGeneratorRequest parseDelimitedFrom(InputStream inputStream) throws IOException {
            return (CodeGeneratorRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
        }
        ...
        public static CodeGeneratorRequest parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (CodeGeneratorRequest) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }
                        ...
                        try {
                            ...
                            if (readTag != 0) {
                                ...
                                if (readTag == 10) {
                                    ...
                                    Builder builder = (this.bitField0_ & 2) == 2 ? (Builder) this.compilerVersion_.toBuilder() : null;
                                    ...
                                    this.protoFile_.add((FileDescriptorProto) codedInputStream.readMessage(FileDescriptorProto.parser(), extensionRegistryLite));
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessageLite<CodeGeneratorResponse, Builder> implements CodeGeneratorResponseOrBuilder {
        ...
        private ProtobufList<File> file_ = GeneratedMessageLite.emptyProtobufList();
        ...
        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<CodeGeneratorResponse, Builder> implements CodeGeneratorResponseOrBuilder {
            private Builder() {
        ...
        public static final class File extends GeneratedMessageLite<File, Builder> implements FileOrBuilder {
            ...
            /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
            public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<File, Builder> implements FileOrBuilder {
                private Builder() {
            ...
            private void setInsertionPoint(String str) {
                if (str != null) {
                    this.bitField0_ |= 2;
                    this.insertionPoint_ = str;
                    return;
            ...
            private void setInsertionPointBytes(ByteString byteString) {
                if (byteString != null) {
                    this.bitField0_ |= 2;
            ...
            public int getSerializedSize() {
                ...
                if ((this.bitField0_ & 2) == 2) {
                    i += CodedOutputStream.computeStringSize(2, getInsertionPoint());
                }
                if ((this.bitField0_ & 4) == 4) {
                    i += CodedOutputStream.computeStringSize(15, getContent());
                }
                            ...
                            try {
                                ...
                                if (readTag != 0) {
                                    ...
                                    if (readTag == 10) {
                                        ...
                                        readString = codedInputStream.readString();
                                        this.bitField0_ |= 2;
                                        this.insertionPoint_ = readString;
                                    } else if (readTag == 122) {
                                        readString = codedInputStream.readString();
                                        this.bitField0_ |= 4;
        ...
        private void setFile(int i, File file) {
            if (file != null) {
                ensureFileIsMutable();
        ...
        private void addFile(int i, File file) {
            if (file != null) {
                ensureFileIsMutable();
        ...
        private void addAllFile(Iterable<? extends File> iterable) {
            ensureFileIsMutable();
        ...
        public int getSerializedSize() {
            ...
            int i2 = 0;
            i = (this.bitField0_ & 1) == 1 ? CodedOutputStream.computeStringSize(1, getError()) + 0 : 0;
        ...
        public static CodeGeneratorResponse parseDelimitedFrom(InputStream inputStream) throws IOException {
            return (CodeGeneratorResponse) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
        }
        ...
        public static CodeGeneratorResponse parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (CodeGeneratorResponse) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }
    ...
    public static final class Version extends GeneratedMessageLite<Version, Builder> implements VersionOrBuilder {
        ...
        /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Version, Builder> implements VersionOrBuilder {
            private Builder() {
        ...
        public int getSerializedSize() {
            ...
            if ((this.bitField0_ & 8) == 8) {
                i += CodedOutputStream.computeStringSize(4, getSuffix());
            }
            i += this.unknownFields.getSerializedSize();
            this.memoizedSerializedSize = i;
            return i;
