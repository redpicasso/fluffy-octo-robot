...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.requestTypeUrl_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getRequestTypeUrl());
        }
        boolean z = this.requestStreaming_;
        if (z) {
        ...
        if (!this.responseTypeUrl_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(4, getResponseTypeUrl());
        }
        z = this.responseStreaming_;
        if (z) {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, method.name_.isEmpty() ^ true, method.name_);
                this.requestTypeUrl_ = visitor.visitString(this.requestTypeUrl_.isEmpty() ^ true, this.requestTypeUrl_, method.requestTypeUrl_.isEmpty() ^ true, method.requestTypeUrl_);
                ...
                this.responseTypeUrl_ = visitor.visitString(this.responseTypeUrl_.isEmpty() ^ true, this.responseTypeUrl_, method.responseTypeUrl_.isEmpty() ^ true, method.responseTypeUrl_);
                z2 = this.responseStreaming_;
                z3 = method.responseStreaming_;
                this.responseStreaming_ = visitor.visitBoolean(z2, z2, z3, z3);
                ...
                this.syntax_ = visitor.visitInt(z2, i, z, method.syntax_);
