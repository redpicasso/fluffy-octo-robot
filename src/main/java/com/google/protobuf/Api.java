...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    private ProtobufList<Method> methods_ = GeneratedMessageLite.emptyProtobufList();
    private ProtobufList<Mixin> mixins_;
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        private Builder() {
    ...
    private void setMethods(int i, com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
    ...
    private void addMethods(com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
        this.methods_.add((Method) builder.build());
    }

    private void addMethods(int i, com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
    ...
    private void setMixins(int i, com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();
    ...
    private void addMixins(com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();
        this.mixins_.add((Mixin) builder.build());
    }

    private void addMixins(int i, com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                Api api = (Api) obj2;
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, api.name_.isEmpty() ^ true, api.name_);
                this.methods_ = visitor.visitList(this.methods_, api.methods_);
                this.options_ = visitor.visitList(this.options_, api.options_);
                this.version_ = visitor.visitString(this.version_.isEmpty() ^ true, this.version_, api.version_.isEmpty() ^ true, api.version_);
