...
public final class Struct extends GeneratedMessageLite<Struct, Builder> implements StructOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Struct, Builder> implements StructOrBuilder {
        private Builder() {
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case NEW_BUILDER:
                return new Builder();
            case VISIT:
                this.fields_ = ((Visitor) obj).visitMap(this.fields_, ((Struct) obj2).internalGetFields());
