...
public final class Mixin extends GeneratedMessageLite<Mixin, Builder> implements MixinOrBuilder {
    ...
    /* compiled from: com.google.firebase:protolite-well-known-types@@16.0.1 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Mixin, Builder> implements MixinOrBuilder {
        private Builder() {
    ...
    public int getSerializedSize() {
        ...
        if (!this.root_.isEmpty()) {
            i += CodedOutputStream.computeStringSize(2, getRoot());
        }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, mixin.name_.isEmpty() ^ true, mixin.name_);
                this.root_ = visitor.visitString(this.root_.isEmpty() ^ true, this.root_, true ^ mixin.root_.isEmpty(), mixin.root_);
