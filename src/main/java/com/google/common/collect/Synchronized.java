...
final class Synchronized {
    ...
    private static class SynchronizedEntry<K, V> extends SynchronizedObject implements Entry<K, V> {
        ...
        SynchronizedEntry(Entry<K, V> entry, @NullableDecl Object obj) {
            super(entry, obj);
        }
    ...
    private static class SynchronizedAsMapEntries<K, V> extends SynchronizedSet<Entry<K, Collection<V>>> {
        ...
        SynchronizedAsMapEntries(Set<Entry<K, Collection<V>>> set, @NullableDecl Object obj) {
            super(set, obj);
        }
    ...
    @GwtIncompatible
    private static <K, V> Entry<K, V> nullableSynchronizedEntry(@NullableDecl Entry<K, V> entry, @NullableDecl Object obj) {
