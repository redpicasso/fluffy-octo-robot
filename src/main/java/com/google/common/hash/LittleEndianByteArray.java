...
final class LittleEndianByteArray {
     ...
     */
        private static sun.misc.Unsafe getUnsafe() {
            ...
            return r0;
        L_0x0005:
            r0 = new com.google.common.hash.LittleEndianByteArray$UnsafeByteArray$3;	 Catch:{ PrivilegedActionException -> 0x0011 }
        ...
        try {
            if ("amd64".equals(System.getProperty("os.arch"))) {
                if (ByteOrder.nativeOrder().equals(ByteOrder.LITTLE_ENDIAN)) {
                    ...
                    UnsafeByteArray unsafeByteArray = UnsafeByteArray.UNSAFE_BIG_ENDIAN;
                }
            }
