...
abstract class AbstractDirectedNetworkConnections<N, E> implements NetworkConnections<N, E> {
    ...
    protected AbstractDirectedNetworkConnections(Map<E, N> map, Map<E, N> map2, int i) {
        ...
        boolean z = i <= map.size() && i <= map2.size();
        ...
        return new AbstractSet<E>() {
            public UnmodifiableIterator<E> iterator() {
                ...
                if (AbstractDirectedNetworkConnections.this.selfLoopCount == 0) {
                    concat = Iterables.concat(AbstractDirectedNetworkConnections.this.inEdgeMap.keySet(), AbstractDirectedNetworkConnections.this.outEdgeMap.keySet());
                } else {
                    concat = Sets.union(AbstractDirectedNetworkConnections.this.inEdgeMap.keySet(), AbstractDirectedNetworkConnections.this.outEdgeMap.keySet());
                }
                return Iterators.unmodifiableIterator(concat.iterator());
            }
