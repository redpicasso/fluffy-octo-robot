...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.of((Network) this, (Object) n, (Object) n2);
        ...
        z = n.equals(n2);
        if (!allowsSelfLoops()) {
            Preconditions.checkArgument(z ^ 1, "Cannot add self-loop edge on node %s, as self-loops are not allowed. To construct a graph that allows self-loops, call allowsSelfLoops(true) on the Builder.", (Object) n);
        }
        ...
        networkConnections.addInEdge(e, n, z);
