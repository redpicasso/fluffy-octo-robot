...
class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    ConfigurableNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(((Integer) networkBuilder.expectedNodeCount.or(Integer.valueOf(10))).intValue()), networkBuilder.edgeOrder.createMap(((Integer) networkBuilder.expectedEdgeCount.or(Integer.valueOf(20))).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.of((Network) this, checkedReferenceNode, ((NetworkConnections) this.nodeConnections.get(checkedReferenceNode)).adjacentNode(e));
    }
