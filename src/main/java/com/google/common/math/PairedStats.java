...
public final class PairedStats implements Serializable {
    ...
    private static double ensurePositive(double d) {
        return d > 0.0d ? d : Double.MIN_VALUE;
    }
    ...
    public String toString() {
        ...
        String str2 = "xStats";
        if (count() <= 0) {
            return MoreObjects.toStringHelper((Object) this).add(str2, this.xStats).add(str, this.yStats).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add(str2, this.xStats).add(str, this.yStats).add("populationCovariance", populationCovariance()).toString();
    }
