        ...
        if (stats.count() != 0) {
            ...
            if (j == 0) {
                ...
                if (Doubles.isFinite(this.mean) && Doubles.isFinite(stats.mean())) {
                    ...
                    double d = this.mean;
                    mean -= d;
                    this.mean = d + ((((double) stats.count()) * mean) / ((double) this.count));
                    this.sumOfSquaresOfDeltas += stats.sumOfSquaresOfDeltas() + ((mean * (stats.mean() - this.mean)) * ((double) stats.count()));
                } else {
