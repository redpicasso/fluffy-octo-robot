...
public final class ExecutionSequencer {
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> asyncCallable, final Executor executor) {
        ...
        AsyncCallable anonymousClass2 = new AsyncCallable<T>() {
            public ListenableFuture<T> call() throws Exception {
        ...
        ListenableFuture submitAsync = Futures.submitAsync(anonymousClass2, new Executor() {
        ...
        nonCancellationPropagating.addListener(anonymousClass4, MoreExecutors.directExecutor());
        submitAsync.addListener(anonymousClass4, MoreExecutors.directExecutor());
