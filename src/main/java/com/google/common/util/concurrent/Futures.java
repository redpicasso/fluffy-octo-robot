...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static final class FutureCombiner<V> {
        ...
        public <C> ListenableFuture<C> callAsync(AsyncCallable<C> asyncCallable, Executor executor) {
            return new CombinedFuture(this.futures, this.allMustSucceed, executor, (AsyncCallable) asyncCallable);
        }

        @CanIgnoreReturnValue
        public <C> ListenableFuture<C> call(Callable<C> callable, Executor executor) {
            return new CombinedFuture(this.futures, this.allMustSucceed, executor, (Callable) callable);
        }
    ...
    private static final class InCompletionOrderState<T> {
        ...
        private void recordInputCompletion(ImmutableList<AbstractFuture<T>> immutableList, int i) {
            ...
            for (i = this.delegateIndex; i < immutableList.size(); i++) {
                if (((AbstractFuture) immutableList.get(i)).setFuture(listenableFuture)) {
                    recordCompletion();
    ...
    public static <O> ListenableFuture<O> submitAsync(AsyncCallable<O> asyncCallable, Executor executor) {
        Object create = TrustedListenableFutureTask.create((AsyncCallable) asyncCallable);
    ...
    public static <O> ListenableFuture<O> scheduleAsync(AsyncCallable<O> asyncCallable, long j, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        ListenableFuture<O> create = TrustedListenableFutureTask.create((AsyncCallable) asyncCallable);
        final Future schedule = scheduledExecutorService.schedule(create, j, timeUnit);
    ...
    public static <V, X extends Throwable> ListenableFuture<V> catching(ListenableFuture<? extends V> listenableFuture, Class<X> cls, Function<? super X, ? extends V> function, Executor executor) {
        return AbstractCatchingFuture.create((ListenableFuture) listenableFuture, (Class) cls, (Function) function, executor);
    }

    @CanIgnoreReturnValue
    @GwtIncompatible("AVAILABLE but requires exceptionType to be Throwable.class")
    public static <V, X extends Throwable> ListenableFuture<V> catchingAsync(ListenableFuture<? extends V> listenableFuture, Class<X> cls, AsyncFunction<? super X, ? extends V> asyncFunction, Executor executor) {
        return AbstractCatchingFuture.create((ListenableFuture) listenableFuture, (Class) cls, (AsyncFunction) asyncFunction, executor);
    }
    ...
    public static <I, O> ListenableFuture<O> transformAsync(ListenableFuture<I> listenableFuture, AsyncFunction<? super I, ? extends O> asyncFunction, Executor executor) {
        return AbstractTransformFuture.create((ListenableFuture) listenableFuture, (AsyncFunction) asyncFunction, executor);
    }

    public static <I, O> ListenableFuture<O> transform(ListenableFuture<I> listenableFuture, Function<? super I, ? extends O> function, Executor executor) {
        return AbstractTransformFuture.create((ListenableFuture) listenableFuture, (Function) function, executor);
    }
    ...
    public static <V> FutureCombiner<V> whenAllComplete(ListenableFuture<? extends V>... listenableFutureArr) {
        return new FutureCombiner(false, ImmutableList.copyOf((Object[]) listenableFutureArr), null);
    }

    public static <V> FutureCombiner<V> whenAllComplete(Iterable<? extends ListenableFuture<? extends V>> iterable) {
        return new FutureCombiner(false, ImmutableList.copyOf((Iterable) iterable), null);
    }

    @SafeVarargs
    public static <V> FutureCombiner<V> whenAllSucceed(ListenableFuture<? extends V>... listenableFutureArr) {
        return new FutureCombiner(true, ImmutableList.copyOf((Object[]) listenableFutureArr), null);
    }

    public static <V> FutureCombiner<V> whenAllSucceed(Iterable<? extends ListenableFuture<? extends V>> iterable) {
        return new FutureCombiner(true, ImmutableList.copyOf((Iterable) iterable), null);
    }
    ...
    public static <V> ListenableFuture<V> nonCancellationPropagating(ListenableFuture<V> listenableFuture) {
        ...
        Object nonCancellationPropagatingFuture = new NonCancellationPropagatingFuture(listenableFuture);
    ...
    public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            collection = ImmutableList.copyOf((Iterable) iterable);
        }
        ListenableFuture[] listenableFutureArr = (ListenableFuture[]) collection.toArray(new ListenableFuture[collection.size()]);
        final InCompletionOrderState inCompletionOrderState = new InCompletionOrderState(listenableFutureArr, null);
