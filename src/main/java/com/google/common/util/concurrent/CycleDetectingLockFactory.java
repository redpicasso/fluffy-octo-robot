...
public class CycleDetectingLockFactory {
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        ExampleStackTrace(LockGraphNode lockGraphNode, LockGraphNode lockGraphNode2) {
            ...
            stringBuilder.append(lockGraphNode2.getLockName());
        ...
        void checkAcquiredLock(Policy policy, LockGraphNode lockGraphNode) {
            ...
            if (!this.allowedPriorLocks.containsKey(lockGraphNode)) {
                ...
                if (potentialDeadlockException != null) {
                    policy.handlePotentialDeadlock(new PotentialDeadlockException(lockGraphNode, this, potentialDeadlockException.getConflictingStackTrace(), null));
                    return;
                }
                ...
                if (findPathTo == null) {
                    ...
                    PotentialDeadlockException potentialDeadlockException2 = new PotentialDeadlockException(lockGraphNode, this, findPathTo, null);
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e, boolean z) {
            ...
            return new CycleDetectingReentrantLock(this, (LockGraphNode) this.lockGraphNodes.get(e), z, null);
        }
        ...
        public ReentrantReadWriteLock newReentrantReadWriteLock(E e, boolean z) {
            ...
            return new CycleDetectingReentrantReadWriteLock(this, (LockGraphNode) this.lockGraphNodes.get(e), z, null);
        }
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z) {
        return this.policy == Policies.DISABLED ? new ReentrantLock(z) : new CycleDetectingReentrantLock(this, new LockGraphNode(str), z, null);
    }
    ...
    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z) {
        return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z) : new CycleDetectingReentrantReadWriteLock(this, new LockGraphNode(str), z, null);
    }
