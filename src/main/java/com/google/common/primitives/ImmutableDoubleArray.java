...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static final class Builder {
        ...
        private void ensureRoomFor(int i) {
            ...
            double[] dArr = this.array;
            if (i2 > dArr.length) {
                Object obj = new double[expandedCapacity(dArr.length, i2)];
                System.arraycopy(this.array, 0, obj, 0, this.count);
                this.array = obj;
            }
        }
    ...
    public static ImmutableDoubleArray of(double d, double... dArr) {
        ...
        Object obj = new double[(dArr.length + 1)];
        obj[0] = d;
        System.arraycopy(dArr, 0, obj, 1, dArr.length);
        return new ImmutableDoubleArray(obj);
    }
    ...
    public static ImmutableDoubleArray copyOf(Iterable<Double> iterable) {
        ...
        return builder().addAll((Iterable) iterable).build();
    }
