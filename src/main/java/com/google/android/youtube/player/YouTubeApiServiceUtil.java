...
public final class YouTubeApiServiceUtil {
    ...
    private static boolean a(PackageInfo packageInfo) {
        try {
            ...
            while (true) {
                byte[][] bArr = a;
                if (i < bArr.length) {
                    if (Arrays.equals(bArr[i], toByteArray)) {
                        return true;
                    }
                    i++;
                }
    ...
    public static YouTubeInitializationResult isYouTubeApiServiceAvailable(Context context) {
        try {
            ...
            return !a(packageManager.getPackageInfo(a, 64)) ? YouTubeInitializationResult.SERVICE_INVALID : z.a(context, a) ? YouTubeInitializationResult.SERVICE_VERSION_UPDATE_REQUIRED : !packageManager.getApplicationInfo(a, 0).enabled ? YouTubeInitializationResult.SERVICE_DISABLED : YouTubeInitializationResult.SUCCESS;
