...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzv() {
        ...
        boolean z = this.zzgb;
        StringBuilder stringBuilder = new StringBuilder(((((String.valueOf(str2).length() + 51) + String.valueOf(str).length()) + String.valueOf(str4).length()) + String.valueOf(str5).length()) + String.valueOf(str3).length());
        String str7 = "\t";
