...
public abstract class GmsClientSupervisor {
    ...
    protected abstract boolean zza(zza zza, ServiceConnection serviceConnection, String str);

    protected abstract void zzb(zza zza, ServiceConnection serviceConnection, String str);
