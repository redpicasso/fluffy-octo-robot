...
public final class ApiKey<O extends ApiOptions> {
    ...
    private ApiKey(Api<O> api, O o) {
        this.mApi = api;
        this.zabj = o;
        this.zacy = Objects.hashCode(this.mApi, this.zabj);
    }
    ...
    public static <O extends ApiOptions> ApiKey<O> getSharedApiKey(Api<O> api, O o) {
        return new ApiKey(api, o);
    }

    public static <O extends ApiOptions> ApiKey<O> getUniqueApiKey(Api<O> api) {
