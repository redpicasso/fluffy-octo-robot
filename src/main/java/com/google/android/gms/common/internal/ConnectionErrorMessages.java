...
public final class ConnectionErrorMessages {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.google.android.gms.common.internal.ConnectionErrorMessages.getAppName(android.content.Context):java.lang.String, dom blocks: []
    ...
    private static String zaa(Context context, String str) {
        synchronized (zaor) {
            String str2 = (String) zaor.get(str);
            if (str2 != null) {
                return str2;
            }
