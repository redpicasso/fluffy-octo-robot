...
public final class zzc extends Fragment implements LifecycleFragment {
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzc = (zzc) fragmentActivity.getSupportFragmentManager().findFragmentByTag(str);
            if (zzc == null || zzc.isRemoving()) {
                zzc = new zzc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzc, str).commitAllowingStateLoss();
            }
