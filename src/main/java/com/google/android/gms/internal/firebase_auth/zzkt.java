...
final class zzkt {
    ...
    public static boolean zze(byte[] bArr) {
        return zzafm.zze(bArr, 0, bArr.length);
    }

    private static int zzs(int i, int i2) {
    ...
    L_0x004c:
        ...
        goto L_0x0055;
    L_0x004f:
        r8 = new com.google.android.gms.internal.firebase_auth.zzkw;
        r8.<init>(r2, r4);
        throw r8;
    L_0x0055:
        r2 = r2 + 1;
    ...
    L_0x005c:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_auth.zzkt.zzb(java.lang.CharSequence):int");
    }
    ...
    static {
        zzku zzkx;
        Object obj = (zzkq.zzkr() && zzkq.zzks()) ? 1 : null;
        if (obj == null || zzge.zzga()) {
            zzkx = new zzkx();
        } else {
            zzkx = new zzkz();
        }
