            ...
            while (i < i4) {
                ...
                if (zzkv.zzd(b2)) {
                    ...
                    if (i5 < i4 - 1) {
                        ...
                        i3 = i7 + 1;
                        int i8 = i6 + 1;
                        zzkv.zza(b2, bArr[i5], bArr[i7], cArr, i6);
                        i = i3;
                        i6 = i8;
                    } else {
                        throw zzic.zziz();
                    ...
                    int i9 = i5 + 1;
                    int i10 = i6 + 1;
                    zzkv.zza(b2, b3, bArr[i7], bArr[i5], cArr, i6);
                    i = i9;
                    i6 = i10 + 1;
                } else {
                    throw zzic.zziz();
