...
interface zzlh {
    ...
    void zza(int i, zzgf zzgf) throws IOException;

    <K, V> void zza(int i, zzit<K, V> zzit, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjs zzjs) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjs zzjs) throws IOException;
    ...
    @Deprecated
    void zzau(int i) throws IOException;

    void zzb(int i, long j) throws IOException;

    @Deprecated
    void zzb(int i, Object obj, zzjs zzjs) throws IOException;

    void zzb(int i, List<zzgf> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjs zzjs) throws IOException;
