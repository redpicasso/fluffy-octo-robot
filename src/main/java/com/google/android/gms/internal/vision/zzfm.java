...
final class zzfm extends zzfl<zze> {
    ...
    final boolean zze(zzhf zzhf) {
        return zzhf instanceof zzd;
    }

    final zzfp<zze> zzc(Object obj) {
        return ((zzd) obj).zzwp;
    }

    final void zza(Object obj, zzfp<zze> zzfp) {
        ((zzd) obj).zzwp = zzfp;
    }

    final zzfp<zze> zzd(Object obj) {
    ...
    final <UT, UB> UB zza(zzhv zzhv, Object obj, zzfk zzfk, zzfp<zze> zzfp, UB ub, zzio<UT, UB> zzio) throws IOException {
        zzf zzf = (zzf) obj;
    ...
    final void zza(zzjj zzjj, Entry<?, ?> entry) throws IOException {
    ...
    final Object zza(zzfk zzfk, zzhf zzhf, int i) {
        return zzfk.zza(zzhf, i);
    }

    final void zza(zzhv zzhv, Object obj, zzfk zzfk, zzfp<zze> zzfp) throws IOException {
        zzf zzf = (zzf) obj;
        zzfp.zza(zzf.zzww, zzhv.zza(zzf.zzwv.getClass(), zzfk));
    }

    final void zza(zzeo zzeo, Object obj, zzfk zzfk, zzfp<zze> zzfp) throws IOException {
        byte[] bArr;
        zzf zzf = (zzf) obj;
