...
final class zzhc implements zzlh {
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzal(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzao(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zze(((Long) list.get(i)).longValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzf(((Long) list.get(i)).longValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
                this.zzwc.zzb(((Long) list.get(i2)).longValue());
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzh(((Long) list.get(i)).longValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzb(((Float) list.get(i)).floatValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzb(((Double) list.get(i)).doubleValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzaq(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
                this.zzwc.zzag(((Integer) list.get(i2)).intValue());
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzu(((Boolean) list.get(i)).booleanValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzam(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzap(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
                this.zzwc.zzaj(((Integer) list.get(i2)).intValue());
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzi(((Long) list.get(i)).longValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
                this.zzwc.zzd(((Long) list.get(i2)).longValue());
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzan(((Integer) list.get(i)).intValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (i = 0; i < list.size(); i++) {
                i3 += zzha.zzg(((Long) list.get(i)).longValue());
            }
            this.zzwc.zzah(i3);
            while (i2 < list.size()) {
