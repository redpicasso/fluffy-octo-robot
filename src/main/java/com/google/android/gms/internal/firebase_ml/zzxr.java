...
interface zzxr {
    ...
    void zza(int i, zzsw zzsw) throws IOException;

    <K, V> void zza(int i, zzvh<K, V> zzvh, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzwe zzwe) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzwe zzwe) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzwe zzwe) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzsw> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzwe zzwe) throws IOException;
    ...
    @Deprecated
    void zzde(int i) throws IOException;

    @Deprecated
    void zzdf(int i) throws IOException;
    ...
    void zzs(int i, int i2) throws IOException;
}
