    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            if (length > 16) {
                ...
                return zza((Long.rotateRight(zzb6, 37) * j) + zzb4, (Long.rotateRight(zzb4, 25) + zzb6) * j, j);
            } else if (length >= 4) {
                ...
                long j2 = (((long) ((bArr2[0] & 255) + ((bArr2[(length >> 1) + 0] & 255) << 8))) * -7286425919675154353L) ^ (((long) (length + ((bArr2[(length - 1) + 0] & 255) << 2))) * -4348849565147123417L);
                return (j2 ^ (j2 >>> 47)) * -7286425919675154353L;
            }
        } else if (length <= 64) {
            ...
            long rotateRight = (Long.rotateRight(zzb2 + zzb7, 43) + Long.rotateRight(zzb4, 30)) + (zzb(bArr2, length - 16) * -7286425919675154353L);
            j = zzb;
            zzb4 = zza(rotateRight, (Long.rotateRight(-7286425919675154353L + zzb7, 18) + zzb2) + zzb4, j);
            bArr2 = bArr;
            zzb5 = zzb(bArr2, 16) * zzb;
            long zzb8 = zzb(bArr2, 24);
            zzb3 = (rotateRight + zzb(bArr2, length - 32)) * zzb;
            return zza((Long.rotateRight(zzb5 + zzb8, 43) + Long.rotateRight(zzb3, 30)) + ((zzb4 + zzb(bArr2, length - 24)) * zzb), (zzb5 + Long.rotateRight(zzb8 + zzb2, 18)) + zzb3, j);
        } else {
            zzb4 = 2480279821605975764L;
            long j3 = 1390051526045402406L;
            ...
            while (true) {
                ...
                long rotateRight2 = Long.rotateRight(j3 + jArr2[0], 33) * -5435081209227447693L;
                int i7 = i4;
                i = i3;
                ...
                length = i6 + 64;
                if (length == i) {
                    zzb2 = ((255 & zzb3) << 1) - 5435081209227447693L;
                    jArr2[0] = jArr2[0] + ((long) i7);
                    jArr[0] = jArr[0] + jArr2[0];
                    jArr2[0] = jArr2[0] + jArr[0];
                    zzb5 = (Long.rotateRight(((rotateRight2 + zzb9) + jArr[0]) + zzb(bArr2, i5 + 8), 37) * zzb2) ^ (jArr2[1] * 9);
                    zzb9 = (Long.rotateRight((zzb9 + jArr[1]) + zzb(bArr2, i5 + 48), 42) * zzb2) + ((jArr[0] * 9) + zzb(bArr2, i5 + 40));
                    zzb3 = Long.rotateRight(zzb3 + jArr2[0], 33) * zzb2;
                    zza(bArr, i5, jArr[1] * zzb2, jArr2[0] + zzb5, jArr);
                    zza(bArr, i5 + 32, jArr2[1] + zzb3, zzb9 + zzb(bArr2, i5 + 16), jArr2);
                    long j4 = zzb2;
                    return zza((zza(jArr[0], jArr2[0], j4) + ((zzb9 ^ (zzb9 >>> 47)) * -4348849565147123417L)) + zzb5, zza(jArr[1], jArr2[1], j4) + zzb3, j4);
                }
                i6 = length;
                i3 = i;
                i4 = i7;
