...
public interface IGoogleMapDelegate extends IInterface {
    ...
    zzk addGroundOverlay(GroundOverlayOptions groundOverlayOptions) throws RemoteException;

    zzt addMarker(MarkerOptions markerOptions) throws RemoteException;

    zzw addPolygon(PolygonOptions polygonOptions) throws RemoteException;

    zzz addPolyline(PolylineOptions polylineOptions) throws RemoteException;

    zzac addTileOverlay(TileOverlayOptions tileOverlayOptions) throws RemoteException;
