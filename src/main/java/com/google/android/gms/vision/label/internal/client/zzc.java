...
public abstract class zzc extends zzb implements zzb {
    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        IInterface newImageLabeler = newImageLabeler(Stub.asInterface(parcel.readStrongBinder()), (ImageLabelerOptions) com.google.android.gms.internal.vision.zzc.zza(parcel, ImageLabelerOptions.CREATOR));
        parcel2.writeNoException();
        com.google.android.gms.internal.vision.zzc.zza(parcel2, newImageLabeler);
        return true;
    }
}
