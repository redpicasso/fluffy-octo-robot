...
public final class zzfk extends zzdw {
    ...
    @VisibleForTesting
    final zzai zzb(zzai zzai, zzn zzn) {
        Object obj = null;
        if (!(!"_cmp".equals(zzai.name) || zzai.zzfq == null || zzai.zzfq.size() == 0)) {
            CharSequence string = zzai.zzfq.getString("_cis");
    ...
    public final List<zzjn> zza(zzn zzn, boolean z) {
        ...
        try {
            ...
            List<zzjn> arrayList = new ArrayList(list.size());
            for (zzjp zzjp : list) {
    ...
    private final void zza(String str, boolean z) {
        ...
        if (z) {
            try {
                if (this.zzpb == null) {
                    z = "com.google.android.gms".equals(this.zzpc) || UidVerifier.isGooglePlayServicesUid(this.zzkz.getContext(), Binder.getCallingUid()) || GoogleSignatureVerifier.getInstance(this.zzkz.getContext()).isUidGoogleSigned(Binder.getCallingUid());
