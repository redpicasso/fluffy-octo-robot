...
public class AppMeasurementDynamiteService extends zzn {
    ...
    public void setUserId(String str, long j) throws RemoteException {
        zzbi();
        this.zzj.zzq().zza(null, APEZProvider.FILEID, str, true, j);
    }
    ...
    public void onActivityStarted(IObjectWrapper iObjectWrapper, long j) throws RemoteException {
        zzbi();
        ActivityLifecycleCallbacks activityLifecycleCallbacks = this.zzj.zzq().zzpu;
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityStarted((Activity) ObjectWrapper.unwrap(iObjectWrapper));
        }
    }
    ...
    public void onActivityStopped(IObjectWrapper iObjectWrapper, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityStopped((Activity) ObjectWrapper.unwrap(iObjectWrapper));
        }
    }
    ...
    public void onActivityCreated(IObjectWrapper iObjectWrapper, Bundle bundle, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityCreated((Activity) ObjectWrapper.unwrap(iObjectWrapper), bundle);
        }
    }
    ...
    public void onActivityDestroyed(IObjectWrapper iObjectWrapper, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityDestroyed((Activity) ObjectWrapper.unwrap(iObjectWrapper));
        }
    }
    ...
    public void onActivityPaused(IObjectWrapper iObjectWrapper, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityPaused((Activity) ObjectWrapper.unwrap(iObjectWrapper));
        }
    }
    ...
    public void onActivityResumed(IObjectWrapper iObjectWrapper, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivityResumed((Activity) ObjectWrapper.unwrap(iObjectWrapper));
        }
    }
    ...
    public void onActivitySaveInstanceState(IObjectWrapper iObjectWrapper, zzp zzp, long j) throws RemoteException {
        ...
        if (activityLifecycleCallbacks != null) {
            this.zzj.zzq().zzif();
            activityLifecycleCallbacks.onActivitySaveInstanceState((Activity) ObjectWrapper.unwrap(iObjectWrapper), bundle);
        }
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public void setEventInterceptor(zzq zzq) throws RemoteException {
        zzbi();
        zzgf zzq2 = this.zzj.zzq();
        zzgk zzb = new zzb(zzq);
        zzq2.zzm();
        zzq2.zzbi();
