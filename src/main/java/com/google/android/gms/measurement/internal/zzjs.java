...
public final class zzjs extends zzge {
    ...
    private static final List<String> zzua = Collections.unmodifiableList(Arrays.asList(new String[]{Param.SOURCE, "medium", Param.CAMPAIGN, Param.TERM, "content"}));
    private int zzag;
    ...
    final Bundle zza(@NonNull Uri uri) {
        ...
        try {
            ...
            String str2 = Param.ACLID;
            Object queryParameter5 = uri.getQueryParameter(str2);
            if (!TextUtils.isEmpty(queryParameter5)) {
                bundle.putString(str2, queryParameter5);
            }
            str2 = Param.CP1;
            queryParameter5 = uri.getQueryParameter(str2);
            if (!TextUtils.isEmpty(queryParameter5)) {
                bundle.putString(str2, queryParameter5);
            }
            str2 = "anid";
            Object queryParameter6 = uri.getQueryParameter(str2);
            if (!TextUtils.isEmpty(queryParameter6)) {
                bundle.putString(str2, queryParameter6);
            }
            return bundle;
    ...
    /* JADX WARNING: Missing block: B:12:0x000d, code:
            continue;
     */
    ...
    L_0x0010:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzjs.getMessageDigest():java.security.MessageDigest");
    }
