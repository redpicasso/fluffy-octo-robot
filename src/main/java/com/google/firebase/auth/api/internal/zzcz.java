...
final class zzcz extends zzen<AuthResult, zza> {
    ...
    final /* synthetic */ void zzaa(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zze(this.zzks, this.zzpr.zzcz(), this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzdt(this.zzks, this.zzpr.zzcz()), this.zzpq);
        }
    }
}
