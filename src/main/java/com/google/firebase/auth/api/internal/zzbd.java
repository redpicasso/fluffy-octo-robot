...
final class zzbd extends zzen<GetTokenResult, zza> {
    ...
    final /* synthetic */ void zze(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzna.zzs(), this.zzpq);
        } else {
            zzdp.zzeb().zza(this.zzna, this.zzpq);
        }
    }
}
