...
final class zzdb extends zzen<Void, zza> {
    ...
    final /* synthetic */ void zzab(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzpr.zzcz(), this.zzif, this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzbp(this.zzpr.zzcz(), this.zzif), this.zzpq);
        }
    }
}
