...
final class zzbx extends zzen<AuthResult, zza> {
    ...
    public final TaskApiCall<zzdp, AuthResult> zzdv() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzbw(this)).build();
    }
    ...
    final /* synthetic */ void zzo(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
