...
final class zzdf extends zzen<Void, zza> {
    ...
    final /* synthetic */ void zzad(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzpr.zzcz(), this.zzkj, this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzcn(this.zzpr.zzcz(), this.zzkj), this.zzpq);
        }
    }
}
