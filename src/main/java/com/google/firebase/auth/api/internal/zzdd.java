...
final class zzdd extends zzen<Void, zza> {
    ...
    final /* synthetic */ void zzac(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zzb(this.zzpr.zzcz(), this.zzig, this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzbr(this.zzpr.zzcz(), this.zzig), this.zzpq);
        }
    }
}
