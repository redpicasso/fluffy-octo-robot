...
final class zzdl extends zzen<Void, OnVerificationStateChangedCallbacks> {
    ...
    final /* synthetic */ void zzag(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzoq.zzdk(), this.zzpq);
        } else {
            zzdp.zzeb().zza(this.zzoq, this.zzpq);
        }
    }
}
