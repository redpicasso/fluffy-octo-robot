...
final class zzbf extends zzen<AuthResult, zza> {
    ...
    final /* synthetic */ void zzf(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        if (this.zzqh) {
            ...
            zzdp.zzeb().zza(new zzcj(this.zzkn.getEmail(), this.zzkn.getPassword(), this.zzpr.zzcz()), this.zzpq);
        }
    }
}
