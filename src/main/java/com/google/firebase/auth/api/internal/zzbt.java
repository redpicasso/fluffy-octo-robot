...
final class zzbt extends zzen<AuthResult, zza> {
    ...
    public final TaskApiCall<zzdp, AuthResult> zzdv() {
        ...
        return autoResolveMissingFeatures.setFeatures(featureArr).run(new zzbs(this)).build();
    }
    ...
    final /* synthetic */ void zzm(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
