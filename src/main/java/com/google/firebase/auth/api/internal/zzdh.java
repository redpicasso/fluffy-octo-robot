...
final class zzdh extends zzen<Void, zza> {
    ...
    final /* synthetic */ void zzae(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzpr.zzcz(), this.zzkt, this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzdv(this.zzkt, this.zzpr.zzcz()), this.zzpq);
        }
    }
}
