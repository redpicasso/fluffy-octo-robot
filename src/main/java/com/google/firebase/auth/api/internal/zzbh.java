...
final class zzbh extends zzen<AuthResult, zza> {
    ...
    final /* synthetic */ void zzg(zzdp zzdp, TaskCompletionSource taskCompletionSource) throws RemoteException {
        this.zzpu = new zzeu(this, taskCompletionSource);
        if (this.zzqh) {
            zzdp.zzeb().zza(this.zzpr.zzcz(), this.zznd, this.zzpq);
        } else {
            zzdp.zzeb().zza(new zzcl(this.zzpr.zzcz(), this.zznd), this.zzpq);
        }
    }
}
