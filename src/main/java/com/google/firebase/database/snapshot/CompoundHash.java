...
public class CompoundHash {
    ...
    static class CompoundHashBuilder {
        ...
        private void processLeaf(LeafNode<?> leafNode) {
            ...
            this.optHashValueBuilder.append(leafNode.getHashRepresentation(HashVersion.V2));
    ...
    private static void processNode(Node node, final CompoundHashBuilder compoundHashBuilder) {
        if (node.isLeafNode()) {
