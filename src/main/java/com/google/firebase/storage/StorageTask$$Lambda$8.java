...
final /* synthetic */ class StorageTask$$Lambda$8 implements OnCompleteListener {
    ...
    private StorageTask$$Lambda$8(StorageTask storageTask, Continuation continuation, TaskCompletionSource taskCompletionSource, CancellationTokenSource cancellationTokenSource) {
    ...
    public static OnCompleteListener lambdaFactory$(StorageTask storageTask, Continuation continuation, TaskCompletionSource taskCompletionSource, CancellationTokenSource cancellationTokenSource) {
        return new StorageTask$$Lambda$8(storageTask, continuation, taskCompletionSource, cancellationTokenSource);
    }
