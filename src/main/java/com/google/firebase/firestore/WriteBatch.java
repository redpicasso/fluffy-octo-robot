...
public class WriteBatch {
    ...
    public WriteBatch set(@NonNull DocumentReference documentReference, @NonNull Object obj, @NonNull SetOptions setOptions) {
        ...
        this.mutations.addAll(parseMergeData.toMutationList(documentReference.getKey(), Precondition.NONE));
        return this;
    }
    ...
    private WriteBatch update(@NonNull DocumentReference documentReference, @NonNull ParsedUpdateData parsedUpdateData) {
        this.firestore.validateReference(documentReference);
        verifyNotCommitted();
