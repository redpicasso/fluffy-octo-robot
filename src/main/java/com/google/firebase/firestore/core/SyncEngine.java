...
public class SyncEngine implements RemoteStoreCallback {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$firestore$core$LimboDocumentChange$Type = new int[Type.values().length];
     ...
     */
        static {
            /*
            r0 = com.google.firebase.firestore.core.LimboDocumentChange.Type.values();
            r0 = r0.length;
            r0 = new int[r0];
            $SwitchMap$com$google$firebase$firestore$core$LimboDocumentChange$Type = r0;
            r0 = $SwitchMap$com$google$firebase$firestore$core$LimboDocumentChange$Type;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = com.google.firebase.firestore.core.LimboDocumentChange.Type.ADDED;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = 1;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r0 = $SwitchMap$com$google$firebase$firestore$core$LimboDocumentChange$Type;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = com.google.firebase.firestore.core.LimboDocumentChange.Type.REMOVED;	 Catch:{ NoSuchFieldError -> 0x001f }
        ...
        L_0x001f:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.SyncEngine.1.<clinit>():void");
        }
    }
    ...
    public int listen(Query query) {
        ...
        Assert.hardAssert(this.queryViewsByQuery.containsKey(query) ^ true, "We already listen to query: %s", query);
    ...
    private ViewSnapshot initializeViewAndComputeSnapshot(QueryData queryData) {
        ...
        ImmutableSortedMap executeQuery = this.localStore.executeQuery(query);
    ...
    void stopListening(Query query) {
        ...
        QueryView queryView = (QueryView) this.queryViewsByQuery.get(query);
    ...
    public <TResult> Task<TResult> transaction(AsyncQueue asyncQueue, Function<Transaction, Task<TResult>> function, int i) {
        ...
        return ((Task) function.apply(createTransaction)).continueWithTask(asyncQueue.getExecutor(), SyncEngine$$Lambda$1.lambdaFactory$(this, createTransaction, asyncQueue, i, function));
    }
    ...
    static /* synthetic */ Task lambda$transaction$0(SyncEngine syncEngine, Task task, int i, AsyncQueue asyncQueue, Function function, Task task2) throws Exception {
        ...
        return Tasks.forException(new FirebaseFirestoreException("Transaction failed all retries.", Code.ABORTED, task2.getException()));
    }
    ...
    public void handleRemoteEvent(RemoteEvent remoteEvent) {
        ...
        for (Entry entry : remoteEvent.getTargetChanges().entrySet()) {
            ...
            LimboResolution limboResolution = (LimboResolution) this.limboResolutionsByTarget.get(num);
    ...
    public void handleOnlineStateChange(OnlineState onlineState) {
        ...
        for (Entry value : this.queryViewsByQuery.entrySet()) {
    ...
    public ImmutableSortedSet<DocumentKey> getRemoteKeysForTarget(int i) {
        LimboResolution limboResolution = (LimboResolution) this.limboResolutionsByTarget.get(Integer.valueOf(i));
        ...
        QueryView queryView = (QueryView) this.queryViewsByTarget.get(Integer.valueOf(i));
        if (queryView != null) {
            syncedDocuments = queryView.getView().getSyncedDocuments();
        } else {
            syncedDocuments = DocumentKey.emptyKeySet();
        }
    ...
    public void handleRejectedWrite(int i, Status status) {
        ...
        if (!rejectBatch.isEmpty()) {
            logErrorIfInteresting(status, "Write failed at %s", ((DocumentKey) rejectBatch.getMinKey()).getPath());
        }
        notifyUser(i, status);
    ...
    private void removeAndCleanupQuery(QueryView queryView) {
        ...
        ImmutableSortedSet referencesForId = this.limboDocumentRefs.referencesForId(queryView.getTargetId());
    ...
    private void removeLimboTarget(DocumentKey documentKey) {
        Integer num = (Integer) this.limboTargetsByKey.get(documentKey);
        if (num != null) {
    ...
    private void emitNewSnapsAndNotifyLocalStore(ImmutableSortedMap<DocumentKey, MaybeDocument> immutableSortedMap, @Nullable RemoteEvent remoteEvent) {
        ...
        for (Entry value : this.queryViewsByQuery.entrySet()) {
            ...
            DocumentChanges computeDocChanges = view.computeDocChanges(immutableSortedMap);
            ...
            if (remoteEvent == null) {
                ...
                targetChange = (TargetChange) remoteEvent.getTargetChanges().get(Integer.valueOf(queryView.getTargetId()));
            }
    ...
    public void handleCredentialChange(User user) {
        int equals = this.currentUser.equals(user) ^ 1;
        this.currentUser = user;
        if (equals != 0) {
    ...
    private void logErrorIfInteresting(Status status, String str, Object... objArr) {
        if (errorIsInteresting(status)) {
            ...
            Logger.warn("Firestore", "%s: %s", str, status);
        }
    }
