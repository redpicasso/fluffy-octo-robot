...
class FirestoreMultiDbComponent {
    ...
    FirestoreMultiDbComponent(@NonNull Context context, @NonNull FirebaseApp firebaseApp, @Nullable InternalAuthProvider internalAuthProvider) {
    ...
    @NonNull
    synchronized FirebaseFirestore get(@NonNull String str) {
