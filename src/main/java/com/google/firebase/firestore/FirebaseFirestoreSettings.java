...
public final class FirebaseFirestoreSettings {
    ...
    public String toString() {
        return MoreObjects.toStringHelper((Object) this).add("host", this.host).add("sslEnabled", this.sslEnabled).add("persistenceEnabled", this.persistenceEnabled).add("timestampsInSnapshotsEnabled", this.timestampsInSnapshotsEnabled).toString();
    }
