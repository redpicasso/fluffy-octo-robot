...
public class ArrayValue extends FieldValue {
    ...
    public int compareTo(FieldValue fieldValue) {
        ...
        for (int i = 0; i < min; i++) {
            int compareTo = ((FieldValue) this.internalValue.get(i)).compareTo((FieldValue) arrayValue.internalValue.get(i));
            if (compareTo != 0) {
                return compareTo;
            }
        }
    ...
    public List<Object> value() {
        List<Object> arrayList = new ArrayList(this.internalValue.size());
    ...
    public List<Object> value(FieldValueOptions fieldValueOptions) {
        List<Object> arrayList = new ArrayList(this.internalValue.size());
        for (FieldValue value : this.internalValue) {
            arrayList.add(value.value(fieldValueOptions));
        }
        return arrayList;
    }
