...
public final class UnknownDocument extends GeneratedMessageLite<UnknownDocument, Builder> implements UnknownDocumentOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<UnknownDocument, Builder> implements UnknownDocumentOrBuilder {
        private Builder() {
        ...
        public Builder setVersion(com.google.protobuf.Timestamp.Builder builder) {
            copyOnWrite();
    ...
    private void setVersion(Timestamp timestamp) {
        if (timestamp != null) {
    ...
    private void setVersion(com.google.protobuf.Timestamp.Builder builder) {
        this.version_ = (Timestamp) builder.build();
    }

    private void mergeVersion(Timestamp timestamp) {
        Timestamp timestamp2 = this.version_;
        if (timestamp2 == null || timestamp2 == Timestamp.getDefaultInstance()) {
            this.version_ = timestamp;
        } else {
            this.version_ = (Timestamp) ((com.google.protobuf.Timestamp.Builder) Timestamp.newBuilder(this.version_).mergeFrom(timestamp)).buildPartial();
        }
    }
    ...
    public static UnknownDocument parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (UnknownDocument) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
    ...
    protected final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                this.name_ = visitor.visitString(this.name_.isEmpty() ^ true, this.name_, true ^ unknownDocument.name_.isEmpty(), unknownDocument.name_);
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.version_ != null ? (com.google.protobuf.Timestamp.Builder) this.version_.toBuilder() : null;
