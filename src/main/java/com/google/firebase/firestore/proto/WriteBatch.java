...
public final class WriteBatch extends GeneratedMessageLite<WriteBatch, Builder> implements WriteBatchOrBuilder {
    ...
    private ProtobufList<Write> baseWrites_ = GeneratedMessageLite.emptyProtobufList();
    private int batchId_;
    private int bitField0_;
    private Timestamp localWriteTime_;
    private ProtobufList<Write> writes_ = GeneratedMessageLite.emptyProtobufList();

    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteBatch, Builder> implements WriteBatchOrBuilder {
        private Builder() {
        ...
        public Builder setWrites(int i, com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder addWrites(com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
            ((WriteBatch) this.instance).addWrites(builder);
            return this;
        }

        public Builder addWrites(int i, com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder setLocalWriteTime(com.google.protobuf.Timestamp.Builder builder) {
            copyOnWrite();
        ...
        public Builder setBaseWrites(int i, com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder addBaseWrites(com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
            ((WriteBatch) this.instance).addBaseWrites(builder);
            return this;
        }

        public Builder addBaseWrites(int i, com.google.firestore.v1.Write.Builder builder) {
            copyOnWrite();
    ...
    private void setWrites(int i, Write write) {
        if (write != null) {
    ...
    private void setWrites(int i, com.google.firestore.v1.Write.Builder builder) {
        ensureWritesIsMutable();
    ...
    private void addWrites(int i, Write write) {
        if (write != null) {
            ensureWritesIsMutable();
    ...
    private void addWrites(com.google.firestore.v1.Write.Builder builder) {
        ensureWritesIsMutable();
        this.writes_.add((Write) builder.build());
    }

    private void addWrites(int i, com.google.firestore.v1.Write.Builder builder) {
        ensureWritesIsMutable();
    ...
    private void setLocalWriteTime(Timestamp timestamp) {
        if (timestamp != null) {
    ...
    private void setLocalWriteTime(com.google.protobuf.Timestamp.Builder builder) {
        this.localWriteTime_ = (Timestamp) builder.build();
    }

    private void mergeLocalWriteTime(Timestamp timestamp) {
        Timestamp timestamp2 = this.localWriteTime_;
        if (timestamp2 == null || timestamp2 == Timestamp.getDefaultInstance()) {
            this.localWriteTime_ = timestamp;
        } else {
            this.localWriteTime_ = (Timestamp) ((com.google.protobuf.Timestamp.Builder) Timestamp.newBuilder(this.localWriteTime_).mergeFrom(timestamp)).buildPartial();
        }
    }
    ...
    private void setBaseWrites(int i, Write write) {
        if (write != null) {
    ...
    private void setBaseWrites(int i, com.google.firestore.v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();
        this.baseWrites_.set(i, (Write) builder.build());
    }

    private void addBaseWrites(Write write) {
        if (write != null) {
            ensureBaseWritesIsMutable();
    ...
    private void addBaseWrites(int i, Write write) {
        if (write != null) {
            ensureBaseWritesIsMutable();
    ...
    private void addBaseWrites(com.google.firestore.v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();
        this.baseWrites_.add((Write) builder.build());
    }

    private void addBaseWrites(int i, com.google.firestore.v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();
        this.baseWrites_.add(i, (Write) builder.build());
    }

    private void addAllBaseWrites(Iterable<? extends Write> iterable) {
        ensureBaseWritesIsMutable();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        while (i < this.baseWrites_.size()) {
            codedOutputStream.writeMessage(4, (MessageLite) this.baseWrites_.get(i));
            i++;
        }
    }
    ...
    public int getSerializedSize() {
        ...
        i = this.batchId_;
        int i2 = 0;
        int computeInt32Size = i != 0 ? CodedOutputStream.computeInt32Size(1, i) + 0 : 0;
        for (i = 0; i < this.writes_.size(); i++) {
            computeInt32Size += CodedOutputStream.computeMessageSize(2, (MessageLite) this.writes_.get(i));
        }
        if (this.localWriteTime_ != null) {
            computeInt32Size += CodedOutputStream.computeMessageSize(3, getLocalWriteTime());
        }
        while (i2 < this.baseWrites_.size()) {
            computeInt32Size += CodedOutputStream.computeMessageSize(4, (MessageLite) this.baseWrites_.get(i2));
            i2++;
        }
    ...
    public static WriteBatch parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (WriteBatch) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.localWriteTime_ != null ? (com.google.protobuf.Timestamp.Builder) this.localWriteTime_.toBuilder() : null;
