...
public final class Target extends GeneratedMessageLite<Target, Builder> implements TargetOrBuilder {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        /* JADX WARNING: Missing block: B:19:0x0062, code:
            $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase = new int[com.google.firebase.firestore.proto.Target.TargetTypeCase.values().length];
     */
        /* JADX WARNING: Missing block: B:21:?, code:
            $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase[com.google.firebase.firestore.proto.Target.TargetTypeCase.QUERY.ordinal()] = 1;
     */
        /* JADX WARNING: Missing block: B:23:?, code:
            $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase[com.google.firebase.firestore.proto.Target.TargetTypeCase.DOCUMENTS.ordinal()] = 2;
     */
        /* JADX WARNING: Missing block: B:25:?, code:
            $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase[com.google.firebase.firestore.proto.Target.TargetTypeCase.TARGETTYPE_NOT_SET.ordinal()] = 3;
     */
     ...
     */
        ...
        L_0x0062:
            r3 = com.google.firebase.firestore.proto.Target.TargetTypeCase.values();
            r3 = r3.length;
            r3 = new int[r3];
            $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase = r3;
            r3 = $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase;	 Catch:{ NoSuchFieldError -> 0x0075 }
            r4 = com.google.firebase.firestore.proto.Target.TargetTypeCase.QUERY;	 Catch:{ NoSuchFieldError -> 0x0075 }
            r4 = r4.ordinal();	 Catch:{ NoSuchFieldError -> 0x0075 }
            r3[r4] = r0;	 Catch:{ NoSuchFieldError -> 0x0075 }
        L_0x0075:
            r0 = $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase;	 Catch:{ NoSuchFieldError -> 0x007f }
            r3 = com.google.firebase.firestore.proto.Target.TargetTypeCase.DOCUMENTS;	 Catch:{ NoSuchFieldError -> 0x007f }
            r3 = r3.ordinal();	 Catch:{ NoSuchFieldError -> 0x007f }
            r0[r3] = r1;	 Catch:{ NoSuchFieldError -> 0x007f }
        L_0x007f:
            r0 = $SwitchMap$com$google$firebase$firestore$proto$Target$TargetTypeCase;	 Catch:{ NoSuchFieldError -> 0x0089 }
            r1 = com.google.firebase.firestore.proto.Target.TargetTypeCase.TARGETTYPE_NOT_SET;	 Catch:{ NoSuchFieldError -> 0x0089 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0089 }
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0089 }
        L_0x0089:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.proto.Target.1.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<Target, Builder> implements TargetOrBuilder {
        ...
        public Builder setQuery(com.google.firestore.v1.Target.QueryTarget.Builder builder) {
            copyOnWrite();
        ...
        public Builder setDocuments(com.google.firestore.v1.Target.DocumentsTarget.Builder builder) {
            copyOnWrite();
    ...
    private void setSnapshotVersion(Timestamp timestamp) {
        if (timestamp != null) {
    ...
    private void setSnapshotVersion(com.google.protobuf.Timestamp.Builder builder) {
        this.snapshotVersion_ = (Timestamp) builder.build();
    }

    private void mergeSnapshotVersion(Timestamp timestamp) {
    ...
    private void setLastListenSequenceNumber(long j) {
    ...
    private void setQuery(com.google.firestore.v1.Target.QueryTarget.Builder builder) {
    ...
    private void mergeQuery(QueryTarget queryTarget) {
        if (this.targetTypeCase_ != 5 || this.targetType_ == QueryTarget.getDefaultInstance()) {
            ...
            this.targetType_ = ((com.google.firestore.v1.Target.QueryTarget.Builder) QueryTarget.newBuilder((QueryTarget) this.targetType_).mergeFrom(queryTarget)).buildPartial();
        }
        this.targetTypeCase_ = 5;
    }
    ...
    private void setDocuments(com.google.firestore.v1.Target.DocumentsTarget.Builder builder) {
        this.targetType_ = builder.build();
        this.targetTypeCase_ = 6;
    }
    ...
    private void mergeDocuments(DocumentsTarget documentsTarget) {
        if (this.targetTypeCase_ != 6 || this.targetType_ == DocumentsTarget.getDefaultInstance()) {
            ...
            this.targetType_ = ((com.google.firestore.v1.Target.DocumentsTarget.Builder) DocumentsTarget.newBuilder((DocumentsTarget) this.targetType_).mergeFrom(documentsTarget)).buildPartial();
        }
        this.targetTypeCase_ = 6;
    }
    ...
    public int getSerializedSize() {
        ...
        if (this.snapshotVersion_ != null) {
            i += CodedOutputStream.computeMessageSize(2, getSnapshotVersion());
        }
        if (!this.resumeToken_.isEmpty()) {
            i += CodedOutputStream.computeBytesSize(3, this.resumeToken_);
        }
        long j = this.lastListenSequenceNumber_;
        if (j != 0) {
        ...
        if (this.targetTypeCase_ == 5) {
            i += CodedOutputStream.computeMessageSize(5, (QueryTarget) this.targetType_);
        }
        if (this.targetTypeCase_ == 6) {
            i += CodedOutputStream.computeMessageSize(6, (DocumentsTarget) this.targetType_);
        }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                com.google.firestore.v1.Target.QueryTarget.Builder builder2 = this.targetTypeCase_ == 5 ? (com.google.firestore.v1.Target.QueryTarget.Builder) ((QueryTarget) this.targetType_).toBuilder() : null;
                                ...
                                com.google.firestore.v1.Target.DocumentsTarget.Builder builder3 = this.targetTypeCase_ == 6 ? (com.google.firestore.v1.Target.DocumentsTarget.Builder) ((DocumentsTarget) this.targetType_).toBuilder() : null;
