...
public final class TargetGlobal extends GeneratedMessageLite<TargetGlobal, Builder> implements TargetGlobalOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<TargetGlobal, Builder> implements TargetGlobalOrBuilder {
        private Builder() {
        ...
        public Builder setLastRemoteSnapshotVersion(com.google.protobuf.Timestamp.Builder builder) {
            copyOnWrite();
    ...
    private void setHighestListenSequenceNumber(long j) {
    ...
    private void setLastRemoteSnapshotVersion(Timestamp timestamp) {
        if (timestamp != null) {
    ...
    private void setLastRemoteSnapshotVersion(com.google.protobuf.Timestamp.Builder builder) {
        this.lastRemoteSnapshotVersion_ = (Timestamp) builder.build();
    }

    private void mergeLastRemoteSnapshotVersion(Timestamp timestamp) {
        Timestamp timestamp2 = this.lastRemoteSnapshotVersion_;
        if (timestamp2 == null || timestamp2 == Timestamp.getDefaultInstance()) {
            this.lastRemoteSnapshotVersion_ = timestamp;
        } else {
            this.lastRemoteSnapshotVersion_ = (Timestamp) ((com.google.protobuf.Timestamp.Builder) Timestamp.newBuilder(this.lastRemoteSnapshotVersion_).mergeFrom(timestamp)).buildPartial();
        }
    }
    ...
    public int getSerializedSize() {
        ...
        long j = this.highestListenSequenceNumber_;
        if (j != 0) {
            i += CodedOutputStream.computeInt64Size(2, j);
        }
        if (this.lastRemoteSnapshotVersion_ != null) {
            i += CodedOutputStream.computeMessageSize(3, getLastRemoteSnapshotVersion());
        }
        i2 = this.targetCount_;
        if (i2 != 0) {
    ...
    public static TargetGlobal parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        return (TargetGlobal) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                com.google.protobuf.Timestamp.Builder builder = this.lastRemoteSnapshotVersion_ != null ? (com.google.protobuf.Timestamp.Builder) this.lastRemoteSnapshotVersion_.toBuilder() : null;
