...
final /* synthetic */ class SQLiteMutationQueue$$Lambda$6 implements Consumer {
    private final SQLiteMutationQueue arg$1;
    private final List arg$2;

    private SQLiteMutationQueue$$Lambda$6(SQLiteMutationQueue sQLiteMutationQueue, List list) {
        this.arg$1 = sQLiteMutationQueue;
        this.arg$2 = list;
    }

    public static Consumer lambdaFactory$(SQLiteMutationQueue sQLiteMutationQueue, List list) {
        return new SQLiteMutationQueue$$Lambda$6(sQLiteMutationQueue, list);
    }
