...
final /* synthetic */ class SQLiteQueryCache$$Lambda$4 implements Consumer {
    ...
    private final QueryDataHolder arg$3;

    private SQLiteQueryCache$$Lambda$4(SQLiteQueryCache sQLiteQueryCache, Query query, QueryDataHolder queryDataHolder) {
        this.arg$1 = sQLiteQueryCache;
        this.arg$2 = query;
        this.arg$3 = queryDataHolder;
    }

    public static Consumer lambdaFactory$(SQLiteQueryCache sQLiteQueryCache, Query query, QueryDataHolder queryDataHolder) {
