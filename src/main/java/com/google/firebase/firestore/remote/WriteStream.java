...
import com.google.firestore.v1.WriteRequest.Builder;
...
public class WriteStream extends AbstractStream<WriteRequest, WriteResponse, Callback> {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    public interface Callback extends StreamCallback {
    ...
    WriteStream(FirestoreChannel firestoreChannel, AsyncQueue asyncQueue, RemoteSerializer remoteSerializer, Callback callback) {
        super(firestoreChannel, FirestoreGrpc.getWriteMethod(), asyncQueue, TimerId.WRITE_STREAM_CONNECTION_BACKOFF, TimerId.WRITE_STREAM_IDLE, callback);
    ...
    void writeHandshake() {
        ...
        Assert.hardAssert(this.handshakeComplete ^ 1, "Handshake already completed", new Object[0]);
