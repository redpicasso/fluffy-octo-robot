...
class OnlineStateTracker {
    ...
    void handleWatchStreamStart() {
        if (this.watchStreamFailures == 0) {
            ...
            this.onlineStateTimer = this.workerQueue.enqueueAfterDelay(TimerId.ONLINE_STATE_TIMEOUT, 10000, OnlineStateTracker$$Lambda$1.lambdaFactory$(this));
        }
    }
