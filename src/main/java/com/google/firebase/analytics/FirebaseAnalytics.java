...
public final class FirebaseAnalytics {
            ...
            synchronized (FirebaseAnalytics.class) {
                if (zzabt == null) {
                    if (zzz.zzf(context)) {
                        ...
                        zzabt = new FirebaseAnalytics(zzfj.zza(context, null));
                    }
                }
            }
        }
    ...
    public final void setUserId(@Nullable String str) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb("app", APEZProvider.FILEID, (Object) str, true);
        }
    }
    ...
    public final Task<String> getAppInstanceId() {
        try {
            ...
            if (this.zzl) {
                this.zzabu.zza(5, "Failed to schedule task for getAppInstanceId", null, null, null);
            } else {
    ...
    private final String zzi() {
        synchronized (this.zzabx) {
            ...
            if (this.zzl) {
                ...
                elapsedRealtime = this.zzj.zzx().elapsedRealtime();
            }
            if (Math.abs(elapsedRealtime - this.zzabw) < 1000) {
