...
public class SubtitleSampleDescriptionAtom extends SampleDescriptionAtom<SubtitleSampleDescription> {
    ...
    SubtitleSampleDescription getSampleDescription(SequentialReader sequentialReader) throws IOException {
        return null;
    }
    ...
    public void addMetadata(QuickTimeSubtitleDirectory quickTimeSubtitleDirectory) {
        ...
        quickTimeSubtitleDirectory.setBoolean(1, (subtitleSampleDescription.displayFlags & PropertyOptions.DELETE_EXISTING) == PropertyOptions.DELETE_EXISTING);
        quickTimeSubtitleDirectory.setBoolean(2, (subtitleSampleDescription.displayFlags & Ints.MAX_POWER_OF_TWO) == Ints.MAX_POWER_OF_TWO);
