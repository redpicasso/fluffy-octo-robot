...
public class QuickTimeDictionary {
    ...
    static {
        _dictionary.put(Integer.valueOf(4096), _majorBrands);
        _dictionary.put(Integer.valueOf(10), _videoCompressionTypes);
        _dictionary.put(Integer.valueOf(769), _soundAudioFormats);
        _dictionary.put(Integer.valueOf(1), _vendorIds);
