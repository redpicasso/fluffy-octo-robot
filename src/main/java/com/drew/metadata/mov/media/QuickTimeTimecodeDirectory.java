...
public class QuickTimeTimecodeDirectory extends QuickTimeDirectory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(1), "Drop Frame");
        _tagNameMap.put(Integer.valueOf(2), "24 Hour Max");
        _tagNameMap.put(Integer.valueOf(3), "Negative Times OK");
        _tagNameMap.put(Integer.valueOf(4), "Counter");
        _tagNameMap.put(Integer.valueOf(5), "Text Font");
        _tagNameMap.put(Integer.valueOf(6), "Text Face");
        _tagNameMap.put(Integer.valueOf(7), "Text Size");
        _tagNameMap.put(Integer.valueOf(8), "Text Color");
        _tagNameMap.put(Integer.valueOf(9), "Background Color");
        _tagNameMap.put(Integer.valueOf(10), "Font Name");
    }
