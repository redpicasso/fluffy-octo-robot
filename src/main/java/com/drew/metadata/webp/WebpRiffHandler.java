...
public class WebpRiffHandler implements RiffHandler {
    ...
    public void processChunk(@NotNull String str, @NotNull byte[] bArr) {
        Directory webpDirectory = new WebpDirectory();
        ...
        if (str.equals(WebpDirectory.CHUNK_EXIF)) {
            ...
            try {
                ...
                int int242 = byteArrayReader.getInt24(4);
                int24 = byteArrayReader.getInt24(7);
                webpDirectory.setInt(2, int242 + 1);
                webpDirectory.setInt(1, int24 + 1);
            ...
            byteArrayReader.setMotorolaByteOrder(false);
            try {
                if (byteArrayReader.getInt8(0) == (byte) 47) {
                    short uInt8 = byteArrayReader.getUInt8(1);
                    short uInt82 = byteArrayReader.getUInt8(2);
                    int24 = (((byteArrayReader.getUInt8(4) & 15) << 10) | (byteArrayReader.getUInt8(3) << 2)) | ((uInt82 & JfifUtil.MARKER_SOFn) >> 6);
            ...
            byteArrayReader.setMotorolaByteOrder(false);
            try {
                if (byteArrayReader.getUInt8(3) == (short) 157 && byteArrayReader.getUInt8(4) == (short) 1 && byteArrayReader.getUInt8(5) == (short) 42) {
                    int uInt16 = byteArrayReader.getUInt16(6);
                    int24 = byteArrayReader.getUInt16(8);
                    webpDirectory.setInt(2, uInt16);
                    webpDirectory.setInt(1, int24);
                    this._metadata.addDirectory(webpDirectory);
                }
            } catch (IOException e22) {
                webpDirectory.addError(e22.getMessage());
            }
        }
    }
}
