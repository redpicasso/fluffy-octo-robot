...
public class IptcDescriptor extends TagDescriptor<IptcDirectory> {
    ...
    public String getDescription(int i) {
        ...
        if (i == IptcDirectory.TAG_DATE_SENT) {
            return getDateSentDescription();
        }
        if (i == IptcDirectory.TAG_TIME_SENT) {
        ...
        if (i == IptcDirectory.TAG_DATE_CREATED) {
            return getDateCreatedDescription();
        }
        if (i == IptcDirectory.TAG_TIME_CREATED) {
            return getTimeCreatedDescription();
        }
        if (i == 549) {
            return getExpirationDateDescription();
        }
        if (i == IptcDirectory.TAG_EXPIRATION_TIME) {
            return getExpirationTimeDescription();
        }
        if (i == IptcDirectory.TAG_DIGITAL_DATE_CREATED) {
            return getDigitalDateCreatedDescription();
        }
        if (i != IptcDirectory.TAG_DIGITAL_TIME_CREATED) {
    ...
    public String getDateDescription(int i) {
        ...
        if (string.length() == 8) {
            ...
            stringBuilder.append(':');
            stringBuilder.append(string.substring(6));
