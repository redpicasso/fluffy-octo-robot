...
public class MovieHeaderBox extends FullBox {
    ...
    public void addMetadata(Mp4Directory mp4Directory) {
        ...
        int i = this.rate;
        mp4Directory.setDouble(260, ((double) ((SupportMenu.CATEGORY_MASK & i) >> 16)) + (((double) (i & 65535)) / Math.pow(2.0d, 4.0d)));
        i = this.volume;
        mp4Directory.setDouble(261, ((double) ((MotionEventCompat.ACTION_POINTER_INDEX_MASK & i) >> 8)) + (((double) (i & 255)) / Math.pow(2.0d, 2.0d)));
