...
public class Mp4Dictionary {
    ...
    static {
        _dictionary.put(Integer.valueOf(1), _majorBrands);
        _dictionary.put(Integer.valueOf(110), _videoCompressionTypes);
        HashMap hashMap = _dictionary;
        Integer valueOf = Integer.valueOf(101);
        hashMap.put(valueOf, _soundAudioFormats);
        _dictionary.put(valueOf, _vendorIds);
        ...
        String str = "dmb1";
        _videoCompressionTypes.put(str, "OpenDML JPEG");
        ...
        String str2 = "raw ";
        _videoCompressionTypes.put(str2, "RAW");
        ...
        _videoCompressionTypes.put(RNFetchBlobConst.RNFB_RESPONSE_PATH, "Vector");
        ...
        String str3 = "avc1";
        _videoCompressionTypes.put(str3, "H.264");
        String str4 = "MPEG-4";
        _videoCompressionTypes.put("mp4v", str4);
        _videoCompressionTypes.put("MP4V", str4);
        ...
        str4 = "Animation";
        String str5 = "rle ";
        _videoCompressionTypes.put(str5, str4);
        _videoCompressionTypes.put(str5, str4);
        ...
        _soundAudioFormats.put(str2, "Uncompressed in offset-binary format");
        ...
        str2 = "uLaw 2:1";
        _soundAudioFormats.put("ulaw", str2);
        _soundAudioFormats.put("alaw", str2);
        _soundAudioFormats.put(new String(new byte[]{(byte) 109, (byte) 115, (byte) 0, (byte) 2}), "Microsoft ADPCM-ACM code 2");
        _soundAudioFormats.put(new String(new byte[]{(byte) 109, (byte) 115, (byte) 0, (byte) 17}), "DVI/Intel IMAADPCM-ACM code 17");
        ...
        _soundAudioFormats.put(new String(new byte[]{(byte) 109, (byte) 115, (byte) 0, (byte) 85}), "MPEG-1 layer 3, CBR only (pre-QT4.1)");
        ...
        _soundAudioFormats.put(new String(new byte[]{(byte) 77, (byte) 83, (byte) 0, (byte) 2}), "Microsoft ADPCM");
        _soundAudioFormats.put(new String(new byte[]{(byte) 77, (byte) 83, (byte) 0, (byte) 17}), "DV IMA");
        _soundAudioFormats.put(new String(new byte[]{(byte) 77, (byte) 83, (byte) 0, (byte) 85}), "MPEG3");
        ...
        str2 = "3gp6";
        _majorBrands.put(str2, "3GPP Media (.3GP) Release 6 Basic Profile");
        _majorBrands.put(str2, "3GPP Media (.3GP) Release 6 Progressive Download");
        _majorBrands.put(str2, "3GPP Media (.3GP) Release 6 Streaming Servers");
        _majorBrands.put("3gs7", "3GPP Media (.3GP) Release 7 Streaming Servers");
        _majorBrands.put(str3, "MP4 Base w/ AVC ext [ISO 14496-12:2005]");
        ...
        _majorBrands.put(str, "DMB MAF supporting all the components defined in the specification");
        ...
        str = "pana";
        _majorBrands.put(str, "Panasonic Digital Camera");
    ...
    public static String lookup(int i, String str) {
        return (_dictionary.containsKey(Integer.valueOf(i)) && ((HashMap) _dictionary.get(Integer.valueOf(i))).containsKey(str)) ? (String) ((HashMap) _dictionary.get(Integer.valueOf(i))).get(str) : "Unknown";
    }
