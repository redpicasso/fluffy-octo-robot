...
public abstract class Mp4MediaDirectory extends Mp4Directory {
    ...
    protected static void addMp4MediaTags(HashMap<Integer, String> hashMap) {
        hashMap.put(Integer.valueOf(101), "Creation Time");
        hashMap.put(Integer.valueOf(102), "Modification Time");
        hashMap.put(Integer.valueOf(103), "Duration");
        hashMap.put(Integer.valueOf(104), "ISO 639-2 Language Code");
    }
}
