...
public class Mp4SoundDirectory extends Mp4MediaDirectory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(101), "Format");
        _tagNameMap.put(Integer.valueOf(102), "Number of Channels");
        _tagNameMap.put(Integer.valueOf(103), "Sample Size");
        _tagNameMap.put(Integer.valueOf(104), "Sample Rate");
        _tagNameMap.put(Integer.valueOf(105), "Balance");
    }
