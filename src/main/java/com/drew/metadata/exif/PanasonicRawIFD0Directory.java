...
public class PanasonicRawIFD0Directory extends Directory {
    ...
    static {
        _tagNameMap.put(Integer.valueOf(1), "Panasonic Raw Version");
        ...
        _tagNameMap.put(Integer.valueOf(23), ExifInterface.TAG_RW2_ISO);
        ...
        _tagNameMap.put(Integer.valueOf(271), ExifInterface.TAG_MAKE);
        _tagNameMap.put(Integer.valueOf(272), ExifInterface.TAG_MODEL);
        _tagNameMap.put(Integer.valueOf(273), "Strip Offsets");
        _tagNameMap.put(Integer.valueOf(274), ExifInterface.TAG_ORIENTATION);
