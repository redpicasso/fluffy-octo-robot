...
public class ReconyxHyperFireMakernoteDescriptor extends TagDescriptor<ReconyxHyperFireMakernoteDirectory> {
    ...
    public String getDescription(int i) {
        ...
        switch (i) {
            case 0:
                return String.format(str2, new Object[]{((ReconyxHyperFireMakernoteDirectory) this._directory).getInteger(i)});
            case 2:
                return ((ReconyxHyperFireMakernoteDirectory) this._directory).getString(i);
            case 12:
                return ((ReconyxHyperFireMakernoteDirectory) this._directory).getString(i);
            case 14:
                if (((ReconyxHyperFireMakernoteDirectory) this._directory).getIntArray(i) == null) {
                    return null;
                }
                return String.format("%d/%d", new Object[]{Integer.valueOf(((ReconyxHyperFireMakernoteDirectory) this._directory).getIntArray(i)[0]), Integer.valueOf(((ReconyxHyperFireMakernoteDirectory) this._directory).getIntArray(i)[1])});
            case 18:
                return String.format(str2, new Object[]{((ReconyxHyperFireMakernoteDirectory) this._directory).getInteger(i)});
            case 22:
            ...
            case 84:
                ...
                if (doubleObject != null) {
                    str = decimalFormat.format(doubleObject);
                }
                return str;
            case 86:
                return ((ReconyxHyperFireMakernoteDirectory) this._directory).getString(i);
