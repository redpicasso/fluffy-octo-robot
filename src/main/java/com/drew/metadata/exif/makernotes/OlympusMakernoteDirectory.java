...
public class OlympusMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(1), str);
        _tagNameMap.put(Integer.valueOf(3), str);
        _tagNameMap.put(Integer.valueOf(64), "Compressed Image Size");
        String str2 = "Thumbnail Offset";
        _tagNameMap.put(Integer.valueOf(129), str2);
        _tagNameMap.put(Integer.valueOf(136), str2);
        _tagNameMap.put(Integer.valueOf(137), "Thumbnail Length");
        _tagNameMap.put(Integer.valueOf(256), "Thumbnail Image");
        _tagNameMap.put(Integer.valueOf(257), "Colour Mode");
        str2 = "Image Quality";
        _tagNameMap.put(Integer.valueOf(258), str2);
        _tagNameMap.put(Integer.valueOf(259), str2);
        ...
        _tagNameMap.put(Integer.valueOf(515), "BW Mode");
        String str3 = "Digital Zoom";
        _tagNameMap.put(Integer.valueOf(516), str3);
        _tagNameMap.put(Integer.valueOf(517), "Focal Plane Diagonal");
        _tagNameMap.put(Integer.valueOf(518), "Lens Distortion Parameters");
        _tagNameMap.put(Integer.valueOf(519), "Camera Type");
        ...
        _tagNameMap.put(Integer.valueOf(768), "Pre Capture Frames");
        _tagNameMap.put(Integer.valueOf(769), "White Board");
        _tagNameMap.put(Integer.valueOf(770), "One Touch WB");
        _tagNameMap.put(Integer.valueOf(771), "White Balance Bracket");
        _tagNameMap.put(Integer.valueOf(772), "White Balance Bias");
        _tagNameMap.put(Integer.valueOf(1027), "Scene Mode");
        String str4 = "Serial Number";
        _tagNameMap.put(Integer.valueOf(1028), str4);
        _tagNameMap.put(Integer.valueOf(1029), "Firmware");
        ...
        _tagNameMap.put(Integer.valueOf(4096), "Shutter Speed Value");
        _tagNameMap.put(Integer.valueOf(4097), "ISO Value");
        _tagNameMap.put(Integer.valueOf(4098), "Aperture Value");
        _tagNameMap.put(Integer.valueOf(4099), "Brightness Value");
        String str5 = "Flash Mode";
        _tagNameMap.put(Integer.valueOf(4100), str5);
        _tagNameMap.put(Integer.valueOf(4101), "Flash Device");
        ...
        _tagNameMap.put(Integer.valueOf(4106), "Focus Range");
        String str6 = "Focus Mode";
        _tagNameMap.put(Integer.valueOf(4107), str6);
        String str7 = "Focus Distance";
        _tagNameMap.put(Integer.valueOf(TAG_FOCUS_DISTANCE), str7);
        ...
        String str8 = ExifInterface.TAG_SHARPNESS;
        hashMap.put(valueOf, str8);
        _tagNameMap.put(Integer.valueOf(4112), "Flash Charge Level");
        _tagNameMap.put(Integer.valueOf(4113), "Colour Matrix");
        _tagNameMap.put(Integer.valueOf(4114), "Black Level");
        _tagNameMap.put(Integer.valueOf(4115), "Color Temperature BG");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_SERIAL_NUMBER_2), str4);
        _tagNameMap.put(Integer.valueOf(TAG_EXTERNAL_FLASH_AE1_0), "External Flash AE1 0");
        _tagNameMap.put(Integer.valueOf(4124), "External Flash AE2 0");
        ...
        _tagNameMap.put(Integer.valueOf(4128), "External Flash AE2");
        _tagNameMap.put(Integer.valueOf(4129), "Internal Flash AE1");
        ...
        hashMap = _tagNameMap;
        valueOf = Integer.valueOf(TAG_CONTRAST);
        str4 = ExifInterface.TAG_CONTRAST;
        ...
        _tagNameMap.put(Integer.valueOf(4144), "Scene Detect");
        _tagNameMap.put(Integer.valueOf(4145), "Scene Area");
        _tagNameMap.put(Integer.valueOf(4147), "Scene Detect Data");
        ...
        _tagNameMap.put(Integer.valueOf(8208), "Equipment");
        _tagNameMap.put(Integer.valueOf(8224), str);
        ...
        _tagNameMap.put(Integer.valueOf(12288), "Raw Info");
        _tagNameMap.put(Integer.valueOf(16384), "Main Info");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_EXPOSURE_MODE), "Exposure Mode");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FLASH_MODE), str5);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_IMAGE_QUALITY), str2);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_DIGITAL_ZOOM), str3);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_DISTANCE), str7);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_CONTRAST), str4);
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_SHARPNESS), str8);
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_MODE), str6);
        ...
        String str9 = "FE190/X750";
        OlympusCameraTypes.put("D4327", str9);
        OlympusCameraTypes.put("D4328", "u760,S760");
        str = "FE180/X745";
        OlympusCameraTypes.put("D4330", str);
        ...
        OlympusCameraTypes.put("SX875", str);
        OlympusCameraTypes.put("SX876", str9);
    }
