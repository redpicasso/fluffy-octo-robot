...
public class FujifilmMakernoteDescriptor extends TagDescriptor<FujifilmMakernoteDirectory> {
    ...
    public String getDescription(int i) {
        ...
        if (i == FujifilmMakernoteDirectory.TAG_AUTO_BRACKETING) {
            return getAutoBracketingDescription();
        }
        if (i == FujifilmMakernoteDirectory.TAG_FINE_PIX_COLOR) {
    ...
    public String getSharpnessDescription() {
        ...
        if (intValue == NikonType2MakernoteDirectory.TAG_ADAPTER) {
            return "Medium Soft";
        }
        if (intValue == NikonType2MakernoteDirectory.TAG_LENS) {
            return "Medium Hard";
        }
        if (intValue == 32768) {
    ...
    public String getColorSaturationDescription() {
        ...
        if (intValue == BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) {
            return "Medium Low";
        }
        if (intValue == 512) {
            return "Low";
    ...
    public String getFlashExposureValueDescription() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(rational.toSimpleString(false));
    ...
    public String getFilmModeDescription() {
        ...
        if (intValue == OlympusRawInfoMakernoteDirectory.TagWbRbLevelsDaylightFluor) {
        ...
        if (intValue == OlympusCameraSettingsMakernoteDirectory.TagWhiteBalanceTemperature) {
            return "Pro Neg. Hi";
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Unknown (");
