...
public class CasioType2MakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(13), str);
        _tagNameMap.put(Integer.valueOf(20), "ISO Sensitivity");
        String str2 = "White Balance";
        _tagNameMap.put(Integer.valueOf(25), str2);
        _tagNameMap.put(Integer.valueOf(29), "Focal Length");
        _tagNameMap.put(Integer.valueOf(31), ExifInterface.TAG_SATURATION);
        _tagNameMap.put(Integer.valueOf(32), ExifInterface.TAG_CONTRAST);
        _tagNameMap.put(Integer.valueOf(33), ExifInterface.TAG_SHARPNESS);
        ...
        _tagNameMap.put(Integer.valueOf(8210), str2);
        ...
        _tagNameMap.put(Integer.valueOf(TAG_FOCUS_MODE_2), str);
