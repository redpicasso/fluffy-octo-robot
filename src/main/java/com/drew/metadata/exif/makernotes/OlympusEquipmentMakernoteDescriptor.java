...
public class OlympusEquipmentMakernoteDescriptor extends TagDescriptor<OlympusEquipmentMakernoteDirectory> {
    ...
    public String getFocalPlaneDiagonalDescription() {
        ...
        stringBuilder.append(((OlympusEquipmentMakernoteDirectory) this._directory).getString(259));
    ...
    public String getBodyFirmwareVersionDescription() {
        if (((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(260) == null) {
            return null;
        }
        String format = String.format("%04X", new Object[]{((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(260)});
    ...
    public String getLensTypeDescription() {
        ...
        try {
            ...
            return (String) _olympusLensTypes.get(String.format("%X %02X %02X", new Object[]{Integer.valueOf(parseInt), Integer.valueOf(parseInt2), Integer.valueOf(parseInt3)}));
    ...
    public String getLensFirmwareVersionDescription() {
        if (((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(516) == null) {
            return null;
        }
        String format = String.format("%04X", new Object[]{((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(516)});
        return String.format("%s.%s", new Object[]{format.substring(0, format.length() - 3), format.substring(format.length() - 3)});
    }
    ...
    public String getLensPropertiesDescription() {
        if (((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(523) == null) {
            return null;
        }
        return String.format("0x%04X", new Object[]{((OlympusEquipmentMakernoteDirectory) this._directory).getInteger(523)});
    }
    ...
    public String getExtenderDescription() {
        ...
        try {
            int parseInt = Integer.parseInt(split[0]);
            int parseInt2 = Integer.parseInt(split[2]);
            return (String) _olympusExtenderTypes.get(String.format("%X %02X", new Object[]{Integer.valueOf(parseInt), Integer.valueOf(parseInt2)}));
        } catch (NumberFormatException unused) {
            return null;
        }
    }
    ...
    static {
        String str = "None";
        _olympusLensTypes.put("0 00 00", str);
        ...
        String str2 = "Sigma 18-125mm F3.5-5.6 DC";
        _olympusLensTypes.put("1 03 00", str2);
        _olympusLensTypes.put("1 03 10", "Sigma 30mm F2.8 DN | A");
        _olympusLensTypes.put("1 04 00", str2);
        _olympusLensTypes.put("1 04 10", "Sigma 19mm F2.8 DN | A");
        str2 = "Sigma 30mm F1.4 EX DC HSM";
        _olympusLensTypes.put("1 05 00", str2);
        _olympusLensTypes.put("1 05 10", "Sigma 60mm F2.8 DN | A");
        String str3 = "Sigma APO 50-500mm F4.0-6.3 EX DG HSM";
        _olympusLensTypes.put("1 06 00", str3);
        ...
        _olympusLensTypes.put("1 13 00", str2);
        _olympusLensTypes.put("1 14 00", str3);
        ...
        str2 = "Leica D Vario Elmarit 14-50mm F2.8-3.5 Asph.";
        _olympusLensTypes.put("2 01 00", str2);
        _olympusLensTypes.put("2 01 10", "Lumix G Vario 14-45mm F3.5-5.6 Asph. Mega OIS");
        str3 = "Leica D Summilux 25mm F1.4 Asph.";
        _olympusLensTypes.put("2 02 00", str3);
        ...
        _olympusLensTypes.put("3 01 00", str2);
        _olympusLensTypes.put("3 02 00", str3);
        _olympusLensTypes.put("5 01 10", "Tamron 14-150mm F3.5-5.8 Di III");
        _olympusExtenderTypes.put("0 00", str);
