...
public class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public String getColorTemperatureDescription() {
        ...
        int intValue = ((integer.intValue() & ViewCompat.MEASURED_STATE_MASK) >> 24) | ((integer.intValue() & 16711680) >> 8);
    ...
    public java.lang.String getColorModeDescription() {
        ...
        r3 = this;
        r0 = r3._directory;
        r0 = (com.drew.metadata.exif.makernotes.SonyType1MakernoteDirectory) r0;
        r1 = 45097; // 0xb029 float:6.3194E-41 double:2.2281E-319;
        r0 = r0.getInteger(r1);
