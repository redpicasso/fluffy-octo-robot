...
public class SonyType1MakernoteDirectory extends Directory {
    ...
    static {
        _tagNameMap.put(Integer.valueOf(16), "Camera Info");
        ...
        String str = "Long Exposure Noise Reduction";
        _tagNameMap.put(Integer.valueOf(TAG_LONG_EXPOSURE_NOISE_REDUCTION), str);
        String str2 = "High ISO Noise Reduction";
        _tagNameMap.put(Integer.valueOf(TAG_HIGH_ISO_NOISE_REDUCTION), str2);
        ...
        _tagNameMap.put(Integer.valueOf(TAG_FOCUS_MODE), str3);
        ...
        String str4 = "Dynamic Range Optimizer";
        _tagNameMap.put(Integer.valueOf(TAG_DYNAMIC_RANGE_OPTIMISER), str4);
        ...
        _tagNameMap.put(Integer.valueOf(TAG_FOCUS_MODE_2), str3);
        ...
        _tagNameMap.put(Integer.valueOf(TAG_LONG_EXPOSURE_NOISE_REDUCTION_OR_FOCUS_MODE), str);
        _tagNameMap.put(Integer.valueOf(TAG_DYNAMIC_RANGE_OPTIMIZER), str4);
        _tagNameMap.put(Integer.valueOf(TAG_HIGH_ISO_NOISE_REDUCTION_2), str2);
