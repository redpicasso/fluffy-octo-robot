...
public class CanonMakernoteDirectory extends Directory {
    ...
    static {
        ...
        String str = "Focus Mode";
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_MODE_1), str);
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FOCUS_MODE_2), str);
        ...
        str = "White Balance";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_WHITE_BALANCE), str);
        String str2 = "Sequence Number";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_SEQUENCE_NUMBER), str2);
        ...
        String str3 = "Auto Exposure Bracketing";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_AUTO_EXPOSURE_BRACKETING), str3);
        String str4 = "AEB Bracket Value";
        _tagNameMap.put(Integer.valueOf(FocalLength.TAG_AEB_BRACKET_VALUE), str4);
        ...
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_WHITE_BALANCE), str);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_SLOW_SHUTTER), "Slow Shutter");
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_SEQUENCE_NUMBER), str2);
        ...
        str = "AF Points in Focus";
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AF_POINTS_IN_FOCUS), str);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_FLASH_EXPOSURE_BRACKETING), "Flash Exposure Compensation");
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AUTO_EXPOSURE_BRACKETING), str3);
        _tagNameMap.put(Integer.valueOf(ShotInfo.TAG_AEB_BRACKET_VALUE), str4);
        ...
        _tagNameMap.put(Integer.valueOf(AFInfo.TAG_AF_POINTS_IN_FOCUS), str);
        ...
        if (obj instanceof int[]) {
            ...
            if (i == 1) {
                ...
                while (i3 < iArr.length) {
                    int i5 = AFInfo.TAG_NUM_AF_POINTS + i4;
                    Object obj2;
                    int i6;
                    if (i5 == AFInfo.TAG_AF_AREA_X_POSITIONS || i5 == AFInfo.TAG_AF_AREA_Y_POSITIONS) {
                        if (iArr.length - 1 >= i3 + i) {
                            obj2 = new short[i];
                            for (i6 = 0; i6 < obj2.length; i6++) {
                                obj2[i6] = (short) iArr[i3 + i6];
                            }
                            super.setObjectArray(i5, obj2);
                        }
                        i5 = i - 1;
                    } else if (i5 == AFInfo.TAG_AF_POINTS_IN_FOCUS) {
                        obj2 = new short[((i + 15) / 16)];
                        if (iArr.length - 1 >= obj2.length + i3) {
                            for (i6 = 0; i6 < obj2.length; i6++) {
                                obj2[i6] = (short) iArr[i3 + i6];
                            }
                            super.setObjectArray(i5, obj2);
                        ...
                        super.setObjectArray(i5, Integer.valueOf(iArr[i3]));
                        i4++;
                        i3++;
                    }
                    i3 += i5;
