...
public class NikonType2MakernoteDirectory extends Directory {
    ...
    static {
        ...
        String str = ExifInterface.TAG_RW2_ISO;
        ...
        _tagNameMap.put(Integer.valueOf(19), str);
        ...
        _tagNameMap.put(Integer.valueOf(29), str);
        ...
        _tagNameMap.put(Integer.valueOf(160), str);
        ...
        hashMap = _tagNameMap;
        valueOf = Integer.valueOf(170);
        str = ExifInterface.TAG_SATURATION;
        hashMap.put(valueOf, str);
        ...
        _tagNameMap.put(Integer.valueOf(148), str);
