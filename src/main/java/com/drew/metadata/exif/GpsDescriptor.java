...
public class GpsDescriptor extends TagDescriptor<GpsDirectory> {
     ...
     */
    /* JADX WARNING: Missing block: B:28:0x003a, code:
    ...
    L_0x0027:
        r2 = super.getDescription(r2);
        return r2;
    L_0x002c:
        r2 = r1.getGpsDestinationReferenceDescription();
        return r2;
    L_0x0031:
        r2 = r1.getGpsDirectionDescription(r2);
        return r2;
    L_0x0036:
        r2 = r1.getGpsDirectionReferenceDescription(r2);
        return r2;
    L_0x003b:
        r2 = r1.getGpsMeasureModeDescription();
        return r2;
    L_0x0040:
        r2 = r1.getGpsStatusDescription();
        return r2;
    L_0x0045:
        r2 = r1.getGpsTimeStampDescription();
        return r2;
    L_0x004a:
        r2 = r1.getGpsAltitudeDescription();
        return r2;
    L_0x004f:
        r2 = r1.getGpsAltitudeRefDescription();
        return r2;
    L_0x0054:
        r2 = r1.getGpsLongitudeDescription();
        return r2;
    L_0x0059:
        r2 = r1.getGpsDifferentialDescription();
        return r2;
    L_0x005e:
        r2 = r1.getGpsSpeedRefDescription();
        return r2;
    L_0x0063:
        r2 = r1.getGpsLatitudeDescription();
        return r2;
    L_0x0068:
        r2 = r1.getGpsVersionIdDescription();
        return r2;
        */
    ...
    public String getGpsDirectionDescription(int i) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(format.trim());
    ...
    public String getGpsDirectionReferenceDescription(int i) {
        ...
        string = string.trim();
        if (ExifInterface.GPS_DIRECTION_TRUE.equalsIgnoreCase(string)) {
    ...
    public String getGpsMeasureModeDescription() {
        ...
        if (ExifInterface.GPS_MEASUREMENT_3D.equalsIgnoreCase(string)) {
    ...
    public String getGpsAltitudeDescription() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(rational.intValue());
