...
public class AviDirectory extends Directory {
    ...
    static {
        _tagNameMap.put(Integer.valueOf(1), "Frames Per Second");
        _tagNameMap.put(Integer.valueOf(2), "Samples Per Second");
        _tagNameMap.put(Integer.valueOf(3), "Duration");
        _tagNameMap.put(Integer.valueOf(4), "Video Codec");
        _tagNameMap.put(Integer.valueOf(5), "Audio Codec");
        _tagNameMap.put(Integer.valueOf(6), "Width");
        _tagNameMap.put(Integer.valueOf(7), "Height");
        _tagNameMap.put(Integer.valueOf(8), "Stream Count");
    }
