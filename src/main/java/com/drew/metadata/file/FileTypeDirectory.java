...
public class FileTypeDirectory extends Directory {
    ...
    static {
        _tagNameMap.put(Integer.valueOf(1), "Detected File Type Name");
        _tagNameMap.put(Integer.valueOf(2), "Detected File Type Long Name");
        _tagNameMap.put(Integer.valueOf(3), "Detected MIME Type");
        _tagNameMap.put(Integer.valueOf(4), "Expected File Name Extension");
    }
