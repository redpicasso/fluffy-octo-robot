...
public class JfifDescriptor extends TagDescriptor<JfifDirectory> {
    ...
    public String getImageVersionDescription() {
        ...
        return String.format("%d.%d", new Object[]{Integer.valueOf((((JfifDirectory) this._directory).getInteger(5).intValue() & MotionEventCompat.ACTION_POINTER_INDEX_MASK) >> 8), Integer.valueOf(((JfifDirectory) this._directory).getInteger(5).intValue() & 255)});
    }
