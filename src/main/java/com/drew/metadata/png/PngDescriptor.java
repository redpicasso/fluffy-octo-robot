...
public class PngDescriptor extends TagDescriptor<PngDirectory> {
    ...
    public String getTextualDataDescription() {
        ...
        for (KeyValuePair keyValuePair : list) {
            ...
            stringBuilder.append(String.format("%s: %s", new Object[]{keyValuePair.getKey(), keyValuePair.getValue()}));
        }
    ...
    public String getBackgroundColorDescription() {
        ...
        if (!(byteArray == null || integer == null)) {
            SequentialReader sequentialByteArrayReader = new SequentialByteArrayReader(byteArray);
            try {
