...
public class Face {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        Age age = this._age;
        if (!age == null ? age.equals(face._age) : face._age == null) {
            return false;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append(this._width);
        stringBuilder.append(" height: ");
        stringBuilder.append(this._height);
        if (this._name != null) {
        ...
        if (this._age != null) {
            ...
            stringBuilder.append(this._age.toFriendlyString());
        }
