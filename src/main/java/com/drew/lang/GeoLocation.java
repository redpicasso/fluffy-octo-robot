...
public final class GeoLocation {
    ...
    public String toString() {
        ...
        stringBuilder.append(this._latitude);
        stringBuilder.append(", ");
        stringBuilder.append(this._longitude);
    ...
    public String toDMSString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(decimalToDegreesMinutesSecondsString(this._latitude));
        stringBuilder.append(", ");
        stringBuilder.append(decimalToDegreesMinutesSecondsString(this._longitude));
        return stringBuilder.toString();
    }
}
