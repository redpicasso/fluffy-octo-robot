    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        ...
        this.cleanupRunnable = new Runnable() {
            ...
            public void run() {
                ...
                r6 = this;
            L_0x0000:
                r0 = com.squareup.okhttp.ConnectionPool.this;
            ...
            L_0x0017:
                ...
                r2 = r2 * r4;
                r0 = r0 - r2;
                r2 = com.squareup.okhttp.ConnectionPool.this;
                monitor-enter(r2);
                r3 = com.squareup.okhttp.ConnectionPool.this;	 Catch:{ InterruptedException -> 0x002b }
    ...
    private int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < list.size()) {
            if (((Reference) list.get(i)).get() != null) {
                ...
                stringBuilder.append(realConnection.getRoute().getAddress().url());
