...
public class ReactVideoView extends ScalableVideoView implements OnPreparedListener, OnErrorListener, OnBufferingUpdateListener, OnSeekCompleteListener, OnCompletionListener, OnInfoListener, LifecycleEventListener, MediaPlayerControl {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z && this.mMediaPlayerValid) {
            ...
            i = getVideoHeight();
            if (videoWidth != 0 && i != 0) {
                Matrix scaleMatrix = new ScaleManager(new Size(getWidth(), getHeight()), new Size(videoWidth, i)).getScaleMatrix(this.mScalableType);
                if (scaleMatrix != null) {
    ...
    public void setSrc(String str, String str2, boolean z, boolean z2, ReadableMap readableMap, int i, int i2) {
        ...
        if (z) {
            ...
            if (this.mMainVer > 0) {
                try {
                    ...
                    stringBuilder.append(str.replace(obj, ""));
                    stringBuilder.append(obj);
                    assetFileDescriptor = aPKExpansionZipFile.getAssetFileDescriptor(stringBuilder.toString());
        ...
        if (i3 > 0) {
            ...
            i3 = this.mPatchVer;
            if (i3 > 0) {
                createMap.putInt(ReactVideoViewManager.PROP_SRC_PATCHVER, i3);
            }
        }
    ...
    public void setPausedModifier(boolean z) {
        ...
        if (this.mMediaPlayerValid) {
            ...
            setKeepScreenOn(this.mPaused ^ 1);
        }
    }
