...
public final class LazyHeaders implements Headers {
    ...
    public static final class Builder {
        ...
        static String getSanitizedUserAgent() {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if ((charAt > 31 || charAt == 9) && charAt < Ascii.MAX) {
    ...
    private Map<String, String> generateHeaders() {
        ...
        for (Entry entry : this.headers.entrySet()) {
            CharSequence buildHeaderValue = buildHeaderValue((List) entry.getValue());
    ...
    private String buildHeaderValue(@NonNull List<LazyHeaderFactory> list) {
        ...
        for (int i = 0; i < size; i++) {
            Object buildHeader = ((LazyHeaderFactory) list.get(i)).buildHeader();
