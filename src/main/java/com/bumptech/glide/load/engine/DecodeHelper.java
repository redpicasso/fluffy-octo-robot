...
final class DecodeHelper<Transcode> {
    ...
    <R> void init(GlideContext glideContext, Object obj, Key key, int i, int i2, DiskCacheStrategy diskCacheStrategy, Class<?> cls, Class<R> cls2, Priority priority, Options options, Map<Class<?>, Transformation<?>> map, boolean z, boolean z2, DiskCacheProvider diskCacheProvider) {
    ...
    <X> Encoder<X> getSourceEncoder(X x) throws NoSourceEncoderAvailableException {
