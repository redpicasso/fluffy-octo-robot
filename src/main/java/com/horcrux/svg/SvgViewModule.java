...
class SvgViewModule extends ReactContextBaseJavaModule {
    ...
    private static void toDataURL(final int i, final ReadableMap readableMap, final Callback callback, final int i2) {
        UiThreadUtil.runOnUiThread(new Runnable() {
            public void run() {
                ...
                if (svgViewByTag == null) {
                    ...
                    if (readableMap != null) {
                        callback.invoke(svgViewByTag.toDataURL(r1.getInt("width"), readableMap.getInt("height")));
                        return;
                    }
