...
class RNSVGMarkerPosition {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        /* JADX WARNING: Missing block: B:13:0x0040, code:
            $SwitchMap$com$horcrux$svg$RNSVGMarkerType = new int[com.horcrux.svg.RNSVGMarkerType.values().length];
     */
        /* JADX WARNING: Missing block: B:15:?, code:
            $SwitchMap$com$horcrux$svg$RNSVGMarkerType[com.horcrux.svg.RNSVGMarkerType.kStartMarker.ordinal()] = 1;
     */
        /* JADX WARNING: Missing block: B:17:?, code:
            $SwitchMap$com$horcrux$svg$RNSVGMarkerType[com.horcrux.svg.RNSVGMarkerType.kMidMarker.ordinal()] = 2;
     */
     ...
     */
        static {
            /*
            r0 = com.horcrux.svg.ElementType.values();
            r0 = r0.length;
            r0 = new int[r0];
            $SwitchMap$com$horcrux$svg$ElementType = r0;
            r0 = 1;
            r1 = $SwitchMap$com$horcrux$svg$ElementType;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = com.horcrux.svg.ElementType.kCGPathElementAddCurveToPoint;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = r2.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1[r2] = r0;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r1 = 2;
            r2 = $SwitchMap$com$horcrux$svg$ElementType;	 Catch:{ NoSuchFieldError -> 0x001f }
            r3 = com.horcrux.svg.ElementType.kCGPathElementAddQuadCurveToPoint;	 Catch:{ NoSuchFieldError -> 0x001f }
            r3 = r3.ordinal();	 Catch:{ NoSuchFieldError -> 0x001f }
            r2[r3] = r1;	 Catch:{ NoSuchFieldError -> 0x001f }
        L_0x001f:
            r2 = 3;
            r3 = $SwitchMap$com$horcrux$svg$ElementType;	 Catch:{ NoSuchFieldError -> 0x002a }
            r4 = com.horcrux.svg.ElementType.kCGPathElementMoveToPoint;	 Catch:{ NoSuchFieldError -> 0x002a }
            r4 = r4.ordinal();	 Catch:{ NoSuchFieldError -> 0x002a }
            r3[r4] = r2;	 Catch:{ NoSuchFieldError -> 0x002a }
        L_0x002a:
            r3 = $SwitchMap$com$horcrux$svg$ElementType;	 Catch:{ NoSuchFieldError -> 0x0035 }
            r4 = com.horcrux.svg.ElementType.kCGPathElementAddLineToPoint;	 Catch:{ NoSuchFieldError -> 0x0035 }
            r4 = r4.ordinal();	 Catch:{ NoSuchFieldError -> 0x0035 }
            r5 = 4;
            r3[r4] = r5;	 Catch:{ NoSuchFieldError -> 0x0035 }
        L_0x0035:
            r3 = $SwitchMap$com$horcrux$svg$ElementType;	 Catch:{ NoSuchFieldError -> 0x0040 }
            r4 = com.horcrux.svg.ElementType.kCGPathElementCloseSubpath;	 Catch:{ NoSuchFieldError -> 0x0040 }
            r4 = r4.ordinal();	 Catch:{ NoSuchFieldError -> 0x0040 }
            r5 = 5;
            r3[r4] = r5;	 Catch:{ NoSuchFieldError -> 0x0040 }
        L_0x0040:
            r3 = com.horcrux.svg.RNSVGMarkerType.values();
            r3 = r3.length;
            r3 = new int[r3];
            $SwitchMap$com$horcrux$svg$RNSVGMarkerType = r3;
            r3 = $SwitchMap$com$horcrux$svg$RNSVGMarkerType;	 Catch:{ NoSuchFieldError -> 0x0053 }
            r4 = com.horcrux.svg.RNSVGMarkerType.kStartMarker;	 Catch:{ NoSuchFieldError -> 0x0053 }
            r4 = r4.ordinal();	 Catch:{ NoSuchFieldError -> 0x0053 }
            r3[r4] = r0;	 Catch:{ NoSuchFieldError -> 0x0053 }
        L_0x0053:
            r0 = $SwitchMap$com$horcrux$svg$RNSVGMarkerType;	 Catch:{ NoSuchFieldError -> 0x005d }
            r3 = com.horcrux.svg.RNSVGMarkerType.kMidMarker;	 Catch:{ NoSuchFieldError -> 0x005d }
            r3 = r3.ordinal();	 Catch:{ NoSuchFieldError -> 0x005d }
            r0[r3] = r1;	 Catch:{ NoSuchFieldError -> 0x005d }
        L_0x005d:
            r0 = $SwitchMap$com$horcrux$svg$RNSVGMarkerType;	 Catch:{ NoSuchFieldError -> 0x0067 }
            r1 = com.horcrux.svg.RNSVGMarkerType.kEndMarker;	 Catch:{ NoSuchFieldError -> 0x0067 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0067 }
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0067 }
        L_0x0067:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.horcrux.svg.RNSVGMarkerPosition.1.<clinit>():void");
        }
    }
