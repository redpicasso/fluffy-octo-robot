...
public class ReactDebugOverlayTags {
    ...
    public static final DebugOverlayTag NAVIGATION = new DebugOverlayTag("Navigation", "Tag for navigation", Color.rgb(NikonType2MakernoteDirectory.TAG_SCENE_ASSIST, 39, 176));
