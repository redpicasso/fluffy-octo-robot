...
public class ReactViewManager extends ViewGroupManager<ReactViewGroup> {
    ...
    public void setHitSlop(ReactViewGroup reactViewGroup, @Nullable ReadableMap readableMap) {
        ...
        int i = 0;
        int toPixelFromDIP = readableMap.hasKey(str) ? (int) PixelUtil.toPixelFromDIP(readableMap.getDouble(str)) : 0;
        String str2 = ViewProps.TOP;
        int toPixelFromDIP2 = readableMap.hasKey(str2) ? (int) PixelUtil.toPixelFromDIP(readableMap.getDouble(str2)) : 0;
        String str3 = ViewProps.RIGHT;
        int toPixelFromDIP3 = readableMap.hasKey(str3) ? (int) PixelUtil.toPixelFromDIP(readableMap.getDouble(str3)) : 0;
