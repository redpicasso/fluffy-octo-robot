...
public class ReactTextInputShadowNode extends ReactBaseTextShadowNode implements YogaMeasureFunction {
    ...
    public void setThemedContext(ThemedReactContext themedReactContext) {
        ...
        View editText = new EditText(getThemedContext());
    ...
    public void setSelection(@Nullable ReadableMap readableMap) {
        ...
        if (readableMap != null) {
            String str = ViewProps.START;
            if (readableMap.hasKey(str)) {
                String str2 = ViewProps.END;
                if (readableMap.hasKey(str2)) {
                    this.mSelectionStart = readableMap.getInt(str);
                    this.mSelectionEnd = readableMap.getInt(str2);
                    markUpdated();
                }
            }
        }
    ...
    public void onCollectExtraUpdates(UIViewOperationQueue uIViewOperationQueue) {
        ...
        if (this.mMostRecentEventCount != -1) {
            ReactTextUpdate reactTextUpdate = new ReactTextUpdate(ReactBaseTextShadowNode.spannedFromShadowNode(this, getText(), false, null), this.mMostRecentEventCount, this.mContainsImages, getPadding(0), getPadding(1), getPadding(2), getPadding(3), this.mTextAlign, this.mTextBreakStrategy, this.mJustificationMode, this.mSelectionStart, this.mSelectionEnd);
