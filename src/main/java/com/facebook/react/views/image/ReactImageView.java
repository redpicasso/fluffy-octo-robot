...
public class ReactImageView extends GenericDraweeView {
    ...
    private class RoundedCornerPostprocessor extends BasePostprocessor {
        ...
        /* synthetic */ RoundedCornerPostprocessor(ReactImageView reactImageView, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    public ReactImageView(Context context, AbstractDraweeControllerBuilder abstractDraweeControllerBuilder, @Nullable GlobalImageLoadListener globalImageLoadListener, @Nullable Object obj) {
        ...
        this.mTilePostprocessor = new TilePostprocessor(this, null);
    ...
    public void setBlurRadius(float f) {
        int toPixelFromDIP = (int) PixelUtil.toPixelFromDIP(f);
        if (toPixelFromDIP == 0) {
            this.mIterativeBoxBlurPostProcessor = null;
        } else {
            this.mIterativeBoxBlurPostProcessor = new IterativeBoxBlurPostProcessor(toPixelFromDIP);
        }
        this.mIsDirty = true;
    }
    ...
    private void cornerRadii(float[] fArr) {
        ...
        float f2 = (fArr2 == null || YogaConstants.isUndefined(fArr2[0])) ? f : this.mBorderCornerRadii[0];
        fArr[0] = f2;
        fArr2 = this.mBorderCornerRadii;
        f2 = (fArr2 == null || YogaConstants.isUndefined(fArr2[1])) ? f : this.mBorderCornerRadii[1];
        fArr[1] = f2;
        fArr2 = this.mBorderCornerRadii;
        f2 = (fArr2 == null || YogaConstants.isUndefined(fArr2[2])) ? f : this.mBorderCornerRadii[2];
        fArr[2] = f2;
        fArr2 = this.mBorderCornerRadii;
        ...
        if (!hasMultipleSources() || (getWidth() > 0 && getHeight() > 0)) {
            ...
            if (imageSource != null) {
                ...
                if (!isTiled() || (getWidth() > 0 && getHeight() > 0)) {
                    ...
                    drawable = this.mLoadingImageDrawable;
                    if (drawable != null) {
                    ...
                    if (this.mControllerListener == null || this.mControllerForTesting == null) {
                        controllerListener = this.mControllerForTesting;
                        if (controllerListener != null) {
                            this.mDraweeControllerBuilder.setControllerListener(controllerListener);
                        } else {
                            controllerListener = this.mControllerListener;
                            if (controllerListener != null) {
                                this.mDraweeControllerBuilder.setControllerListener(controllerListener);
                            }
                        }
                    } else {
                        controllerListener = new ForwardingControllerListener();
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (i > 0 && i2 > 0) {
            boolean z = this.mIsDirty || hasMultipleSources() || isTiled();
            this.mIsDirty = z;
            maybeUpdateView();
        }
    }
