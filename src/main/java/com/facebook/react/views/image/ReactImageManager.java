...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        return MapBuilder.of(ImageLoadEvent.eventNameForType(4), MapBuilder.of(str, "onLoadStart"), ImageLoadEvent.eventNameForType(2), MapBuilder.of(str, "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.of(str, "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.of(str, "onLoadEnd"));
    }
