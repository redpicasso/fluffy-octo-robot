...
public class ReactScrollViewManager extends ViewGroupManager<ReactScrollView> implements ScrollCommandHandler<ReactScrollView> {
    ...
    public void setPersistentScrollbar(ReactScrollView reactScrollView, boolean z) {
        reactScrollView.setScrollbarFadingEnabled(z ^ 1);
    }
    ...
    public static Map<String, Object> createExportedCustomDirectEventTypeConstants() {
        ...
        return MapBuilder.builder().put(ScrollEventType.getJSEventName(ScrollEventType.SCROLL), MapBuilder.of(str, "onScroll")).put(ScrollEventType.getJSEventName(ScrollEventType.BEGIN_DRAG), MapBuilder.of(str, "onScrollBeginDrag")).put(ScrollEventType.getJSEventName(ScrollEventType.END_DRAG), MapBuilder.of(str, "onScrollEndDrag")).put(ScrollEventType.getJSEventName(ScrollEventType.MOMENTUM_BEGIN), MapBuilder.of(str, "onMomentumScrollBegin")).put(ScrollEventType.getJSEventName(ScrollEventType.MOMENTUM_END), MapBuilder.of(str, "onMomentumScrollEnd")).build();
    }
}
