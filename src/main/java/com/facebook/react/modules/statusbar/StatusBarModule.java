...
public class StatusBarModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        Context reactApplicationContext = access$200();
        ...
        float toDIPFromPixel = identifier > 0 ? PixelUtil.toDIPFromPixel((float) reactApplicationContext.getResources().getDimensionPixelSize(identifier)) : 0.0f;
        Object format = (currentActivity == null || VERSION.SDK_INT < 21) ? "black" : String.format("#%06X", new Object[]{Integer.valueOf(currentActivity.getWindow().getStatusBarColor() & ViewCompat.MEASURED_SIZE_MASK)});
        return MapBuilder.of(HEIGHT_KEY, Float.valueOf(toDIPFromPixel), DEFAULT_BACKGROUND_COLOR_KEY, format);
    }
    ...
    public void setColor(int i, boolean z) {
        ...
        if (VERSION.SDK_INT >= 21) {
            final boolean z2 = z;
            final int i2 = i;
            UiThreadUtil.runOnUiThread(new GuardedRunnable(access$200()) {
                @TargetApi(21)
