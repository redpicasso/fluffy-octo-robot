...
public class ImageLoaderModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void getSize(String str, final Promise promise) {
        ...
        Fresco.getImagePipeline().fetchDecodedImage(ImageRequestBuilder.newBuilderWithSource(new ImageSource(access$200(), str).getUri()).build(), this.mCallerContext).subscribe(new BaseDataSubscriber<CloseableReference<CloseableImage>>() {
            protected void onNewResultImpl(DataSource<CloseableReference<CloseableImage>> dataSource) {
                if (dataSource.isFinished()) {
                    CloseableReference closeableReference = (CloseableReference) dataSource.getResult();
                    String str = ImageLoaderModule.ERROR_GET_SIZE_FAILURE;
    ...
    public void getSizeWithHeaders(String str, ReadableMap readableMap, final Promise promise) {
        ...
        Fresco.getImagePipeline().fetchDecodedImage(ReactNetworkImageRequest.fromBuilderWithHeaders(ImageRequestBuilder.newBuilderWithSource(new ImageSource(access$200(), str).getUri()), readableMap), this.mCallerContext).subscribe(new BaseDataSubscriber<CloseableReference<CloseableImage>>() {
            protected void onNewResultImpl(DataSource<CloseableReference<CloseableImage>> dataSource) {
                if (dataSource.isFinished()) {
                    CloseableReference closeableReference = (CloseableReference) dataSource.getResult();
                    String str = ImageLoaderModule.ERROR_GET_SIZE_FAILURE;
    ...
    public void prefetchImage(String str, final int i, final Promise promise) {
        ...
        DataSubscriber anonymousClass3 = new BaseDataSubscriber<Void>() {
        ...
        prefetchToDiskCache.subscribe(anonymousClass3, CallerThreadExecutor.getInstance());
    }
