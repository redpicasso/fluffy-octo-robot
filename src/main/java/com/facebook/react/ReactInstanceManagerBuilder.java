...
public class ReactInstanceManagerBuilder {
    ...
    public ReactInstanceManager build() {
        ...
        boolean z = true;
        boolean z2 = (!this.mUseDeveloperSupport && this.mJSBundleAssetUrl == null && this.mJSBundleLoader == null) ? false : true;
