...
public class MatrixMathHelper {
    ...
    public static void multiplyInto(double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        d19 = dArr3[14];
        d20 = dArr3[15];
        dArr[12] = (((d * d17) + (d5 * d18)) + (d9 * d19)) + (d13 * d20);
        dArr[13] = (((d2 * d17) + (d6 * d18)) + (d10 * d19)) + (d14 * d20);
        dArr[14] = (((d3 * d17) + (d7 * d18)) + (d11 * d19)) + (d15 * d20);
        dArr[15] = (((d17 * d4) + (d18 * d8)) + (d19 * d12)) + (d20 * d16);
    }
    ...
    public static void decomposeMatrix(double[] dArr, MatrixDecompositionContext matrixDecompositionContext) {
        ...
        if (!isZero(dArr2[15])) {
            ...
            if (!isZero(determinant(dArr9))) {
                ...
                for (i4 = 0; i4 < 3; i4++) {
                    dArr10[i4][0] = dArr8[i4][0];
                    dArr10[i4][1] = dArr8[i4][1];
                    dArr10[i4][2] = dArr8[i4][2];
                }
    ...
    public static double[] inverse(double[] dArr) {
        ...
        double d40 = d6 * d9;
        d20 = ((((d20 * d13) - (d19 * d13)) + (d17 * d14)) - (d35 * d14)) - (d40 * d16);
        d19 = d5 * d10;
        dArr2[8] = (d20 + (d19 * d16)) / determinant;
        double d41 = d2 * d9;
        double d42 = d * d10;
        dArr2[9] = ((((((d25 * d13) - (d26 * d13)) - (d23 * d14)) + (d18 * d14)) + (d41 * d16)) - (d42 * d16)) / determinant;
        d2 *= d5;
        d *= d6;
        ...
        dArr2[12] = ((((((d21 * d13) - (d22 * d13)) - (d36 * d14)) + (d37 * d14)) + (d40 * d15)) - (d19 * d15)) / determinant;
        dArr2[13] = ((((((d28 * d13) - (d27 * d13)) + (d38 * d14)) - (d39 * d14)) - (d41 * d15)) + (d42 * d15)) / determinant;
