...
class RedBoxDialog extends Dialog implements OnItemClickListener {
    ...
    private static class OpenStackFrameTask extends AsyncTask<StackFrame, Void, Void> {
        ...
        /* synthetic */ OpenStackFrameTask(DevSupportManager devSupportManager, AnonymousClass1 anonymousClass1) {
    ...
    private static class StackAdapter extends BaseAdapter {
        ...
        private static class FrameViewHolder {
            ...
            /* synthetic */ FrameViewHolder(View view, AnonymousClass1 anonymousClass1) {
                this(view);
            }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (i == 0) {
                if (view != null) {
                    ...
                    view = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.redbox_item_title, viewGroup, false);
                }
                view.setText(this.mTitle.replaceAll("\\x1b\\[[0-9;]*m", ""));
                return view;
            }
            if (view == null) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        new OpenStackFrameTask(this.mDevSupportManager, null).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new StackFrame[]{(StackFrame) this.mStackView.getAdapter().getItem(i)});
    }
