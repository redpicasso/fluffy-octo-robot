...
public class DevServerHelper {
    ...
    private BundleStatusProvider mBundlerStatusProvider;
    ...
    private final Handler mRestartOnChangePollingHandler = new Handler(Looper.getMainLooper());
        ...
        if (this.mPackagerClient != null) {
            ...
            new AsyncTask<Void, Void, Void>() {
                protected Void doInBackground(Void... voidArr) {
                    ...
                    ConnectionCallback anonymousClass4 = new ConnectionCallback() {
                    ...
                    devServerHelper.mPackagerClient = new JSPackagerClient(str, devServerHelper.mSettings.getPackagerConnectionSettings(), hashMap, anonymousClass4);
        ...
        this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (isSuccessful) {
                    ...
                    if (body == null) {
                        FLog.e(str, "Got null body response from packager when requesting status");
                        packagerStatusCallback.onPackagerStatusFetched(false);
                        return;
                    }
                ...
                stringBuilder2.append("Got non-success http code from packager when requesting status: ");
                stringBuilder2.append(response.code());
                FLog.e(str, stringBuilder2.toString());
                packagerStatusCallback.onPackagerStatusFetched(false);
            }
        });
    }
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r6, java.io.File r7) {
        ...
        r5 = this;
        r0 = r5.mSettings;
        r0 = r0.getPackagerConnectionSettings();
        r0 = r0.getDebugServerHost();
        r0 = createResourceURL(r0, r6);
        r1 = new okhttp3.Request$Builder;
        r1.<init>();
        r0 = r1.url(r0);
        r0 = r0.build();
        r1 = 0;
        r2 = r5.mClient;	 Catch:{ Exception -> 0x0074 }
        r0 = r2.newCall(r0);	 Catch:{ Exception -> 0x0074 }
        r0 = r0.execute();	 Catch:{ Exception -> 0x0074 }
        r2 = r0.isSuccessful();	 Catch:{ Throwable -> 0x005d, all -> 0x005a }
    ...
    L_0x0031:
        return r1;
    L_0x0032:
        r2 = okio.Okio.sink(r7);	 Catch:{ all -> 0x0052 }
        r3 = r0.body();	 Catch:{ all -> 0x0050 }
        r3 = r3.source();	 Catch:{ all -> 0x0050 }
        r3 = okio.Okio.buffer(r3);	 Catch:{ all -> 0x0050 }
    ...
    L_0x0074:
        ...
        r2[r6] = r0;
        r6 = "ReactNative";
        r7 = "Failed to fetch resource synchronously - resourcePath: \"%s\", outputFile: \"%s\"";
        com.facebook.common.logging.FLog.e(r6, r7, r2);
        return r1;
        */
