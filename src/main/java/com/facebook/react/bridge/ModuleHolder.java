...
public class ModuleHolder {
    ...
    /* JADX WARNING: Missing block: B:25:0x0028, code:
            if (r3.mModule != null) goto L_0x0032;
     */
    /* JADX WARNING: Missing block: B:29:?, code:
            wait();
     */
    /* JADX WARNING: Missing block: B:34:0x003b, code:
            return (com.facebook.react.bridge.NativeModule) com.facebook.infer.annotation.Assertions.assertNotNull(r3.mModule);
     */
    ...
    L_0x0032:
        r0 = r3.mModule;	 Catch:{ all -> 0x003c }
        r0 = com.facebook.infer.annotation.Assertions.assertNotNull(r0);	 Catch:{ all -> 0x003c }
    ...
    private NativeModule create() {
        ...
        SystraceMessage.beginSection(0, "ModuleHolder.createModule").arg(ConditionalUserProperty.NAME, this.mName).flush();
        PrinterHolder.getPrinter().logMessage(ReactDebugOverlayTags.NATIVE_MODULE, "NativeModule init: %s", this.mName);
        try {
    ...
    private void doInitialize(NativeModule nativeModule) {
        SystraceMessage.beginSection(0, "ModuleHolder.initialize").arg(ConditionalUserProperty.NAME, this.mName).flush();
