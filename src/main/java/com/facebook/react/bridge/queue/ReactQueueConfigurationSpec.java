...
public class ReactQueueConfigurationSpec {
    ...
    public static ReactQueueConfigurationSpec createDefault() {
        ...
        if (VERSION.SDK_INT < 21) {
            newBackgroundThreadSpec = MessageQueueThreadSpec.newBackgroundThreadSpec(str, LEGACY_STACK_SIZE_BYTES);
        } else {
            newBackgroundThreadSpec = MessageQueueThreadSpec.newBackgroundThreadSpec(str);
        }
