...
public abstract class DalvikPurgeableDecoder implements PlatformDecoder {
    ...
    private static class OreoUtils {
        ...
        @TargetApi(26)
        static void setColorSpace(Options options, @Nullable ColorSpace colorSpace) {
            if (colorSpace == null) {
    ...
    protected abstract Bitmap decodeByteArrayAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, Options options);

    protected abstract Bitmap decodeJPEGByteArrayAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, int i, Options options);
    ...
    public static boolean endsWithEOI(CloseableReference<PooledByteBuffer> closeableReference, int i) {
        ...
        if (i >= 2 && pooledByteBuffer.read(i - 2) == (byte) -1 && pooledByteBuffer.read(i - 1) == (byte) -39) {
            return true;
        }
        return false;
    }
