...
public class LocalContentUriFetchProducer extends LocalFetchProducer {
    ...
    private static final String[] PROJECTION = new String[]{APEZProvider.FILEID, "_data"};
    ...
    protected EncodedImage getEncodedImage(ImageRequest imageRequest) throws IOException {
        ...
        Object sourceUri = imageRequest.getSourceUri();
        if (UriUtil.isLocalContactUri(sourceUri)) {
            ...
            if (sourceUri.toString().endsWith("/photo")) {
                ...
                if (sourceUri.toString().endsWith("/display_photo")) {
                    try {
                        openInputStream = this.mContentResolver.openAssetFileDescriptor(sourceUri, "r").createInputStream();
                    } catch (IOException unused) {
                        stringBuilder = new StringBuilder();
                        stringBuilder.append(str);
                        stringBuilder.append(sourceUri);
