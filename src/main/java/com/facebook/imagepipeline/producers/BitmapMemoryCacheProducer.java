    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        try {
            ...
            if (closeableReference != null) {
                ...
                if (isOfFullQuality) {
                    listener.onProducerFinishWithSuccess(id, getProducerName(), listener.requiresExtraMap(id) ? ImmutableMap.of(str, "true") : null);
            ...
            if (producerContext.getLowestPermittedRequestLevel().getValue() >= RequestLevel.BITMAP_MEMORY_CACHE.getValue()) {
                listener.onProducerFinishWithSuccess(id, getProducerName(), listener.requiresExtraMap(id) ? ImmutableMap.of(str, str2) : null);
            ...
            public void onNewResultImpl(CloseableReference<CloseableImage> closeableReference, int i) {
                ...
                try {
                    ...
                    if (closeableReference == null) {
                        ...
                        Object closeableReference4;
                        if (!isLast) {
                            closeableReference3 = BitmapMemoryCacheProducer.this.mMemoryCache.get(cacheKey);
                            if (closeableReference3 != null) {
                                QualityInfo qualityInfo = ((CloseableImage) closeableReference4.get()).getQualityInfo();
                        ...
                        if (z) {
                            closeableReference2 = BitmapMemoryCacheProducer.this.mMemoryCache.cache(cacheKey, closeableReference4);
                        }
                        if (isLast) {
                        ...
                        if (closeableReference2 != null) {
                            closeableReference4 = closeableReference2;
                        }
                        consumer.onNewResult(closeableReference4, i);
