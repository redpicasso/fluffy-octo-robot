...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    private static class PartialDiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        /* synthetic */ PartialDiskCacheConsumer(Consumer consumer, BufferedDiskCache bufferedDiskCache, CacheKey cacheKey, PooledByteBufferFactory pooledByteBufferFactory, ByteArrayPool byteArrayPool, EncodedImage encodedImage, AnonymousClass1 anonymousClass1) {
            ...
            public Void then(Task<EncodedImage> task) throws Exception {
                ...
                if (access$000) {
                    ...
                    if (encodedImage != null) {
                        ...
                        producerListener = listener;
                        str2 = id;
                        producerListener.onProducerFinishWithSuccess(str2, str, PartialDiskCacheProducer.getExtraMap(producerListener, str2, false, 0));
    ...
    private void startInputProducer(Consumer<EncodedImage> consumer, ProducerContext producerContext, CacheKey cacheKey, @Nullable EncodedImage encodedImage) {
        this.mInputProducer.produceResults(new PartialDiskCacheConsumer(consumer, this.mDefaultBufferedDiskCache, cacheKey, this.mPooledByteBufferFactory, this.mByteArrayPool, encodedImage, null), producerContext);
    }
    ...
    static Map<String, String> getExtraMap(ProducerListener producerListener, String str, boolean z, int i) {
        ...
        if (!z) {
            return ImmutableMap.of(str2, String.valueOf(z));
        }
        return ImmutableMap.of(str2, String.valueOf(z), "encodedImageSize", String.valueOf(i));
    }
