        ...
        try {
            ...
            if (closeableReference != null) {
                ...
                if (producerContext.getLowestPermittedRequestLevel().getValue() >= RequestLevel.ENCODED_MEMORY_CACHE.getValue()) {
                    listener.onProducerFinishWithSuccess(id, str, listener.requiresExtraMap(id) ? ImmutableMap.of(str2, str3) : null);
