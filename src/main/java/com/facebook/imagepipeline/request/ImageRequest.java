...
public class ImageRequest {
    ...
    public int getPreferredWidth() {
        ...
        return resizeOptions != null ? resizeOptions.width : 2048;
    }

    public int getPreferredHeight() {
        ResizeOptions resizeOptions = this.mResizeOptions;
        return resizeOptions != null ? resizeOptions.height : 2048;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (postprocessor2 != null) {
            obj2 = postprocessor2.getPostprocessorCacheKey();
        }
    ...
    public int hashCode() {
        ...
        return Objects.hashCode(this.mCacheChoice, this.mSourceUri, this.mSourceFile, this.mBytesRange, this.mImageDecodeOptions, this.mResizeOptions, this.mRotationOptions, postprocessorCacheKey, this.mResizingAllowedOverride);
    }
