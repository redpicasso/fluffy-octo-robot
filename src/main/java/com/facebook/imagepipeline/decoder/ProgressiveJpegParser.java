...
public class ProgressiveJpegParser {
    ...
    private static boolean doesMarkerStartSegment(int i) {
        ...
        if (i >= 208 && i <= JfifUtil.MARKER_RST7) {
            return false;
        }
    ...
    public boolean parseMoreData(EncodedImage encodedImage) {
        ...
        try {
            ...
            e = doParseMoreData(pooledByteArrayBufferedInputStream);
            return e;
        ...
        while (true) {
            ...
            try {
                ...
                if (i2 != 0) {
                        ...
                        if (i2 != 2) {
                            if (i2 != 3) {
                                if (i2 == 4) {
                                    ...
                                    i2 = ((this.mLastByteRead << 8) + read) - 2;
                                ...
                                this.mParserState = 2;
                            } else if (read == JfifUtil.MARKER_EOI) {
                    ...
                    } else if (read == JfifUtil.MARKER_SOI) {
                        this.mParserState = 2;
                    } else {
                        this.mParserState = 6;
                    }
