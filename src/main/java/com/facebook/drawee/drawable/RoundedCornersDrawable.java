...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
     ...
     */
        static {
            /*
            r0 = com.facebook.drawee.drawable.RoundedCornersDrawable.Type.values();
            r0 = r0.length;
            r0 = new int[r0];
            $SwitchMap$com$facebook$drawee$drawable$RoundedCornersDrawable$Type = r0;
            r0 = $SwitchMap$com$facebook$drawee$drawable$RoundedCornersDrawable$Type;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = com.facebook.drawee.drawable.RoundedCornersDrawable.Type.CLIPPING;	 Catch:{ NoSuchFieldError -> 0x0014 }
            r1 = r1.ordinal();	 Catch:{ NoSuchFieldError -> 0x0014 }
            r2 = 1;
            r0[r1] = r2;	 Catch:{ NoSuchFieldError -> 0x0014 }
        L_0x0014:
            r0 = $SwitchMap$com$facebook$drawee$drawable$RoundedCornersDrawable$Type;	 Catch:{ NoSuchFieldError -> 0x001f }
            r1 = com.facebook.drawee.drawable.RoundedCornersDrawable.Type.OVERLAY_COLOR;	 Catch:{ NoSuchFieldError -> 0x001f }
        ...
        L_0x001f:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.drawable.RoundedCornersDrawable.1.<clinit>():void");
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (i == 1) {
            ...
            if (this.mScaleDownInsideBorders) {
                ...
                rectF = this.mInsideBorderBounds;
            ...
            if (this.mIsCircle) {
                ...
                if (height > 0.0f) {
                    canvas2 = canvas;
                    canvas2.drawRect(this.mBounds.left, this.mBounds.top, this.mBounds.right, this.mBounds.top + height, this.mPaint);
                    canvas2.drawRect(this.mBounds.left, this.mBounds.bottom - height, this.mBounds.right, this.mBounds.bottom, this.mPaint);
                }
            }
        }
