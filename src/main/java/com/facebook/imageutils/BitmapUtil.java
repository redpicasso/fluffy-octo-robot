...
public final class BitmapUtil {
     ...
     */
        ...
        L_0x0035:
            ...
            r1 = android.graphics.Bitmap.Config.RGBA_F16;	 Catch:{ NoSuchFieldError -> 0x0040 }
    ...
    public static Pair<Integer, Integer> decodeDimensions(Uri uri) {
        ...
        return (options.outWidth == -1 || options.outHeight == -1) ? null : new Pair(Integer.valueOf(options.outWidth), Integer.valueOf(options.outHeight));
    }
