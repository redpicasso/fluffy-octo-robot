...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private LinearGradient getLinearGradient() {
        ...
        LinearGradient linearGradient2 = new LinearGradient((float) ((int) ((this.boundsRect.left + (this.boundsRect.width() / 2.0f)) + pointF.x)), (float) ((int) ((this.boundsRect.top + (this.boundsRect.height() / 2.0f)) + pointF.y)), (float) ((int) ((this.boundsRect.left + (this.boundsRect.width() / 2.0f)) + pointF2.x)), (float) ((int) ((this.boundsRect.top + (this.boundsRect.height() / 2.0f)) + pointF2.y)), applyDynamicColorsIfNeeded(gradientColor.getColors()), gradientColor.getPositions(), TileMode.CLAMP);
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f, f2, (float) Math.hypot((double) (((int) ((this.boundsRect.left + (this.boundsRect.width() / 2.0f)) + pointF2.x)) - width), (double) (((int) ((this.boundsRect.top + (this.boundsRect.height() / 2.0f)) + pointF2.y)) - height)), applyDynamicColorsIfNeeded, positions, TileMode.CLAMP);
