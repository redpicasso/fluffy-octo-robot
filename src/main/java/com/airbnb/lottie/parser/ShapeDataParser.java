    ...
    public ShapeData parse(JsonReader jsonReader, float f) throws IOException {
        ...
        if (list == null || list2 == null || list3 == null) {
            ...
            if (z) {
                ...
                size--;
                arrayList.add(new CubicCurveData(MiscUtils.addPoints((PointF) list.get(size), (PointF) list3.get(size)), MiscUtils.addPoints(pointF3, (PointF) list2.get(0)), pointF3));
            }
