...
class GradientFillParser {
    ...
    private static final Options NAMES = Options.of("nm", "g", "o", "t", "s", "e", "r", "hd");
    ...
    static GradientFill parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        String str = null;
        GradientType gradientType = str;
        AnimatableGradientColorValue animatableGradientColorValue = gradientType;
        AnimatableIntegerValue animatableIntegerValue = animatableGradientColorValue;
        AnimatablePointValue animatablePointValue = animatableIntegerValue;
        AnimatablePointValue animatablePointValue2 = animatablePointValue;
        boolean z = false;
