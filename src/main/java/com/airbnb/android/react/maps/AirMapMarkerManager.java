...
public class AirMapMarkerManager extends ViewGroupManager<AirMapMarker> {
            ...
            if (!this.markers.isEmpty()) {
                for (Entry entry : this.markers.entrySet()) {
                    if (entry.getKey() != null) {
                        ((AirMapMarker) entry.getKey()).setIconBitmapDescriptor(bitmapDescriptor, bitmap);
                    }
                }
            }
        }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        Map of = MapBuilder.of(str5, MapBuilder.of(str, "onPress"), str6, MapBuilder.of(str, "onCalloutPress"), "onDragStart", MapBuilder.of(str, str2), "onDrag", MapBuilder.of(str, str3), "onDragEnd", MapBuilder.of(str, str4));
        of.putAll(MapBuilder.of("onDragStart", MapBuilder.of(str, str2), "onDrag", MapBuilder.of(str, str3), "onDragEnd", MapBuilder.of(str, str4)));
        return of;
    }
