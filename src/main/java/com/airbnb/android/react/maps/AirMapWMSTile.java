...
public class AirMapWMSTile extends AirMapFeature {
    ...
    private static final double[] mapBound = new double[]{-2.003750834789244E7d, 2.003750834789244E7d};
    ...
    class AIRMapGSUrlTileProvider extends UrlTileProvider {
        ...
        private double[] getBoundingBox(int i, int i2, int i3) {
            ...
            return new double[]{AirMapWMSTile.mapBound[0] + (((double) i) * pow), AirMapWMSTile.mapBound[1] - (((double) (i2 + 1)) * pow), AirMapWMSTile.mapBound[0] + (((double) (i + 1)) * pow), AirMapWMSTile.mapBound[1] - (((double) i2) * pow)};
        }
