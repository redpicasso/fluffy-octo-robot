...
public class AirMapView extends MapView implements InfoWindowAdapter, OnMarkerDragListener, OnMapReadyCallback, OnPoiClickListener, OnIndoorStateChangeListener {
    ...
    public AirMapView(ThemedReactContext themedReactContext, ReactApplicationContext reactApplicationContext, AirMapManager airMapManager, GoogleMapOptions googleMapOptions) {
        ...
        LayoutParams layoutParams = new FrameLayout.LayoutParams(0, 0);
        ...
        if (!this.destroyed) {
            ...
            googleMap.setOnMarkerClickListener(new OnMarkerClickListener() {
                public boolean onMarkerClick(Marker marker) {
                    View access$500 = AirMapView.this.getMarkerMap(marker);
                    ...
                    makeClickEventData = AirMapView.this.makeClickEventData(marker.getPosition());
                    makeClickEventData.putString(str2, str);
                    makeClickEventData.putString(str3, access$500.getIdentifier());
            ...
            googleMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
                public void onInfoWindowClick(Marker marker) {
                    ...
                    makeClickEventData.putString(str2, str);
                    View access$500 = AirMapView.this.getMarkerMap(marker);
                    AirMapView.this.manager.pushEvent(AirMapView.this.context, access$500, str3, makeClickEventData);
                    ...
                    if (calloutView != null) {
                        AirMapView.this.manager.pushEvent(AirMapView.this.context, calloutView, "onPress", makeClickEventData2);
                    }
                }
            });
            ...
            googleMap.setOnGroundOverlayClickListener(new OnGroundOverlayClickListener() {
    ...
    public void removeFeatureAt(int i) {
        ...
        if (airMapFeature instanceof AirMapMarker) {
            ...
            this.heatmapMap.remove(airMapFeature.getFeature());
        }
    ...
    public WritableMap makeClickEventData(LatLng latLng) {
        ...
        writableNativeMap2.putDouble("x", (double) toScreenLocation.x);
        writableNativeMap2.putDouble("y", (double) toScreenLocation.y);
    ...
    public void animateToCamera(ReadableMap readableMap, int i) {
        ...
        if (googleMap != null) {
            ...
            str = "heading";
            if (readableMap.hasKey(str)) {
                builder.bearing((float) readableMap.getDouble(str));
            }
            str = "pitch";
            if (readableMap.hasKey(str)) {
                builder.tilt((float) readableMap.getDouble(str));
            }
            str = "center";
            if (readableMap.hasKey(str)) {
    ...
    public double[][] getMapBoundaries() {
        ...
        r3 = new double[2][];
        r3[0] = new double[]{latLng.longitude, latLng.latitude};
        r3[1] = new double[]{latLng2.longitude, latLng2.latitude};
        return r3;
    }
    ...
    public void setKmlSrc(String str) {
        ...
        try {
            ...
            if (inputStream != null) {
                this.kmlLayer = new KmlLayer(this.map, inputStream, this.context);
                ...
                for (KmlPlacemark kmlPlacemark : kmlContainer.getPlacemarks()) {
                    ...
                    String str6 = str2;
                    View airMapMarker = new AirMapMarker(this.context, markerOptions, this.manager.getMarkerManager());
                    ...
                    makeClickEventData.putString("id", str2);
