    ...
    private class ProgressReportingSource implements Source {
        ...
        public long read(@NonNull Buffer buffer, long j) throws IOException {
            ...
            try {
                ...
                rNFetchBlobFileResp.bytesDownloaded += i2 > 0 ? read : 0;
                if (i2 > 0) {
                ...
                if (RNFetchBlobFileResp.this.contentLength() != 0) {
                    float contentLength = RNFetchBlobFileResp.this.contentLength() != -1 ? (float) (RNFetchBlobFileResp.this.bytesDownloaded / RNFetchBlobFileResp.this.contentLength()) : (float) RNFetchBlobFileResp.this.isEndMarkerReceived;
    ...
    public RNFetchBlobFileResp(ReactApplicationContext reactApplicationContext, String str, ResponseBody responseBody, String str2, boolean z) throws IOException {
        ...
        if (str2 != null) {
            ...
            if (parentFile == null || parentFile.exists() || parentFile.mkdirs()) {
                ...
                this.ofStream = new FileOutputStream(new File(str), z2);
                return;
            }
